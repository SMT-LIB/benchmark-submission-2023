...
(declare-fun |c_ULTIMATE.start_main_#t~malloc15#1.base| () Int)
...
(assert (and (= |c_ULTIMATE.start_main_~n~0#1| |c_ULTIMATE.start_is_pow2_~x#1|) (= (select |c_#valid| |c_ULTIMATE.start_main_#t~malloc15#1.base|) 1) (< 1 |c_ULTIMATE.start_main_~n~0#1|) (< |c_ULTIMATE.start_main_~n~0#1| 1073741824) (< (* (div |c_ULTIMATE.start_is_pow2_~x#1| 2) 2) |c_ULTIMATE.start_is_pow2_~x#1|)))
