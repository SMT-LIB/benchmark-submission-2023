...
(declare-fun |c_ULTIMATE.start_main_#t~mem78#1| () Int)
...
(assert (or (not (= 2 (mod c_~__CS_thread_index~0 256))) (forall ((v_ArrVal_30515 (Array Int Int))) (not (= 1 (mod (select (select (store |c_#memory_int| |c_~#__CS_thread_status~0.base| v_ArrVal_30515) |c_~#__CS_thread_allocated~0.base|) (+ 2 |c_~#__CS_thread_allocated~0.offset|)) 256))))))
(assert (not (or (not (= 2 (mod c_~__CS_thread_index~0 256))) (not (= (mod |c_ULTIMATE.start_main_#t~mem78#1| 256) 1)))))
(check-sat)
(exit)
