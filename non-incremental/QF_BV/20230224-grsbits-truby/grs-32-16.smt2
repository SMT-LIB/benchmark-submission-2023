...
(declare-fun x_use () (_ BitVec 55 ))
(declare-fun y_use () (_ BitVec 55 ))
...
(declare-fun z_short () (_ BitVec 48 ))
...
;;;example
;;;(assert (= x #b1110101100101110001001101010100001111100010010100))
;;;(assert (= y #b1001111111100100000010110010101101111011101110001))
...
(assert (= x_sign ((_ extract 54 54) x_use)))
(assert (= y_sign ((_ extract 54 54) y_use)))
(assert (= x_expo ((_ extract 53 22) x_use)))
(assert (= y_expo ((_ extract 53 22) y_use)))
(assert (= x_man ((_ extract 21 0) x_use)))
(assert (= y_man ((_ extract 21 0) y_use)))

;;;check for nan and inf
(assert (ite (bvuge x_expo #b11111111111111111111111111111111) (ite (bvuge x_man (_ bv1 22))(= nan1 #b1) (and (= inf1 #b1) (= nan1 #b0))) (and (= nan1 #b0) (= inf1 #b0))))
(assert (ite (bvuge y_expo #b11111111111111111111111111111111) (ite (bvuge y_man (_ bv1 22))(= nan2 #b1) (and (= inf2 #b1) (= nan2 #b0)))	(and (= nan2 #b0) (= inf2 #b0))))
...
(assert (ite (= nan #b0) (ite (= inf #b0) (ite (= overflow2 #b0) (ite (= underflow1 #b0)(= z_short (concat z_expo_19 z_mant_final))(= z_short (_ bv0 48)))(= z_short #b111111111111111111111111111111110000000000000000))(= z_short #b111111111111111111111111111111110000000000000000))(= z_short #b111111111111111111111111111111111000000000000000)))
(assert (= z (concat z_sign z_short)))

;;;set the variables
(declare-fun a () (_ BitVec 49 ))
(declare-fun b () (_ BitVec 49 ))
(declare-fun a_use () (_ BitVec 55 ))
(declare-fun b_use () (_ BitVec 55 ))
...
(declare-fun c_short () (_ BitVec 48 ))
...
;;;example
;;;(assert (= a #b1110101100101110001001101010100001111100010010100))
;;;(assert (= b #b1001111111100100000010110010101101111011101110001))
...
;;;extract sign mantissa expo
(assert (= a_sign ((_ extract 54 54) a_use)))
(assert (= b_sign ((_ extract 54 54) b_use)))
(assert (= a_expo ((_ extract 53 22) a_use)))
(assert (= b_expo ((_ extract 53 22) b_use)))
(assert (= a_man ((_ extract 21 0) a_use)))
(assert (= b_man ((_ extract 21 0) b_use)))

;;;check for nan and inf
(assert (ite (bvuge a_expo #b11111111111111111111111111111111) (ite (bvuge a_man (_ bv1 22))(= nan1_2 #b1) (and (= inf1_2 #b1) (= nan1_2 #b0))) (and (= nan1_2 #b0) (= inf1_2 #b0))))
(assert (ite (bvuge b_expo #b11111111111111111111111111111111) (ite (bvuge b_man (_ bv1 22))(= nan2_2 #b1) (and (= inf2_2 #b1) (= nan2_2 #b0)))	(and (= nan2_2 #b0) (= inf2_2 #b0))))
...
(assert (ite (= nan_2 #b0) (ite (= inf_2 #b0) (ite (= overflow2_2 #b0) (ite (= underflow1_2 #b0)(= c_short (concat c_expo_19_2 c_mant_final))(= c_short (_ bv0 48)))(= c_short #b111111111111111111111111111111110000000000000000))(= c_short #b111111111111111111111111111111110000000000000000))(= c_short #b111111111111111111111111111111111000000000000000)))
