...
;;;set the variables
(declare-fun x () (_ BitVec 81 ))
(declare-fun y () (_ BitVec 81 ))
(declare-fun x_use () (_ BitVec 87 ))
(declare-fun y_use () (_ BitVec 87 ))
...
(declare-fun z () (_ BitVec 81 ))
(declare-fun z_short () (_ BitVec 80 ))
...
;;;example
;;;(assert (= x #b111010110010111000100110101010000111110001001010010011111111001000000101100101011))
;;;(assert (= y #b011110111011100011011011010011101101100000011110011111101000100001100001000010111))
...
(assert (= x_sign ((_ extract 86 86) x_use)))
(assert (= y_sign ((_ extract 86 86) y_use)))
(assert (= x_expo ((_ extract 85 22) x_use)))
(assert (= y_expo ((_ extract 85 22) y_use)))
(assert (= x_man ((_ extract 21 0) x_use)))
(assert (= y_man ((_ extract 21 0) y_use)))

;;;check for nan and inf
(assert (ite (bvuge x_expo #b1111111111111111111111111111111111111111111111111111111111111111) (ite (bvuge x_man (_ bv1 22))(= nan1 #b1) (and (= inf1 #b1) (= nan1 #b0))) (and (= nan1 #b0) (= inf1 #b0))))
(assert (ite (bvuge y_expo #b1111111111111111111111111111111111111111111111111111111111111111) (ite (bvuge y_man (_ bv1 22))(= nan2 #b1) (and (= inf2 #b1) (= nan2 #b0)))	(and (= nan2 #b0) (= inf2 #b0))))
...
(assert (ite (= nan #b0) (ite (= inf #b0) (ite (= overflow2 #b0) (ite (= underflow1 #b0)(= z_short (concat z_expo_19 z_mant_final))(= z_short (_ bv0 80)))(= z_short #b11111111111111111111111111111111111111111111111111111111111111110000000000000000))(= z_short #b11111111111111111111111111111111111111111111111111111111111111110000000000000000))(= z_short #b11111111111111111111111111111111111111111111111111111111111111111000000000000000)))
(assert (= z (concat z_sign z_short)))

;;;set the variables
(declare-fun a () (_ BitVec 81 ))
(declare-fun b () (_ BitVec 81 ))
(declare-fun a_use () (_ BitVec 87 ))
(declare-fun b_use () (_ BitVec 87 ))
...
(declare-fun c () (_ BitVec 81 ))
(declare-fun c_short () (_ BitVec 80 ))
...
;;;example
;;;(assert (= a #b111010110010111000100110101010000111110001001010010011111111001000000101100101011))
;;;(assert (= b #b011110111011100011011011010011101101100000011110011111101000100001100001000010111))
...
;;;extract sign mantissa expo
(assert (= a_sign ((_ extract 86 86) a_use)))
(assert (= b_sign ((_ extract 86 86) b_use)))
(assert (= a_expo ((_ extract 85 22) a_use)))
(assert (= b_expo ((_ extract 85 22) b_use)))
(assert (= a_man ((_ extract 21 0) a_use)))
(assert (= b_man ((_ extract 21 0) b_use)))

;;;check for nan and inf
(assert (ite (bvuge a_expo #b1111111111111111111111111111111111111111111111111111111111111111) (ite (bvuge a_man (_ bv1 22))(= nan1_2 #b1) (and (= inf1_2 #b1) (= nan1_2 #b0))) (and (= nan1_2 #b0) (= inf1_2 #b0))))
(assert (ite (bvuge b_expo #b1111111111111111111111111111111111111111111111111111111111111111) (ite (bvuge b_man (_ bv1 22))(= nan2_2 #b1) (and (= inf2_2 #b1) (= nan2_2 #b0)))	(and (= nan2_2 #b0) (= inf2_2 #b0))))
...
(assert (ite (= nan_2 #b0) (ite (= inf_2 #b0) (ite (= overflow2_2 #b0) (ite (= underflow1_2 #b0)(= c_short (concat c_expo_19_2 c_mant_final))(= c_short (_ bv0 80)))(= c_short #b11111111111111111111111111111111111111111111111111111111111111110000000000000000))(= c_short #b11111111111111111111111111111111111111111111111111111111111111110000000000000000))(= c_short #b11111111111111111111111111111111111111111111111111111111111111111000000000000000)))
