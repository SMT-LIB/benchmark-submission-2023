...
(assert (str.in_re atkPtn attack))
(assert (= atk_sink (str.++ atk_sigmaStar_1 (str.++ atkPtn atk_sigmaStar_2))))
(assert (= b_x_23 (or (and (= x_23 literal_1) b_literal_1) (and (= x_23 sigmaStar_2256) b_sigmaStar_2256) ) ))
(assert (= b_x_27 (and (= x_27 (str.replace_all x_23 "\\'" "\'") ) b_x_23) ))
(assert (= b_x_31 (and (= x_31 (str.replace_all x_27 "\\""" """") ) b_x_27) ))
(assert (= b_x_35 (and (= x_35 (str.replace_all x_31 "\\\\" "\\") ) b_x_31) ))
