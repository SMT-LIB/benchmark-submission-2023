...
(assert (= b_x_62 (and (= x_62 (str.replace_all x_58 "<" "&lt;") ) b_x_58) ))
(assert (= b_x_66 (and (= x_66 (str.replace_all x_62 ">" "&gt;") ) b_x_62) ))
(assert (= b_x_70 (and (= x_70 (str.replace_all x_66 """" "&quot;") ) b_x_66) ))
