...
(assert (and (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (exists ((|v_ULTIMATE.start_main_~list~0#1.base_22| Int)) (let ((.cse1 (select |c_#memory_$Pointer$.base| |v_ULTIMATE.start_main_~list~0#1.base_22|))) (let ((.cse0 (select .cse1 12)) (.cse2 (select |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_main_~list~0#1.base_22|))) (and (<= (select (select |c_#memory_int| |v_ULTIMATE.start_main_~list~0#1.base_22|) 0) 1) (= .cse0 |v_ULTIMATE.start_main_~list~0#1.base_22|) (= |c_ULTIMATE.start_main_~m~0#1.base| (select .cse1 4)) (= (select .cse2 4) 0) (not (= |c_ULTIMATE.start_main_~m~0#1.base| |v_ULTIMATE.start_main_~list~0#1.base_22|)) (= .cse0 |c_ULTIMATE.start_main_~list~0#1.base|) (= 0 (select .cse2 12)))))) (= |c_ULTIMATE.start_main_~m~0#1.offset| 0)))
