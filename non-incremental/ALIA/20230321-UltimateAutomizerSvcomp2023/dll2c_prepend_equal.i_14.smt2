...
(declare-fun |c_ULTIMATE.start_dll_circular_prepend_#t~ret9#1.base| () Int)
(declare-fun |c_ULTIMATE.start_dll_circular_prepend_#t~ret9#1.offset| () Int)
