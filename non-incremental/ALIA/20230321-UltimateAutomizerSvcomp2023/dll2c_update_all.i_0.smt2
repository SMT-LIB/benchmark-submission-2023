...
(assert (let ((.cse0 (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_circular_create_#res#1.base|))) (= (select .cse0 8) (select .cse0 0))))
(assert (not (exists ((v_DerPreprocessor_1 (Array Int Int)) (v_arrayElimArr_3 (Array Int Int))) (let ((.cse0 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_circular_create_#res#1.base|) 0))) (and (= (select |#memory_$Pointer$.base| .cse0) (select (store (store (store (store |#memory_$Pointer$.base| .cse0 v_DerPreprocessor_1) |ULTIMATE.start_dll_circular_create_#res#1.base| v_arrayElimArr_3) .cse0 v_DerPreprocessor_1) |ULTIMATE.start_dll_circular_create_#res#1.base| v_arrayElimArr_3) .cse0)) (= (select v_arrayElimArr_3 8) .cse0))))))
(check-sat)
(exit)
