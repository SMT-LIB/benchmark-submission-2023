...
(assert (not (and (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= (store |c_old(#memory_$Pointer$.base)| c_~head~0.base v_arrayElimArr_1) |c_#memory_$Pointer$.base|) (= |c_old(~head~0.base)| (select v_arrayElimArr_1 4)))) (exists ((v_arrayElimArr_2 (Array Int Int))) (and (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| c_~head~0.base v_arrayElimArr_2)) (= (select v_arrayElimArr_2 4) |c_old(~head~0.offset)|))) (= c_~head~0.offset 0))))
(check-sat)
(exit)
