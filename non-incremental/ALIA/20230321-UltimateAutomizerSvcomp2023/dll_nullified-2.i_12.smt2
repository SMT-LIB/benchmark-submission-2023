...
(assert (not (let ((.cse0 (select |c_#memory_int| |c_ULTIMATE.start_dll_create_~new_head~0#1.base|))) (and (= (select (select |c_#memory_int| |c_ULTIMATE.start_dll_create_~head~0#1.base|) |c_ULTIMATE.start_dll_create_~head~0#1.offset|) 0) (= (select .cse0 0) 0) (= |c_ULTIMATE.start_dll_create_~new_head~0#1.offset| 0) (= (select |c_#valid| |c_ULTIMATE.start_dll_create_~new_head~0#1.base|) 1) (not (= |c_ULTIMATE.start_dll_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_create_~head~0#1.base|)) (= (select .cse0 12) 0) (= (select |c_#valid| |c_ULTIMATE.start_dll_create_~head~0#1.base|) 1) (= (select .cse0 |c_ULTIMATE.start_dll_create_~new_head~0#1.offset|) 0)))))
(check-sat)
(exit)
