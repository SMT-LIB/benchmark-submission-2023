...
(assert (not (and (= (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) 8) 1) (= (select |c_#valid| |c_ULTIMATE.start_main_~#s~0#1.base|) 1) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_sll_circular_create_#res#1.offset| 0) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (= |c_ULTIMATE.start_main_~data~0#1| 1) (exists ((|ULTIMATE.start_sll_circular_create_~last~0#1.base| Int)) (and (= (select |c_#valid| |ULTIMATE.start_sll_circular_create_~last~0#1.base|) 1) (= (select (select |c_#memory_int| |ULTIMATE.start_sll_circular_create_~last~0#1.base|) 8) 1) (not (= |c_ULTIMATE.start_sll_circular_create_#res#1.base| |ULTIMATE.start_sll_circular_create_~last~0#1.base|)))) (not (= |c_ULTIMATE.start_sll_circular_create_#res#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) 1))))
(check-sat)
(exit)
