...
(assert (not (let ((.cse1 (+ |c_ULTIMATE.start_main_~t~0#1.offset| 4))) (and (forall ((v_arrayElimArr_22 (Array Int Int)) (v_arrayElimArr_21 (Array Int Int)) (|v_ULTIMATE.start_main_~t~0#1.base_17| Int) (v_arrayElimArr_15 (Array Int Int)) (v_arrayElimArr_16 (Array Int Int))) (or (not (= (select v_arrayElimArr_15 4) |c_ULTIMATE.start_main_~t~0#1.base|)) (= (select (let ((.cse0 (store (store |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~t~0#1.base| v_arrayElimArr_21) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_15))) (select .cse0 (select (select .cse0 |c_ULTIMATE.start_main_~t~0#1.base|) .cse1))) (+ (select (select (store (store |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~t~0#1.base| v_arrayElimArr_22) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_16) |c_ULTIMATE.start_main_~t~0#1.base|) .cse1) 4)) 0) (not (= (select v_arrayElimArr_22 .cse1) |c_ULTIMATE.start_main_~p~0#1.offset_primed|)) (not (= |c_ULTIMATE.start_main_~p~0#1.base_primed| (select v_arrayElimArr_21 .cse1))) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)) (not (= (select v_arrayElimArr_16 4) |c_ULTIMATE.start_main_~t~0#1.offset|)))) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int) (v_arrayElimArr_17 (Array Int Int)) (v_arrayElimArr_19 (Array Int Int)) (v_arrayElimArr_18 (Array Int Int)) (v_arrayElimArr_20 (Array Int Int))) (or (not (= (select v_arrayElimArr_19 .cse1) |c_ULTIMATE.start_main_~p~0#1.offset_primed|)) (not (= (select v_arrayElimArr_18 4) |c_ULTIMATE.start_main_~t~0#1.offset|)) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)) (= 0 (let ((.cse2 (store (store |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~t~0#1.base| v_arrayElimArr_19) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_18))) (select (select .cse2 (select (select (store (store |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~t~0#1.base| v_arrayElimArr_20) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_17) |c_ULTIMATE.start_main_~t~0#1.base|) .cse1)) (+ (select (select .cse2 |c_ULTIMATE.start_main_~t~0#1.base|) .cse1) 4)))) (not (= |c_ULTIMATE.start_main_~t~0#1.base| (select v_arrayElimArr_17 4))) (not (= (select v_arrayElimArr_20 .cse1) |c_ULTIMATE.start_main_~p~0#1.base_primed|))))))))
(check-sat)
(exit)
