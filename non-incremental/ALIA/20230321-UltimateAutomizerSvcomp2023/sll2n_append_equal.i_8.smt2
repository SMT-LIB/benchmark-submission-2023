...
(assert (forall ((|ULTIMATE.start_sll_append_~last~0#1.base| Int) (|v_node_create_~temp~0#1.base_16| Int) (|ULTIMATE.start_sll_append_~last~0#1.offset| Int) (v_ArrVal_562 (Array Int Int)) (v_ArrVal_558 Int)) (let ((.cse2 (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_16| v_ArrVal_562))) (let ((.cse0 (select .cse2 |ULTIMATE.start_sll_append_~last~0#1.base|)) (.cse1 (+ |ULTIMATE.start_sll_append_~last~0#1.offset| 4))) (or (<= |c_#StackHeapBarrier| |v_node_create_~temp~0#1.base_16|) (not (= (select .cse0 .cse1) 0)) (not (= (select (select (store .cse2 |ULTIMATE.start_sll_append_~last~0#1.base| (store .cse0 .cse1 v_ArrVal_558)) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|) 0)))))))
(check-sat)
(exit)
