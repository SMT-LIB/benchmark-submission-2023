...
(assert (= (select (select |#memory_$Pointer$.base| |chain_node_alloc_node_#res#1.base|) 8) 0))
(assert (= |chain_node_alloc_node_#res#1.offset| 0))
(assert (= 1 (select |#valid| |chain_node_alloc_node_#res#1.base|)))
(assert (not (exists ((v_ArrVal_1324 Int)) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |chain_node_alloc_node_#res#1.base| (store (store (select |old(#memory_$Pointer$.offset)| |chain_node_alloc_node_#res#1.base|) 0 v_ArrVal_1324) 8 0))))))
(check-sat)
(exit)
