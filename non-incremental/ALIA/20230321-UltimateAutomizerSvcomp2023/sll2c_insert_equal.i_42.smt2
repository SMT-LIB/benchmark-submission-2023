...
(assert (not (and (= |c_ULTIMATE.start_main_~ptr~0#1.offset| 0) (exists ((|ULTIMATE.start_sll_circular_create_~last~0#1.base| Int)) (and (= (select (select |c_#memory_int| |ULTIMATE.start_sll_circular_create_~last~0#1.base|) 8) 1) (not (= |c_ULTIMATE.start_main_~ptr~0#1.base| |ULTIMATE.start_sll_circular_create_~last~0#1.base|)))) (= |c_ULTIMATE.start_main_~data~0#1| 1) (= 1 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~ptr~0#1.base|) 8)))))
(check-sat)
(exit)
