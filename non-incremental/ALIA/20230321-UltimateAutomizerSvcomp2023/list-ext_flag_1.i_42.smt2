...
(assert (not (forall ((|v_ULTIMATE.start_main_~t~0#1.base_14| Int)) (or (forall ((v_ArrVal_335 Int) (v_ArrVal_339 (Array Int Int))) (= (select (select (store (store |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base|) (+ |c_ULTIMATE.start_main_~p~0#1.offset| 8) v_ArrVal_335)) |v_ULTIMATE.start_main_~t~0#1.base_14| v_ArrVal_339) |c_ULTIMATE.start_main_~a~0#1.base|) (+ |c_ULTIMATE.start_main_~a~0#1.offset| 4)) 0)) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_14|) 0))))))
(check-sat)
(exit)
