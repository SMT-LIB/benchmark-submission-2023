...
(assert (not (let ((.cse4 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|))) (let ((.cse0 (select .cse4 12))) (let ((.cse3 (select |c_#memory_$Pointer$.base| .cse0))) (let ((.cse1 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|)) (.cse2 (select .cse3 4))) (and (= (select (select |c_#memory_$Pointer$.offset| .cse0) 4) 0) (= (select .cse1 4) 0) (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~list~0#1.base| .cse0)) (not (= |c_ULTIMATE.start_main_~list~0#1.base| .cse2)) (= (select .cse3 12) |c_ULTIMATE.start_main_~list~0#1.base|) (= (select .cse1 12) 0) (not (= .cse2 .cse0)) (<= 100 (select (select |c_#memory_int| .cse2) 0)) (= .cse2 (select .cse4 4)) (<= 1 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~list~0#1.base|) 0)))))))))
(check-sat)
(exit)
