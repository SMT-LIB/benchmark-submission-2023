...
(assert (not (exists ((v_ArrVal_1471 Int) (v_ArrVal_1476 (Array Int Int)) (|list_add___list_add_~next#1.offset| Int) (v_ArrVal_1470 (Array Int Int))) (= (let ((.cse0 (let ((.cse1 (select (select |old(#memory_$Pointer$.base)| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|))) (store |old(#memory_$Pointer$.base)| .cse1 (store (select |old(#memory_$Pointer$.base)| .cse1) (+ |list_add___list_add_~next#1.offset| 8) |list_add_#in~new#1.base|))))) (store (store .cse0 |list_add_#in~new#1.base| v_ArrVal_1470) |list_add_#in~head#1.base| (store (select (store .cse0 |list_add_#in~new#1.base| v_ArrVal_1476) |list_add_#in~head#1.base|) |list_add_#in~head#1.offset| v_ArrVal_1471))) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
