...
(assert (or (and (< |c_ULTIMATE.start_main_~i~0#1| 20) |c_ULTIMATE.start_main_#t~short5#1_primed|) (and (not |c_ULTIMATE.start_main_#t~short5#1_primed|) (<= 20 |c_ULTIMATE.start_main_~i~0#1|))))
