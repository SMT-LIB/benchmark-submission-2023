...
(assert (let ((.cse0 (+ 4 c_insert_list_~l.offset))) (and (= c_~head~0.offset 0) (= (store |c_#memory_$Pointer$.offset| c_insert_list_~l.base (store (select |c_#memory_$Pointer$.offset| c_insert_list_~l.base) .cse0 0)) |c_#memory_$Pointer$.offset_primed|) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| c_insert_list_~l.base (store (select |c_#memory_$Pointer$.base| c_insert_list_~l.base) .cse0 0))) (= |c_#memory_int_primed| (store |c_#memory_int| c_insert_list_~l.base (store (select |c_#memory_int| c_insert_list_~l.base) .cse0 (select (select |c_#memory_int_primed| c_insert_list_~l.base) .cse0)))) (= c_~head~0.base 0))))
...
(assert (not (and (= (store |c_old(#valid)| c_insert_list_~l.base 1) |c_#valid|) (= (select |c_old(#valid)| c_insert_list_~l.base) 0) (exists ((v_ArrVal_1075 (Array Int Int))) (= |c_#memory_int_primed| (store |c_old(#memory_int)| c_insert_list_~l.base v_ArrVal_1075))) (= |c_old(~head~0.base)| (select (select |c_#memory_$Pointer$.base_primed| c_insert_list_~l.base) 4)) (= c_insert_list_~l.offset 0) (= (select (select |c_#memory_$Pointer$.offset_primed| c_insert_list_~l.base) 4) |c_old(~head~0.offset)|))))
(check-sat)
(exit)
