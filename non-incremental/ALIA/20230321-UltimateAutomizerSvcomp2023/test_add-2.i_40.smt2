...
(assert (let ((.cse0 (= |__ldv_list_add_#in~next.base| |__ldv_list_add_#in~prev.base|)) (.cse5 (= (select (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~prev.base|) |__ldv_list_add_#in~prev.offset|) |__ldv_list_add_#in~new.offset|)) (.cse6 (= |__ldv_list_add_#in~new.base| |__ldv_list_add_#in~prev.base|))) (or (and (or .cse0 (exists ((v_DerPreprocessor_9 (Array Int Int))) (and (exists ((v_DerPreprocessor_7 (Array Int Int)) (v_DerPreprocessor_8 (Array Int Int))) (let ((.cse1 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9) |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9))) (let ((.cse2 (select .cse1 |__ldv_list_add_#in~next.base|))) (and (= (select .cse1 |__ldv_list_add_#in~new.base|) v_DerPreprocessor_8) (= .cse2 v_DerPreprocessor_7) (= (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base|) .cse2) (exists ((v_prenex_9 (Array Int Int)) (v_prenex_10 (Array Int Int)) (v_prenex_11 (Array Int Int))) (let ((.cse4 (store (store (store (store (store (store .cse1 |__ldv_list_add_#in~next.base| v_prenex_9) |__ldv_list_add_#in~new.base| v_prenex_11) |__ldv_list_add_#in~prev.base| v_prenex_10) |__ldv_list_add_#in~next.base| v_prenex_9) |__ldv_list_add_#in~new.base| v_prenex_11) |__ldv_list_add_#in~prev.base| v_prenex_10))) (let ((.cse3 (select .cse4 |__ldv_list_add_#in~next.base|))) (and (= .cse2 .cse3) (= v_prenex_11 (select .cse4 |__ldv_list_add_#in~new.base|)) (= |__ldv_list_add_#in~new.offset| (select v_prenex_10 |__ldv_list_add_#in~prev.offset|)) (= .cse3 v_prenex_9))))))))) (= (select v_DerPreprocessor_9 |__ldv_list_add_#in~prev.offset|) |__ldv_list_add_#in~new.offset|)))) .cse5 .cse6) (and (or (and (exists ((v_DerPreprocessor_5 (Array Int Int)) (v_DerPreprocessor_4 (Array Int Int)) (v_DerPreprocessor_6 (Array Int Int))) (let ((.cse7 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6) |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6))) (and (= v_DerPreprocessor_4 (select .cse7 |__ldv_list_add_#in~next.base|)) (= (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~new.base|) (select .cse7 |__ldv_list_add_#in~new.base|)) (= (select v_DerPreprocessor_6 |__ldv_list_add_#in~prev.offset|) |__ldv_list_add_#in~new.offset|)))) .cse5) (and (not .cse0) .cse5)) (not .cse6)))))
(assert (= |~#s1~0.base| 3))
