...
(declare-fun |c_mutex_lock_~m#1.base| () Int)
...
(assert (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= |c_mutex_lock_#in~m#1.base| |c_mutex_lock_~m#1.base|) (= |c_#valid| |c_old(#valid)|) (= |c_~#mutexes~0.offset| 0) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (= 3 |c_~#mutexes~0.base|)))
