...
(assert (not (and (not (= |c_ULTIMATE.start_main_~m~0#1.base| |c_ULTIMATE.start_main_~head~0#1.base|)) (<= 100 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~m~0#1.base|) 0)) (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (= |c_ULTIMATE.start_main_~head~0#1.offset| 0) (= |c_ULTIMATE.start_main_~list~0#1.base| |c_ULTIMATE.start_main_~head~0#1.base|) (= (select |c_#valid| |c_ULTIMATE.start_main_~m~0#1.base|) 1) (<= 1 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~head~0#1.base|) 0)) (= |c_ULTIMATE.start_main_~m~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~head~0#1.base|) 4)) (= (select |c_#valid| |c_ULTIMATE.start_main_~head~0#1.base|) 1) (= 0 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~head~0#1.base|) 4)) (= |c_ULTIMATE.start_main_~m~0#1.offset| 0))))
(check-sat)
(exit)
