...
(assert (exists ((v_ArrVal_719 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_719))))
...
(assert (exists ((v_ArrVal_716 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_716))))
(assert (not (exists ((v_ArrVal_715 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_715)))))
(check-sat)
(exit)
