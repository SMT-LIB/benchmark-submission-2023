...
(assert (exists ((v_ArrVal_1399 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1399))))
(assert (<= (+ |node_create_#res#1.base| 1) |#StackHeapBarrier|))
(assert (not (exists ((v_ArrVal_1398 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1398) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
