...
(assert (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= |c_~#pstate~0.offset| 0) (= (select (select |c_#memory_int| |c_~#pstate~0.base|) 0) 1) (<= |c_~#pp~0.base| 4) (= |c_old(#memory_int)| |c_#memory_int|) (= |c_g_#t~mem9#1| 1) (= |c_old(~counter~0)| c_~counter~0) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (<= 5 |c_~#pstate~0.base|)))
(assert (not (and (= |c_~#pstate~0.offset| 0) (= (select (select |c_#memory_int| |c_~#pstate~0.base|) 0) 1) (<= |c_~#pp~0.base| 4) (= |c_old(~counter~0)| c_~counter~0) (<= 5 |c_~#pstate~0.base|) (exists ((f_~i~1 Int) (v_ArrVal_653 (Array Int Int)) (v_ArrVal_655 Int)) (and (<= 1 f_~i~1) (= (let ((.cse0 (store |c_old(#memory_int)| |c_~#pp~0.base| v_ArrVal_653))) (store .cse0 |c_~#pstate~0.base| (store (select .cse0 |c_~#pstate~0.base|) (* f_~i~1 4) v_ArrVal_655))) |c_#memory_int|))))))
(check-sat)
(exit)
