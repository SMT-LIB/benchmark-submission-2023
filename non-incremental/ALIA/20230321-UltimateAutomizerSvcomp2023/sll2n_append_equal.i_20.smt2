...
(declare-fun |c_ULTIMATE.start_sll_append_#t~ret7#1.offset| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~last~0#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~last~0#1.offset| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~head#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~head#1.offset| () Int)
...
(assert (not (let ((.cse2 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_append_~head#1.base|))) (let ((.cse0 (select .cse2 |c_ULTIMATE.start_main_~#s~0#1.offset|)) (.cse1 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_append_~head#1.base|) |c_ULTIMATE.start_sll_append_~head#1.offset|))) (and (= |c_ULTIMATE.start_sll_append_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= .cse0 0)) (= |c_ULTIMATE.start_sll_append_#t~ret7#1.offset| 0) (<= 0 .cse1) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| .cse0) 0)) (not (= .cse0 |c_ULTIMATE.start_sll_append_~head#1.base|)) (<= .cse1 0) (= |c_ULTIMATE.start_sll_append_~head#1.offset| |c_ULTIMATE.start_main_~#s~0#1.offset|) (= (select (select |c_#memory_$Pointer$.offset| (select .cse2 |c_ULTIMATE.start_sll_append_~head#1.offset|)) (+ .cse1 4)) 0))))))
(check-sat)
(exit)
