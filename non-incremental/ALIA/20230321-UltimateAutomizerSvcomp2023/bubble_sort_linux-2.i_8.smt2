...
(assert (let ((.cse1 (select |c_#memory_$Pointer$.base| 3))) (let ((.cse0 (select .cse1 0))) (and (= .cse0 (select .cse1 8)) (not (= .cse0 3)) (= |c_~#gl_list~0.offset| 0) (= 3 |c_~#gl_list~0.base|) (not (= |c_ULTIMATE.start_gl_insert_~node~1#1.base| .cse0)) (not (= |c_ULTIMATE.start_gl_insert_~node~1#1.base| 3))))))
