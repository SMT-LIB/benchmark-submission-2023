...
(declare-fun |c_dll_insert_master_~dll#1.base_primed| () Int)
(declare-fun |c_dll_insert_master_~dll#1.offset_primed| () Int)
(declare-fun |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed| () Int)
(declare-fun |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.offset_primed| () Int)
...
(assert (and (= |c_dll_insert_master_#in~dll#1.base| |c_dll_insert_master_~dll#1.base_primed|) (= (select |c_#valid| |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed|) 0) (= |c_dll_insert_master_~dll#1.offset_primed| |c_dll_insert_master_#in~dll#1.offset|) (= |c_#valid_primed| (store |c_#valid| |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed| 1)) (< |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed| |c_#StackHeapBarrier|) (not (= |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed| 0)) (= |c_#length_primed| (store |c_#length| |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.base_primed| 24)) (= |c_dll_insert_master_alloc_or_die_master_~ptr~1#1.offset_primed| 0)))
