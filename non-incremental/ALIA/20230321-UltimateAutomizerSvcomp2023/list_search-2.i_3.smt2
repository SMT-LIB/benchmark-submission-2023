...
(assert (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= |c_old(~head~0.base)| c_~head~0.base) (= c_insert_list_~l.offset 0) (= c_~head~0.offset |c_old(~head~0.offset)|) (= (select |c_old(#valid)| c_insert_list_~l.base) 0)))
(assert (not (and (exists ((v_arrayElimArr_2 (Array Int Int))) (and (= (store |c_old(#memory_$Pointer$.offset)| c_insert_list_~l.base v_arrayElimArr_2) |c_#memory_$Pointer$.offset|) (= (select v_arrayElimArr_2 4) |c_old(~head~0.offset)|))) (= c_insert_list_~l.offset 0) (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= |c_old(~head~0.base)| (select v_arrayElimArr_1 4)) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| c_insert_list_~l.base v_arrayElimArr_1)))))))
(check-sat)
(exit)
