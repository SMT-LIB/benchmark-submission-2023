...
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~mem10#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~mem10#1.offset| () Int)
...
(assert (not (let ((.cse1 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|)) (.cse2 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base| .cse1) .cse2))) (and (or (and (= |c_ULTIMATE.start_sll_circular_prepend_#t~mem10#1.offset| 0) (= (select (select |c_#memory_$Pointer$.base| .cse0) (select (select |c_#memory_$Pointer$.offset| .cse1) .cse2)) 0) (= |c_ULTIMATE.start_sll_circular_prepend_#t~mem10#1.base| .cse1)) (not (= .cse0 |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|))) (= |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.offset| 0) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset| |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|)) (= |c_ULTIMATE.start_main_~uneq~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|) 8)) (not (= .cse0 |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|)))))))
(check-sat)
(exit)
