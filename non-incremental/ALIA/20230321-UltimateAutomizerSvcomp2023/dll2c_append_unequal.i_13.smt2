...
(assert (exists ((v_ArrVal_1081 (Array Int Int))) (= (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1081) |#memory_int|)))
(assert (= (select (select |#memory_$Pointer$.offset| |node_create_#res#1.base|) 8) 0))
(assert (not (exists ((v_ArrVal_1079 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1079)))))
(check-sat)
(exit)
