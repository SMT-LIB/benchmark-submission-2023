...
(assert (not (and (exists ((v_ArrVal_1351 (Array Int Int))) (= (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base v_ArrVal_1351) |c_#memory_$Pointer$.base|)) (= |c_append_#in~head.base| c_append_~head.base) (exists ((v_ArrVal_1352 (Array Int Int))) (= (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base v_ArrVal_1352) |c_#memory_$Pointer$.offset|)) (= (select |c_old(#valid)| c_append_~node~0.base) 0) (= |c_#valid| (store |c_old(#valid)| c_append_~node~0.base (select |c_#valid| c_append_~node~0.base))))))
(check-sat)
(exit)
