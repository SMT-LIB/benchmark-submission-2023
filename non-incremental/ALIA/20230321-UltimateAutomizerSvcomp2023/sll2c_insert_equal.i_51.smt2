...
(assert (exists ((v_ArrVal_427 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_427))))
...
(assert (not (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= (select v_arrayElimArr_1 8) |node_create_#in~data#1|) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_arrayElimArr_1))))))
(check-sat)
(exit)
