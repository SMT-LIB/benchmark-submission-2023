...
(assert (not (and (= (select (select |c_#memory_int_primed| (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~ptr~0#1.base|) 4)) (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~ptr~0#1.base|) 4)) |c_ULTIMATE.start_main_~data_init~0#1|) (= |c_ULTIMATE.start_main_~data_init~0#1| |c_ULTIMATE.start_main_~data_new~0#1|) (= |c_ULTIMATE.start_main_~ptr~0#1.offset| 0) (= |c_ULTIMATE.start_main_#t~mem7#1| (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~ptr~0#1.base|) 0)))))
(check-sat)
(exit)
