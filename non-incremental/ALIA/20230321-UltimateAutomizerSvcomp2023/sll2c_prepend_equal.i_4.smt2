...
(assert (exists ((v_ArrVal_527 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_527))))
(assert (<= (+ |node_create_#res#1.base| 1) |#StackHeapBarrier|))
(assert (not (exists ((v_ArrVal_526 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_526)))))
(check-sat)
(exit)
