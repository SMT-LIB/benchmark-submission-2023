...
(assert (not (and (= |c_append_#in~head.base| c_append_~head.base) (= (select |c_old(#valid)| c_append_~node~0.base) 0) (exists ((v_ArrVal_1589 (Array Int Int)) (v_DerPreprocessor_8 (Array Int Int))) (= |c_#memory_$Pointer$.offset| (store (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base v_DerPreprocessor_8) c_append_~head.base v_ArrVal_1589))) (= |c_#valid| (store |c_old(#valid)| c_append_~node~0.base (select |c_#valid| c_append_~node~0.base))) (exists ((v_DerPreprocessor_7 (Array Int Int)) (v_ArrVal_1590 (Array Int Int))) (= (store (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base v_DerPreprocessor_7) c_append_~head.base v_ArrVal_1590) |c_#memory_$Pointer$.base|)))))
(check-sat)
(exit)
