...
(assert (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= 0 c_f_~i~1) (= |c_~#pstate~0.offset| 0) (<= |c_~#pp~0.base| 4) (= |c_old(#memory_int)| |c_#memory_int|) (= |c_old(~counter~0)| c_~counter~0) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (<= 5 |c_~#pstate~0.base|)))
