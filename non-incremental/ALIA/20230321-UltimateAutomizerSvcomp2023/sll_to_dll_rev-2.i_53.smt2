...
(assert (exists ((v_ArrVal_983 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |chain_node_alloc_node_#res#1.base| v_ArrVal_983) |#memory_$Pointer$.base|)))
...
(assert (not (exists ((v_ArrVal_982 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |chain_node_alloc_node_#res#1.base| v_ArrVal_982)))))
(check-sat)
(exit)
