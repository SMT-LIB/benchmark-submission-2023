...
(assert (exists ((v_ArrVal_1031 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1031))))
(assert (exists ((v_ArrVal_1028 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1028) |#memory_$Pointer$.base|)))
...
(assert (not (exists ((v_ArrVal_1029 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1029)))))
(check-sat)
(exit)
