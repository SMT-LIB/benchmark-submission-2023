...
(assert (not (let ((.cse2 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.base|))) (let ((.cse1 (select .cse2 0)) (.cse0 (select .cse2 8))) (and (not (= .cse0 .cse1)) (= (select |c_#valid| .cse1) 1) (not (= .cse0 |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.base|)) (not (= .cse1 |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.base|)) (= |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.offset| 0) (= .cse0 |c_ULTIMATE.start_create_sl_with_head_and_tail_#t~mem12#1.base|) (= (select |c_#valid| |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.base|) 1) (= .cse0 |c_ULTIMATE.start_create_sl_with_head_and_tail_#t~mem11#1.base|) (= .cse0 (select (select |c_#memory_$Pointer$.base| .cse1) (+ 16 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_create_sl_with_head_and_tail_~sl~0#1.base|) 0)))) (= (select |c_#valid| .cse0) 1))))))
(check-sat)
(exit)
