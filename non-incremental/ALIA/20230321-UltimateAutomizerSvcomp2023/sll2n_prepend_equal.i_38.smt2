...
(assert (exists ((v_ArrVal_982 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_982))))
...
(assert (not (exists ((v_ArrVal_980 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_980) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
