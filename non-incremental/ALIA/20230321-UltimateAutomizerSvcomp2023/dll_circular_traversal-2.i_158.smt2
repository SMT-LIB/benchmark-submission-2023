...
(assert (not (= |c_ULTIMATE.start_main_~data_init~0#1| (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~ptr~0#1.base|) |c_ULTIMATE.start_main_~ptr~0#1.offset|))))
(check-sat)
(exit)
