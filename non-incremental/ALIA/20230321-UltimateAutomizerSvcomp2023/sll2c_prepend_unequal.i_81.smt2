...
(declare-fun |c_ULTIMATE.start_sll_circular_create_#t~ret4#1.offset| () Int)
...
(assert (not (and (= |c_ULTIMATE.start_sll_circular_create_#t~ret4#1.offset| 0) (= (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_#t~ret4#1.base|) 1) (not (= |c_ULTIMATE.start_sll_circular_create_#t~ret4#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (<= (+ |c_#StackHeapBarrier| 1) |c_ULTIMATE.start_main_~#s~0#1.base|))))
(check-sat)
(exit)
