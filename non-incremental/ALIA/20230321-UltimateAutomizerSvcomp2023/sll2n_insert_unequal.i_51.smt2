...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) 0))) (and (<= (+ .cse0 2) |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_sll_insert_~new_node~0#1.offset| 0) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (= .cse0 |c_ULTIMATE.start_sll_insert_~last~0#1.base|) (= (select (select |c_#memory_int| .cse0) 0) 1) (= |c_ULTIMATE.start_main_~data~0#1| 1) (<= (+ 2 |c_ULTIMATE.start_sll_insert_~new_node~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.base|) (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) 0) 0) (= |c_ULTIMATE.start_sll_insert_~last~0#1.offset| 0) (not (= .cse0 |c_ULTIMATE.start_sll_insert_~new_node~0#1.base|))))))
(check-sat)
(exit)
