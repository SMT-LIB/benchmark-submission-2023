...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~a~0#1.base|) 4))) (and (not (= .cse0 |c_ULTIMATE.start_main_~a~0#1.base|)) (not (= .cse0 0)) (= .cse0 |c_ULTIMATE.start_main_~p~0#1.base|) (= |c_ULTIMATE.start_main_~t~0#1.offset| 0) (= |c_ULTIMATE.start_main_~a~0#1.offset| 0)))))
(check-sat)
(exit)
