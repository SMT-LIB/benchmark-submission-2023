...
(assert (not (let ((.cse2 (+ |c_ULTIMATE.start_main_~p~0#1.offset_primed| 4))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) .cse2)) (.cse1 (+ 4 (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) .cse2)))) (and (= (select (select |c_#memory_$Pointer$.offset_primed| .cse0) .cse1) 0) (= 0 (select (select |c_#memory_$Pointer$.base_primed| .cse0) .cse1)))))))
(check-sat)
(exit)
