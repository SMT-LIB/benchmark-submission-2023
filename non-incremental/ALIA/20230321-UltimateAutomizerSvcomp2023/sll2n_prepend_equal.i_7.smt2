...
(assert (exists ((v_ArrVal_584 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_584))))
...
(assert (= (let ((.cse0 (ULTIMATE@diffIntArray_Int_Int |old(#memory_int)| |#memory_int|))) (store |old(#memory_int)| .cse0 (select |#memory_int| .cse0))) |#memory_int|))
...
(assert (exists ((v_ArrVal_585 (Array Int Int))) (= (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_585) |#memory_int|)))
(assert (not (exists ((v_ArrVal_587 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_587)))))
(check-sat)
(exit)
