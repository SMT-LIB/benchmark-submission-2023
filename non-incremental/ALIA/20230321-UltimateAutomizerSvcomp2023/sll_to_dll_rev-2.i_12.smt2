...
(assert (not (exists ((v_ArrVal_328 (Array Int Int)) (v_ArrVal_327 (Array Int Int)) (v_ArrVal_329 (Array Int Int)) (|chain_node_~node~0#1.base| Int) (|chain_node_alloc_node_~ptr~0#1.base| Int)) (and (< |chain_node_alloc_node_~ptr~0#1.base| |#StackHeapBarrier|) (= |#memory_$Pointer$.base| (store (store (store |old(#memory_$Pointer$.base)| |chain_node_alloc_node_~ptr~0#1.base| v_ArrVal_327) |chain_node_~node~0#1.base| v_ArrVal_328) |chain_node_#in~ppnode#1.base| v_ArrVal_329)) (<= |chain_node_~node~0#1.base| |chain_node_alloc_node_~ptr~0#1.base|)))))
(check-sat)
(exit)
