...
(assert (not (and (= (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) 4) 0) (not (= |c_ULTIMATE.start_main_~t~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base_primed|)) (= |c_ULTIMATE.start_main_~t~0#1.offset| 0) (= |c_ULTIMATE.start_main_~p~0#1.offset_primed| 0) (let ((.cse0 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) 4))) (or (= .cse0 |c_ULTIMATE.start_main_~t~0#1.base|) (and (= (select (select |c_#memory_$Pointer$.offset_primed| .cse0) 4) 0) (= (select (select |c_#memory_$Pointer$.base_primed| .cse0) 4) 0)))))))
(check-sat)
(exit)
