...
(assert (not (and (= 0 |c_ULTIMATE.start_main_~p~0#1.base_primed|) (= (select |c_#valid| |c_ULTIMATE.start_main_~t~0#1.base|) 1) (= |c_ULTIMATE.start_main_~t~0#1.offset| 0) (= |c_ULTIMATE.start_main_~p~0#1.offset_primed| 0))))
(check-sat)
(exit)
