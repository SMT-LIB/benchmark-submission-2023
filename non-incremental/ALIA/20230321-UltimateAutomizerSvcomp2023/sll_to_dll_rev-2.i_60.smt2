...
(assert (not (and (= (select (select |#memory_$Pointer$.base| |chain_node_#in~ppnode#1.base|) |chain_node_#in~ppnode#1.offset|) |chain_node_#in~ppnode#1.base|) (not (= |chain_node_#in~ppnode#1.base| 0)))))
(check-sat)
(exit)
