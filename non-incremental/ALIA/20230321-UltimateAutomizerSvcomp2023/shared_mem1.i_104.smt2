...
(assert (not (let ((.cse5 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|))) (let ((.cse0 (select .cse5 12))) (let ((.cse2 (select |c_#memory_$Pointer$.base| .cse0))) (let ((.cse1 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|)) (.cse3 (select .cse2 4)) (.cse4 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~list~0#1.base|) 0))) (and (= (select (select |c_#memory_$Pointer$.offset| .cse0) 4) 0) (= (select .cse1 4) 0) (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~list~0#1.base| .cse0)) (= (select .cse2 12) |c_ULTIMATE.start_main_~list~0#1.base|) (= (select .cse1 12) 0) (not (= .cse3 .cse0)) (<= (+ .cse4 100) (select (select |c_#memory_int| .cse3) 0)) (= .cse3 (select .cse5 4)) (<= 1 .cse4))))))))
(check-sat)
(exit)
