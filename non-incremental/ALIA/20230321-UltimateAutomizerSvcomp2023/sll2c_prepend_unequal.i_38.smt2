...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) 0))) (and (<= (+ .cse0 2) |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (exists ((v_arrayElimCell_47 Int) (v_arrayElimCell_48 Int)) (let ((.cse1 (select (select |c_#memory_$Pointer$.base| v_arrayElimCell_47) v_arrayElimCell_48))) (and (not (= v_arrayElimCell_47 |c_ULTIMATE.start_main_~#s~0#1.base|)) (not (= .cse0 v_arrayElimCell_47)) (not (= .cse0 .cse1)) (not (= .cse1 |c_ULTIMATE.start_main_~#s~0#1.base|)) (not (= .cse1 v_arrayElimCell_47))))) (= |c_ULTIMATE.start_main_~uneq~0#1| (select (select |c_#memory_int| .cse0) 8)) (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) 0) 0)))))
(check-sat)
(exit)
