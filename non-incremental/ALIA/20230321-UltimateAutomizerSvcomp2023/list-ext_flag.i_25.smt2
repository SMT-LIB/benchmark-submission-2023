...
(assert (not (and (= |c_ULTIMATE.start_main_~a~0#1.offset| |c_ULTIMATE.start_main_~p~0#1.offset|) (= (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base|) |c_ULTIMATE.start_main_~p~0#1.offset|) 2) (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|) (= (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|) 1))))
(check-sat)
(exit)
