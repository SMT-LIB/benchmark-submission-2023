...
(assert (not (let ((.cse2 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~bucket~0#1.base|) 0))) (let ((.cse1 (select |c_#memory_$Pointer$.base| .cse2))) (let ((.cse0 (select .cse1 0)) (.cse3 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~bucket~0#1.base|))) (and (not (= |c_ULTIMATE.start_main_~bucket~0#1.base| |c_ULTIMATE.start_main_~item~0#1.base|)) (not (= .cse0 0)) (= 0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base|) 0)) (= (select .cse1 8) 0) (= (select |c_#valid| |c_ULTIMATE.start_main_~bucket~0#1.base|) 1) (not (= .cse0 .cse2)) (not (= .cse0 |c_ULTIMATE.start_main_~bucket~0#1.base|)) (not (= |c_ULTIMATE.start_main_~item~0#1.base| 0)) (= |c_ULTIMATE.start_main_~bucket~0#1.offset| 0) (= (select .cse3 0) 0) (= |c_ULTIMATE.start_main_~item~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~bcki~0#1.base| 0)) (= (select |c_#valid| .cse2) 1) (= (select .cse3 8) 0)))))))
(check-sat)
(exit)
