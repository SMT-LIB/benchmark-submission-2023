...
(assert (not (and (= |c_ULTIMATE.start_main_~p~0#1.offset| 0) (or (<= 10 |c_ULTIMATE.start_main_#t~mem9#1|) (not (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~p~0#1.base|) 4) 0))))))
(check-sat)
(exit)
