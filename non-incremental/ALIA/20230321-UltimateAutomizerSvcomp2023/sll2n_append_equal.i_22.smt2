...
(declare-fun |c_ULTIMATE.start_sll_append_#t~mem11#1.offset| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~last~0#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~last~0#1.offset| () Int)
(declare-fun |c_ULTIMATE.start_sll_append_~new_last~0#1.offset| () Int)
...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))) (and (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|) 0) (= |c_ULTIMATE.start_sll_append_~new_last~0#1.offset| 0) (not (= .cse0 |c_ULTIMATE.start_main_~#s~0#1.base|)) (= |c_ULTIMATE.start_sll_append_#t~mem11#1.offset| 0) (= |c_ULTIMATE.start_sll_append_~last~0#1.offset| 0) (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_append_~last~0#1.base|) 4) 0) (not (= 0 .cse0)) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| .cse0) 0))))))
(check-sat)
(exit)
