...
(assert (exists ((v_ArrVal_1395 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1395))))
(assert (= 0 (select |old(#valid)| |node_create_~temp~0#1.base|)))
(assert (= 0 |node_create_#res#1.offset|))
(assert (exists ((v_ArrVal_1398 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1398) |#memory_$Pointer$.base|)))
...
(assert (not (exists ((v_ArrVal_1399 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1399)))))
(check-sat)
(exit)
