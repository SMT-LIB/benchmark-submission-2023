...
(assert (not (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= (select |c_#valid| 3) 1) (= |c_~#gl_list~0.offset| 0) (= 3 |c_~#gl_list~0.base|) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|))))
(check-sat)
(exit)
