...
(assert (exists ((v_ArrVal_986 (Array Int Int)) (v_ArrVal_981 (Array Int Int)) (v_ArrVal_984 (Array Int Int))) (= |#memory_$Pointer$.base| (let ((.cse0 (select (select |old(#memory_$Pointer$.base)| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|))) (store (store (store |old(#memory_$Pointer$.base)| .cse0 v_ArrVal_986) |list_add_#in~new#1.base| v_ArrVal_984) |list_add_#in~head#1.base| (store (select (store (store |old(#memory_$Pointer$.base)| .cse0 (store (select |old(#memory_$Pointer$.base)| .cse0) (+ (select (select |old(#memory_$Pointer$.offset)| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|) 8) |list_add_#in~new#1.base|)) |list_add_#in~new#1.base| v_ArrVal_981) |list_add_#in~head#1.base|) |list_add_#in~head#1.offset| |list_add_#in~new#1.base|))))))
...
(assert (exists ((|v_ULTIMATE.start_gl_insert_~node~1#1.base_BEFORE_CALL_1| Int)) (and (not (= 3 |v_ULTIMATE.start_gl_insert_~node~1#1.base_BEFORE_CALL_1|)) (= (select |#valid| |v_ULTIMATE.start_gl_insert_~node~1#1.base_BEFORE_CALL_1|) 1))))
(assert (= |~#gl_list~0.offset| 0))
(assert (not (let ((.cse2 (select (select |old(#memory_$Pointer$.base)| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|))) (or (exists ((v_DerPreprocessor_1 (Array Int Int)) (v_DerPreprocessor_3 (Array Int Int)) (v_DerPreprocessor_2 (Array Int Int)) (v_DerPreprocessor_7 (Array Int Int)) (v_DerPreprocessor_9 (Array Int Int)) (v_DerPreprocessor_8 (Array Int Int))) (let ((.cse4 (store (store (store (store (store (store |#memory_$Pointer$.offset| .cse2 v_DerPreprocessor_7) |list_add_#in~new#1.base| v_DerPreprocessor_8) |list_add_#in~head#1.base| v_DerPreprocessor_9) .cse2 v_DerPreprocessor_7) |list_add_#in~new#1.base| v_DerPreprocessor_8) |list_add_#in~head#1.base| v_DerPreprocessor_9))) (let ((.cse1 (store (store (store (store (store (store |#memory_$Pointer$.offset| .cse2 v_DerPreprocessor_1) |list_add_#in~new#1.base| v_DerPreprocessor_2) |list_add_#in~head#1.base| v_DerPreprocessor_3) .cse2 v_DerPreprocessor_1) |list_add_#in~new#1.base| v_DerPreprocessor_2) |list_add_#in~head#1.base| v_DerPreprocessor_3)) (.cse0 (select (select |#memory_$Pointer$.offset| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|)) (.cse3 (select .cse4 |list_add_#in~new#1.base|))) (and (= .cse0 (select v_DerPreprocessor_9 |list_add_#in~head#1.offset|)) (= (select .cse1 .cse2) v_DerPreprocessor_1) (= (select .cse1 |list_add_#in~new#1.base|) .cse3) (= .cse0 (select v_DerPreprocessor_3 |list_add_#in~head#1.offset|)) (= (select .cse4 .cse2) v_DerPreprocessor_7) (= (select |#memory_$Pointer$.offset| |list_add_#in~new#1.base|) .cse3))))) (not (= .cse2 |list_add_#in~head#1.base|)) (= |list_add_#in~head#1.base| |list_add_#in~new#1.base|)))))
(check-sat)
(exit)
