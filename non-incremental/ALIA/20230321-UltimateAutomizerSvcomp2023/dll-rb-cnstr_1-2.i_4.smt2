...
(assert (or (not (= (select |#valid| |ULTIMATE.start_main_~end~0#1.base|) 0)) (forall ((v_prenex_8 (Array Int Int)) (v_arrayElimCell_14 Int) (v_ArrVal_299 (Array Int Int)) (v_prenex_7 (Array Int Int)) (v_prenex_9 Int)) (or (= (select (select (store (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_299) v_arrayElimCell_14 v_prenex_7) v_prenex_9 v_prenex_8) |ULTIMATE.start_main_~list~0#1.base|) (+ 16 |ULTIMATE.start_main_~list~0#1.offset|)) 1) (not (= (select (store |#valid| |ULTIMATE.start_main_~end~0#1.base| 1) v_arrayElimCell_14) 0))))))
(assert (forall ((v_arrayElimCell_13 Int)) (or (not (= (select |#valid| v_arrayElimCell_13) 0)) (forall ((v_prenex_12 Int)) (or (forall ((v_ArrVal_298 Int) (v_prenex_10 (Array Int Int)) (v_prenex_11 (Array Int Int))) (= (select (select (store (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~end~0#1.base|) |ULTIMATE.start_main_~end~0#1.offset| v_ArrVal_298)) v_arrayElimCell_13 v_prenex_10) v_prenex_12 v_prenex_11) |ULTIMATE.start_main_~list~0#1.base|) (+ 16 |ULTIMATE.start_main_~list~0#1.offset|)) 1)) (not (= (select (store |#valid| v_arrayElimCell_13 1) v_prenex_12) 0)))) (= |ULTIMATE.start_main_~end~0#1.base| v_arrayElimCell_13))))
(assert (or (forall ((v_ArrVal_304 (Array Int Int)) (v_ArrVal_306 (Array Int Int)) (v_ArrVal_305 (Array Int Int)) (v_arrayElimCell_14 Int) (v_ArrVal_299 (Array Int Int)) (v_arrayElimCell_12 Int) (v_arrayElimCell_11 Int)) (let ((.cse0 (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_299) v_arrayElimCell_14 v_ArrVal_304)) (.cse1 (+ 16 |ULTIMATE.start_main_~list~0#1.offset|))) (or (= (select (select (store (store .cse0 v_arrayElimCell_11 v_ArrVal_306) v_arrayElimCell_12 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse1) 1) (= (select (select (store .cse0 v_arrayElimCell_11 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse1) 1) (not (= (select (store |#valid| |ULTIMATE.start_main_~end~0#1.base| 1) v_arrayElimCell_11) 0))))) (not (= (select |#valid| |ULTIMATE.start_main_~end~0#1.base|) 0))))
(assert (forall ((v_arrayElimCell_13 Int)) (or (forall ((v_arrayElimCell_11 Int)) (or (forall ((v_ArrVal_304 (Array Int Int)) (v_ArrVal_305 (Array Int Int)) (v_ArrVal_298 Int)) (let ((.cse0 (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~end~0#1.base|) |ULTIMATE.start_main_~end~0#1.offset| v_ArrVal_298))) (.cse1 (+ 16 |ULTIMATE.start_main_~list~0#1.offset|))) (or (forall ((v_ArrVal_306 (Array Int Int)) (v_arrayElimCell_14 Int) (v_ArrVal_299 (Array Int Int)) (v_arrayElimCell_12 Int)) (= (select (select (store (store (store (store .cse0 v_arrayElimCell_13 v_ArrVal_299) v_arrayElimCell_14 v_ArrVal_304) v_arrayElimCell_11 v_ArrVal_306) v_arrayElimCell_12 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse1) 1)) (= (select (select (store (store .cse0 v_arrayElimCell_13 v_ArrVal_304) v_arrayElimCell_11 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse1) 1)))) (not (= (select (store |#valid| v_arrayElimCell_13 1) v_arrayElimCell_11) 0)))) (not (= (select |#valid| v_arrayElimCell_13) 0)) (= |ULTIMATE.start_main_~end~0#1.base| v_arrayElimCell_13))))
(assert (forall ((v_arrayElimCell_13 Int)) (or (not (= (select |#valid| v_arrayElimCell_13) 0)) (forall ((v_prenex_12 Int) (v_ArrVal_298 Int) (v_prenex_10 (Array Int Int)) (v_prenex_11 (Array Int Int))) (or (= (select (select (store (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~end~0#1.base|) |ULTIMATE.start_main_~end~0#1.offset| v_ArrVal_298)) v_arrayElimCell_13 v_prenex_10) v_prenex_12 v_prenex_11) |ULTIMATE.start_main_~list~0#1.base|) (+ 16 |ULTIMATE.start_main_~list~0#1.offset|)) 1) (not (= (select (store |#valid| v_arrayElimCell_13 1) v_prenex_12) 0)))) (= |ULTIMATE.start_main_~end~0#1.base| v_arrayElimCell_13))))
(assert (not (or (forall ((v_ArrVal_304 (Array Int Int)) (v_ArrVal_306 (Array Int Int)) (v_ArrVal_305 (Array Int Int)) (v_arrayElimCell_14 Int) (v_ArrVal_299 (Array Int Int)) (v_arrayElimCell_12 Int) (v_arrayElimCell_11 Int)) (let ((.cse0 (+ 16 |ULTIMATE.start_main_~list~0#1.offset|))) (or (= (select (select (store (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_304) v_arrayElimCell_11 v_ArrVal_306) v_arrayElimCell_12 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse0) 1) (= (select (select (store (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_299) v_arrayElimCell_14 v_ArrVal_304) v_arrayElimCell_11 v_ArrVal_305) |ULTIMATE.start_main_~list~0#1.base|) .cse0) 1) (not (= (select (store |#valid| |ULTIMATE.start_main_~end~0#1.base| 1) v_arrayElimCell_11) 0))))) (not (= (select |#valid| |ULTIMATE.start_main_~end~0#1.base|) 0)))))
(check-sat)
(exit)
