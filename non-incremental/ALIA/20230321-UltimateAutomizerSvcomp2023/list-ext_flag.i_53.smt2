...
(assert (not (forall ((v_ArrVal_452 (Array Int Int)) (v_ArrVal_449 Int)) (= (select (select (store (store |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base|) (+ |c_ULTIMATE.start_main_~p~0#1.offset| 8) v_ArrVal_449)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_452) |c_ULTIMATE.start_main_~a~0#1.base|) (+ |c_ULTIMATE.start_main_~a~0#1.offset| 4)) 0))))
(check-sat)
(exit)
