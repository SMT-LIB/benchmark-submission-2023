...
(assert (= |#valid| (store |old(#valid)| |node_create_~temp~0#1.base| (select |#valid| |node_create_~temp~0#1.base|))))
(declare-fun ULTIMATE@diffIntInt ((Array Int Int) (Array Int Int)) Int)
(assert (=> (let ((.cse0 (ULTIMATE@diffIntInt |old(#valid)| |#valid|))) (= (select |old(#valid)| .cse0) (select |#valid| .cse0))) (= |old(#valid)| |#valid|)))
(assert (= (let ((.cse0 (ULTIMATE@diffIntInt |old(#valid)| |#valid|))) (store |old(#valid)| .cse0 (select |#valid| .cse0))) |#valid|))
(assert (exists ((v_ArrVal_1179 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1179))))
(assert (or (<= (+ |node_create_#res#1.base| 1) 0) (<= 1 |node_create_#res#1.base|)))
...
(assert (not (exists ((v_ArrVal_1178 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1178) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
