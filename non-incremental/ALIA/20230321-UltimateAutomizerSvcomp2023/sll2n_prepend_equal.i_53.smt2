...
(assert (exists ((v_ArrVal_1377 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1377) |#memory_$Pointer$.base|)))
(assert (<= (+ |node_create_#res#1.base| 1) |#StackHeapBarrier|))
(assert (= (select |old(#valid)| |node_create_#res#1.base|) 0))
(assert (not (exists ((v_ArrVal_1378 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1378)))))
(check-sat)
(exit)
