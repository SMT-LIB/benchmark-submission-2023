...
(assert (or (not (= 0 (select (select |old(#memory_$Pointer$.offset)| |##fun~$Pointer$~TO~VOID_#in~10#1.base|) |##fun~$Pointer$~TO~VOID_#in~10#1.offset|))) (not (= (select (select |old(#memory_$Pointer$.base)| |##fun~$Pointer$~TO~VOID_#in~10#1.base|) |##fun~$Pointer$~TO~VOID_#in~10#1.offset|) 0)) (<= (+ |##fun~$Pointer$~TO~VOID_#in~10#1.base| 1) |#StackHeapBarrier|)))
...
(assert (not (= (select (select |#memory_$Pointer$.base| |##fun~$Pointer$~TO~VOID_#in~10#1.base|) |##fun~$Pointer$~TO~VOID_#in~10#1.offset|) 0)))
(assert (not (exists ((v_ArrVal_2702 (Array Int Int)) (|##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| Int)) (and (= (select (select (store |old(#memory_$Pointer$.base)| |##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| v_ArrVal_2702) |##fun~$Pointer$~TO~VOID_#in~10#1.base|) |##fun~$Pointer$~TO~VOID_#in~10#1.offset|) 0) (< |##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| |#StackHeapBarrier|)))))
(check-sat)
(exit)
