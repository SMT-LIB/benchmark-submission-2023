...
(assert (not (and (not (= (select (select |c_#memory_$Pointer$.base_primed| (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~bcki~0#1.base|) |c_ULTIMATE.start_main_~bcki~0#1.offset|)) 0) 0)) (= (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~bcki~0#1.base|) |c_ULTIMATE.start_main_~bcki~0#1.offset|) 0))))
(check-sat)
(exit)
