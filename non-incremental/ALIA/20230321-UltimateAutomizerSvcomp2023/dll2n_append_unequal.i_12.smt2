...
(assert (exists ((v_ArrVal_767 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_767) |#memory_$Pointer$.base|)))
(assert (<= |node_create_#res#1.offset| 0))
(assert (not (exists ((v_ArrVal_766 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_766)))))
(check-sat)
(exit)
