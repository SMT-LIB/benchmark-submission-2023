...
(assert (not (and (forall ((v_arrayElimArr_22 (Array Int Int)) (v_arrayElimArr_21 (Array Int Int)) (v_arrayElimArr_15 (Array Int Int)) (|v_ULTIMATE.start_main_~t~0#1.base_17| Int) (v_arrayElimArr_16 (Array Int Int))) (let ((.cse0 (select v_arrayElimArr_15 4))) (or (not (= (select v_arrayElimArr_22 4) |c_ULTIMATE.start_main_~p~0#1.offset_primed|)) (not (= (select |c_#valid| .cse0) 0)) (not (= (select v_arrayElimArr_16 4) 0)) (= (select (let ((.cse1 (store (store |c_#memory_$Pointer$.base_primed| .cse0 v_arrayElimArr_21) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_15))) (select .cse1 (select (select .cse1 .cse0) 4))) (+ 4 (select (select (store (store |c_#memory_$Pointer$.offset_primed| .cse0 v_arrayElimArr_22) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_16) .cse0) 4))) 0) (not (= (select (store |c_#valid| .cse0 1) |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)) (not (= (select v_arrayElimArr_21 4) |c_ULTIMATE.start_main_~p~0#1.base_primed|))))) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int) (v_arrayElimArr_17 (Array Int Int)) (v_arrayElimArr_19 (Array Int Int)) (v_arrayElimArr_18 (Array Int Int)) (v_arrayElimArr_20 (Array Int Int))) (let ((.cse2 (select v_arrayElimArr_17 4))) (or (not (= (select v_arrayElimArr_20 4) |c_ULTIMATE.start_main_~p~0#1.base_primed|)) (not (= (select |c_#valid| .cse2) 0)) (not (= (select (store |c_#valid| .cse2 1) |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)) (not (= (select v_arrayElimArr_19 4) |c_ULTIMATE.start_main_~p~0#1.offset_primed|)) (not (= (select v_arrayElimArr_18 4) 0)) (= (let ((.cse3 (store (store |c_#memory_$Pointer$.offset_primed| .cse2 v_arrayElimArr_19) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_18))) (select (select .cse3 (select (select (store (store |c_#memory_$Pointer$.base_primed| .cse2 v_arrayElimArr_20) |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_17) .cse2) 4)) (+ (select (select .cse3 .cse2) 4) 4))) 0)))))))
(check-sat)
(exit)
