...
(assert (= |ULTIMATE.start_dll_circular_update_at_~head#1.offset| 0))
(assert (= 3 |ULTIMATE.start_dll_circular_update_at_~data#1|))
...
(assert (forall ((|v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| Int)) (or (< |v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| |ULTIMATE.start_main_~s~0#1.offset|) (forall ((v_ArrVal_746 (Array Int Int)) (v_ArrVal_748 Int) (v_ArrVal_747 Int)) (<= (+ 1 (let ((.cse0 (+ |v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| 16))) (select (select (store |#memory_int| |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_746) (select (store (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) .cse0 v_ArrVal_748) |ULTIMATE.start_main_~s~0#1.offset|)) (+ 16 (select (store (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) .cse0 v_ArrVal_747) |ULTIMATE.start_main_~s~0#1.offset|))))) (* |ULTIMATE.start_main_~len~0#1| 2))))))
...
(assert (forall ((|v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| Int)) (or (< |v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| |ULTIMATE.start_main_~s~0#1.offset|) (forall ((v_ArrVal_746 (Array Int Int)) (v_ArrVal_748 Int) (v_ArrVal_747 Int)) (<= (* |ULTIMATE.start_main_~len~0#1| 2) (+ 1 (let ((.cse0 (+ |v_ULTIMATE.start_dll_circular_update_at_~head#1.offset_9| 16))) (select (select (store |#memory_int| |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_746) (select (store (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) .cse0 v_ArrVal_748) |ULTIMATE.start_main_~s~0#1.offset|)) (+ 16 (select (store (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) .cse0 v_ArrVal_747) |ULTIMATE.start_main_~s~0#1.offset|))))))))))
(assert (= |ULTIMATE.start_dll_circular_create_~new_head~0#1.base| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_circular_create_~new_head~0#1.base|) 0)))
(check-sat)
(exit)
