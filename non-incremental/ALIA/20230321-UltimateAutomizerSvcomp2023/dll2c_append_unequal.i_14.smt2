...
(assert (= (select (select |#memory_int| |node_create_#res#1.base|) 16) |node_create_#in~data#1|))
(assert (= (store |old(#valid)| |node_create_~temp~0#1.base| 1) |#valid|))
(assert (= |node_create_~data#1| |node_create_#in~data#1|))
(assert (exists ((v_ArrVal_1084 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1084) |#memory_$Pointer$.base|)))
(assert (<= |node_create_#res#1.offset| 0))
(assert (= 1 (select |#valid| |node_create_~temp~0#1.base|)))
(assert (= (select (select |#memory_$Pointer$.offset| |node_create_#res#1.base|) 8) 0))
(assert (exists ((v_ArrVal_1079 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1079))))
(assert (not (exists ((v_ArrVal_1081 (Array Int Int))) (= (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1081) |#memory_int|))))
(check-sat)
(exit)
