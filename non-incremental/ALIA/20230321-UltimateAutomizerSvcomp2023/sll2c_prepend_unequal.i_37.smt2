...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) 0))) (let ((.cse1 (select (select |c_#memory_$Pointer$.base| .cse0) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) 0)))) (and (<= (+ 2 |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|) |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (= |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.offset| 0) (not (= .cse0 |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|)) (not (= .cse1 |c_ULTIMATE.start_main_~#s~0#1.base|)) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_main_~uneq~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|) 8)) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset| 0) (not (= .cse0 |c_ULTIMATE.start_main_~#s~0#1.base|)) (not (= .cse1 |c_ULTIMATE.start_sll_circular_prepend_~new_head~1#1.base|)) (not (= .cse1 .cse0)))))))
(check-sat)
(exit)
