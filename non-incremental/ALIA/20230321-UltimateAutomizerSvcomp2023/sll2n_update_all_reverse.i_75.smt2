...
(assert (forall ((|v_ULTIMATE.start_sll_update_at_~head#1.offset_9| Int)) (or (< |ULTIMATE.start_main_~s~0#1.offset| |v_ULTIMATE.start_sll_update_at_~head#1.offset_9|) (forall ((v_ArrVal_355 Int) (v_ArrVal_354 Int) (v_ArrVal_353 (Array Int Int))) (<= (+ (let ((.cse0 (+ |ULTIMATE.start_main_~s~0#1.offset| 4))) (select (select (store |#memory_int| |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_353) (select (store (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) |v_ULTIMATE.start_sll_update_at_~head#1.offset_9| v_ArrVal_355) .cse0)) (select (store (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) |v_ULTIMATE.start_sll_update_at_~head#1.offset_9| v_ArrVal_354) .cse0))) 1) (* |ULTIMATE.start_main_~len~0#1| 2))))))
(assert (= (select |#valid| |ULTIMATE.start_node_create_#res#1.base|) 1))
(assert (= |ULTIMATE.start_main_~s~0#1.offset| 0))
(assert (not (<= (select (select |#memory_int| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) 4)) (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) 4)) 3)))
(check-sat)
(exit)
