...
(assert (not (let ((.cse1 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~bucket~0#1.base|) 0))) (let ((.cse3 (select |c_#memory_$Pointer$.base_primed| .cse1))) (let ((.cse0 (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~bucket~0#1.base|)) (.cse2 (select .cse3 0))) (and (= |c_ULTIMATE.start_main_~bucket~0#1.offset| 0) (= (select .cse0 0) 0) (not (= .cse1 .cse2)) (= (select .cse3 8) 0) (not (= .cse2 0)) (= 0 (select .cse0 8)) (exists ((|ULTIMATE.start_main_~item~0#1.base| Int)) (and (= 0 (select (select |c_#memory_$Pointer$.base_primed| |ULTIMATE.start_main_~item~0#1.base|) 0)) (not (= |ULTIMATE.start_main_~item~0#1.base| 0)) (not (= |ULTIMATE.start_main_~item~0#1.base| |c_ULTIMATE.start_main_~bucket~0#1.base|)))) (not (= .cse2 |c_ULTIMATE.start_main_~bucket~0#1.base|))))))))
(check-sat)
(exit)
