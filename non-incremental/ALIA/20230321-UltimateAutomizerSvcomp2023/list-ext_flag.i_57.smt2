...
(assert (not (let ((.cse0 (forall ((|v_ULTIMATE.start_main_~t~0#1.base_15| Int)) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_15|) 0))))) (and (or .cse0 (= |c_ULTIMATE.start_main_~a~0#1.offset| |c_ULTIMATE.start_main_~p~0#1.offset|)) (not (= (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|) 0)) (or .cse0 (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|))))))
(check-sat)
(exit)
