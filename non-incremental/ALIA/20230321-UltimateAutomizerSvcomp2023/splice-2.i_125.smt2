...
(assert (or (= |ULTIMATE.start_main_~a~0#1.offset| 0) (let ((.cse2 (+ |ULTIMATE.start_main_~p~0#1.offset| 4))) (let ((.cse3 (+ |ULTIMATE.start_main_~a~0#1.offset| 4)) (.cse1 (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base|)) (.cse4 (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| (store (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base|) .cse2 0)))) (and (forall ((|v_ULTIMATE.start_main_~t~0#1.base_37| Int)) (or (not (= (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_37|) 0)) (forall ((v_ArrVal_728 (Array Int Int)) (v_ArrVal_729 (Array Int Int)) (v_ArrVal_731 (Array Int Int))) (= (let ((.cse0 (store .cse4 |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_728))) (select (select (store .cse0 |ULTIMATE.start_main_~a~0#1.base| v_ArrVal_731) (select (select (store (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| (store .cse1 .cse2 |v_ULTIMATE.start_main_~t~0#1.base_37|)) |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_729) |ULTIMATE.start_main_~a~0#1.base|) .cse3)) (+ (select (select .cse0 |ULTIMATE.start_main_~a~0#1.base|) .cse3) 4))) 0)))) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_37| Int)) (or (not (= (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_37|) 0)) (forall ((v_ArrVal_728 (Array Int Int)) (v_ArrVal_729 (Array Int Int)) (v_ArrVal_730 (Array Int Int))) (= |v_ULTIMATE.start_main_~t~0#1.base_37| (select (let ((.cse5 (store (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| (store .cse1 .cse2 |v_ULTIMATE.start_main_~t~0#1.base_37|)) |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_729))) (select (store .cse5 |ULTIMATE.start_main_~a~0#1.base| v_ArrVal_730) (select (select .cse5 |ULTIMATE.start_main_~a~0#1.base|) .cse3))) (+ (select (select (store .cse4 |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_728) |ULTIMATE.start_main_~a~0#1.base|) .cse3) 4)))))) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_37| Int)) (or (not (= (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_37|) 0)) (forall ((v_ArrVal_728 (Array Int Int)) (v_ArrVal_729 (Array Int Int)) (v_ArrVal_731 (Array Int Int))) (let ((.cse9 (store .cse4 |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_728)) (.cse6 (store (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| (store .cse1 .cse2 |v_ULTIMATE.start_main_~t~0#1.base_37|)) |v_ULTIMATE.start_main_~t~0#1.base_37| v_ArrVal_729))) (let ((.cse7 (select (select .cse6 |ULTIMATE.start_main_~a~0#1.base|) .cse3)) (.cse8 (+ (select (select .cse9 |ULTIMATE.start_main_~a~0#1.base|) .cse3) 4))) (or (forall ((v_ArrVal_730 (Array Int Int))) (not (= (select (select (store .cse6 |ULTIMATE.start_main_~a~0#1.base| v_ArrVal_730) .cse7) .cse8) |ULTIMATE.start_main_~a~0#1.base|))) (= |ULTIMATE.start_main_~a~0#1.offset| (select (select (store .cse9 |ULTIMATE.start_main_~a~0#1.base| v_ArrVal_731) .cse7) .cse8)))))))))))))
