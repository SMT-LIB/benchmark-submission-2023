...
(assert (let ((.cse0 (select |c_#memory_$Pointer$.base| 3))) (and (not (= (select .cse0 |c_~#gl_list~0.offset|) 3)) (not (= (select .cse0 (+ |c_~#gl_list~0.offset| 8)) 3)) (= 3 |c_~#gl_list~0.base|) (not (= |c_ULTIMATE.start_gl_insert_~node~1#1.base| 3)))))
