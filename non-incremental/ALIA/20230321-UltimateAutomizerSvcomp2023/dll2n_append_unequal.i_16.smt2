...
(assert (let ((.cse0 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_int)| |c_#memory_int|))) (let ((.cse4 (store |c_old(#memory_int)| .cse0 (select |c_#memory_int| .cse0)))) (let ((.cse3 (ULTIMATE@diffIntArray_Int_Int .cse4 |c_#memory_int|))) (let ((.cse5 (store .cse4 .cse3 (select |c_#memory_int| .cse3)))) (let ((.cse2 (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|)) (.cse1 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|)) (.cse7 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|)) (.cse6 (ULTIMATE@diffIntArray_Int_Int .cse5 |c_#memory_int|))) (and (or (= |c_old(#memory_int)| |c_#memory_int|) (= (select |c_old(#valid)| .cse0) 0)) (or (= (select |c_old(#valid)| .cse1) 0) .cse2) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (or .cse2 (<= (+ .cse1 1) |c_#StackHeapBarrier|)) (or (= (select |c_old(#valid)| .cse3) 0) (= .cse4 |c_#memory_int|)) (= |c_#memory_int| (store .cse5 .cse6 (select |c_#memory_int| .cse6))) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| .cse1 (select |c_#memory_$Pointer$.offset| .cse1))) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| .cse7 (select |c_#memory_$Pointer$.base| .cse7))) (or (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (<= (+ .cse7 1) |c_#StackHeapBarrier|)) (or (= .cse5 |c_#memory_int|) (= (select |c_old(#valid)| .cse6) 0)) (<= (+ |c_node_create_#res#1.base| 1) |c_#StackHeapBarrier|))))))))
(assert (not (and (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (exists ((v_ArrVal_1028 (Array Int Int))) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| |c_node_create_#res#1.base| v_ArrVal_1028))) (exists ((v_ArrVal_1031 (Array Int Int))) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| |c_node_create_#res#1.base| v_ArrVal_1031))) (exists ((v_ArrVal_1029 (Array Int Int))) (= (store |c_old(#memory_int)| |c_node_create_#res#1.base| v_ArrVal_1029) |c_#memory_int|)) (<= (+ |c_node_create_#res#1.base| 1) |c_#StackHeapBarrier|))))
(check-sat)
(exit)
