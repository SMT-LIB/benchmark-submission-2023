...
(assert (not (let ((.cse5 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~bucket~0#1.base|))) (let ((.cse3 (select .cse5 0))) (let ((.cse2 (select |c_#memory_$Pointer$.base| .cse3))) (let ((.cse1 (select .cse2 0)) (.cse4 (select .cse5 |c_ULTIMATE.start_main_~bucket~0#1.offset|)) (.cse0 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~bucket~0#1.base|))) (and (not (= |c_ULTIMATE.start_main_~bucket~0#1.base| |c_ULTIMATE.start_main_~item~0#1.base|)) (= (select .cse0 |c_ULTIMATE.start_main_~bucket~0#1.offset|) 0) (not (= .cse1 0)) (= 0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base|) 0)) (= (select .cse2 8) 0) (= (select |c_#valid| |c_ULTIMATE.start_main_~bucket~0#1.base|) 1) (not (= .cse1 .cse3)) (not (= .cse1 |c_ULTIMATE.start_main_~bucket~0#1.base|)) (not (= |c_ULTIMATE.start_main_~item~0#1.base| 0)) (= |c_ULTIMATE.start_main_~bucket~0#1.offset| 0) (= (select .cse0 0) 0) (= |c_ULTIMATE.start_main_~item~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~bcki~0#1.base| 0)) (= (select |c_#valid| .cse4) 1) (not (= (select (select |c_#memory_$Pointer$.base| .cse4) 0) 0)) (= (select .cse0 8) 0))))))))
(check-sat)
(exit)
