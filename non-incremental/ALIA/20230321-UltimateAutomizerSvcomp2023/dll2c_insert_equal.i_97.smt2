...
(assert (exists ((v_ArrVal_716 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_716))))
(assert (= 0 (select |old(#valid)| |node_create_~temp~0#1.base|)))
(assert (= 0 |node_create_#res#1.offset|))
(assert (exists ((v_ArrVal_719 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_719))))
...
(assert (not (exists ((v_ArrVal_718 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_718)))))
(check-sat)
(exit)
