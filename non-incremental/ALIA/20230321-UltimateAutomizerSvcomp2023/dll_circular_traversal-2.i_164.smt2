...
(assert (not (and (not (= (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base|) 0)) (not (= 0 (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|))) (or (forall ((|v_ULTIMATE.start_dll_circular_create_~new_head~0#1.base_13| Int)) (not (= (select |c_#valid| |v_ULTIMATE.start_dll_circular_create_~new_head~0#1.base_13|) 0))) (and (= |c_ULTIMATE.start_main_~data_init~0#1| |c_ULTIMATE.start_dll_circular_create_~data#1|) (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|)) (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base_primed|)))))))
(check-sat)
(exit)
