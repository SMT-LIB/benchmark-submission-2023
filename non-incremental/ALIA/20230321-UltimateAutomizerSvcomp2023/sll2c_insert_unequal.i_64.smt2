...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (.cse1 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))) (and (= (select (select |c_#memory_$Pointer$.offset| .cse0) .cse1) 0) (= |c_ULTIMATE.start_main_~uneq~0#1| (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| .cse0) .cse1)) 8))))))
(check-sat)
(exit)
