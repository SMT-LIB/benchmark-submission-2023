...
(assert (not (exists ((|node_create_~temp~0#1.base| Int)) (and (< |node_create_~temp~0#1.base| |#StackHeapBarrier|) (exists ((v_ArrVal_557 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_557) |#memory_$Pointer$.base|))))))
(check-sat)
(exit)
