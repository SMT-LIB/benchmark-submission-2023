...
(assert (not (and (= |c_ULTIMATE.start_main_~data_init~0#1| 1) (= |c_ULTIMATE.start_main_~ptr~0#1.offset| 0) (= (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~ptr~0#1.base|) 0) 1))))
(check-sat)
(exit)
