...
(assert (and (= (select (select |c_#memory_$Pointer$.base| 3) |c_~#gl_list~0.offset|) 3) (= (select |c_#valid| 3) 1) (= |c_~#gl_list~0.offset| (select (select |c_#memory_$Pointer$.offset| 3) |c_~#gl_list~0.offset|)) (= 3 |c_~#gl_list~0.base|)))
