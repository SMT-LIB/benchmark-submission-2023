...
(assert (and (= (select |c_#valid| 3) 1) (= |c_~#mutexes~0.offset| 0) (= (select (select |c_#memory_$Pointer$.offset| 3) 0) 0) (= (select (select |c_#memory_$Pointer$.base| 3) 0) 3) (= 3 |c_~#mutexes~0.base|)))
