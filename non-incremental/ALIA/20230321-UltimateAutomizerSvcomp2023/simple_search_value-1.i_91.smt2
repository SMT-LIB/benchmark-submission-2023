...
(assert (and (= |ULTIMATE.start_main_~a~0#1.offset| 0) (forall ((v_arrayElimArr_8 (Array Int Int)) (v_ArrVal_569 (Array Int Int))) (or (forall ((v_arrayElimArr_6 (Array Int Int)) (v_arrayElimArr_5 (Array Int Int)) (v_arrayElimArr_7 (Array Int Int)) (v_arrayElimArr_2 (Array Int Int)) (v_arrayElimArr_1 (Array Int Int)) (v_arrayElimArr_4 (Array Int Int)) (v_arrayElimArr_3 (Array Int Int)) (v_subst_6 Int) (v_subst_5 Int) (v_subst_4 Int) (v_subst_3 Int) (v_subst_2 Int) (v_subst_1 Int) (v_ArrVal_616 (Array Int Int)) (v_subst_9 Int) (v_subst_8 Int) (v_subst_7 Int)) (or (= (select v_arrayElimArr_6 4) 0) (= (select v_arrayElimArr_5 4) 0) (= |ULTIMATE.start_main_~a~0#1.base| v_subst_1) (not (= (select (select (store (store (store (store (store (store (store (store (store (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_569) v_subst_9 v_arrayElimArr_8) v_subst_8 v_arrayElimArr_7) v_subst_7 v_arrayElimArr_6) v_subst_6 v_arrayElimArr_5) v_subst_5 v_arrayElimArr_4) v_subst_4 v_arrayElimArr_3) v_subst_3 v_arrayElimArr_2) v_subst_2 v_arrayElimArr_1) v_subst_1 v_ArrVal_616) |ULTIMATE.start_main_~a~0#1.base|) 4) 0)) (= 0 (select v_arrayElimArr_7 4)) (= (select v_arrayElimArr_1 4) 0) (= (select v_arrayElimArr_4 4) 0) (= (select v_arrayElimArr_2 4) 0) (= (select v_arrayElimArr_3 4) 0))) (= (select v_arrayElimArr_8 (+ |ULTIMATE.start_main_~t~0#1.offset| 4)) 0)))))
(check-sat)
(exit)
