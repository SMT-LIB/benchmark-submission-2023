...
(assert (not (and (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_dll_remove_first_~temp~1#1.base|) 4) 0) (= |c_ULTIMATE.start_dll_remove_first_~head#1.offset| |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_dll_remove_first_~temp~1#1.offset| 0) (= |c_ULTIMATE.start_dll_remove_first_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= |c_ULTIMATE.start_dll_remove_first_~temp~1#1.base| |c_ULTIMATE.start_dll_remove_first_~head#1.base|)) (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_remove_first_~temp~1#1.base|) 4) 0))))
(check-sat)
(exit)
