...
(assert (not (and (= (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) 4) 0) (let ((.cse2 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) 4))) (let ((.cse0 (= (select (select |c_#memory_$Pointer$.offset_primed| .cse2) 4) 0)) (.cse1 (select (select |c_#memory_$Pointer$.base_primed| .cse2) 4))) (or (and .cse0 (= .cse1 |c_ULTIMATE.start_main_~p~0#1.base_primed|)) (and .cse0 (= .cse1 0))))) (= |c_ULTIMATE.start_main_~p~0#1.offset_primed| 0))))
(check-sat)
(exit)
