...
(assert (forall ((v_arrayElimArr_13 (Array Int Int))) (let ((.cse3 (+ |ULTIMATE.start_main_~p~0#1.offset| 4))) (let ((.cse1 (select v_arrayElimArr_13 .cse3)) (.cse2 (+ |ULTIMATE.start_main_~a~0#1.offset| 4))) (or (forall ((v_arrayElimArr_12 (Array Int Int)) (v_arrayElimArr_16 (Array Int Int)) (v_prenex_5 (Array Int Int))) (or (let ((.cse0 (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_arrayElimArr_16))) (= (select (select (store .cse0 .cse1 v_prenex_5) |ULTIMATE.start_main_~a~0#1.base|) .cse2) (select (select (store .cse0 .cse1 v_arrayElimArr_12) |ULTIMATE.start_main_~a~0#1.base|) .cse2))) (not (= (select v_arrayElimArr_16 .cse3) 0)) (not (= (select v_arrayElimArr_12 4) 0)))) (not (= (select |#valid| .cse1) 0)) (forall ((v_arrayElimArr_11 (Array Int Int))) (let ((.cse4 (select (select (store (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_arrayElimArr_13) .cse1 v_arrayElimArr_11) |ULTIMATE.start_main_~a~0#1.base|) .cse2))) (or (= .cse4 0) (= .cse4 |ULTIMATE.start_main_~p~0#1.base|) (not (= 0 (select v_arrayElimArr_11 4)))))))))))
(assert (forall ((v_arrayElimArr_13 (Array Int Int))) (let ((.cse4 (+ |ULTIMATE.start_main_~p~0#1.offset| 4))) (let ((.cse0 (select v_arrayElimArr_13 .cse4)) (.cse3 (+ |ULTIMATE.start_main_~a~0#1.offset| 4))) (or (not (= (select |#valid| .cse0) 0)) (forall ((v_arrayElimArr_11 (Array Int Int)) (v_prenex_3 (Array Int Int))) (let ((.cse2 (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_arrayElimArr_13))) (let ((.cse1 (select (select (store .cse2 .cse0 v_arrayElimArr_11) |ULTIMATE.start_main_~a~0#1.base|) .cse3))) (or (= .cse1 0) (= (select (select (store .cse2 .cse0 v_prenex_3) |ULTIMATE.start_main_~a~0#1.base|) .cse3) .cse1) (not (= 0 (select v_arrayElimArr_11 4))))))) (forall ((v_arrayElimArr_12 (Array Int Int)) (v_arrayElimArr_16 (Array Int Int))) (or (= |ULTIMATE.start_main_~p~0#1.offset| (select (select (store (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_arrayElimArr_16) .cse0 v_arrayElimArr_12) |ULTIMATE.start_main_~a~0#1.base|) .cse3)) (not (= (select v_arrayElimArr_16 .cse4) 0)) (not (= (select v_arrayElimArr_12 4) 0)))))))))
