...
(assert (exists ((v_ArrVal_1686 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| insert_list_~l.base v_ArrVal_1686))))
(assert (= (store |old(#valid)| insert_list_~l.base 1) |#valid|))
(assert (not (exists ((v_arrayElimArr_10 (Array Int Int))) (and (= |old(~head~0.base)| (select v_arrayElimArr_10 4)) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| insert_list_~l.base v_arrayElimArr_10))))))
(check-sat)
(exit)
