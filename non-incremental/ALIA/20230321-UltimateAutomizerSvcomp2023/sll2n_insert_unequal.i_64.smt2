...
(assert (exists ((v_ArrVal_612 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_612))))
...
(assert (not (exists ((v_ArrVal_615 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_615)))))
(check-sat)
(exit)
