...
(assert (not (and (exists ((|v_ULTIMATE.start_main_~p~0#1.base_40| Int)) (let ((.cse0 (select (select |c_#memory_$Pointer$.base_primed| |v_ULTIMATE.start_main_~p~0#1.base_40|) 4))) (let ((.cse1 (select (select |c_#memory_$Pointer$.base_primed| .cse0) 4))) (and (not (= .cse0 .cse1)) (= (select (select |c_#memory_$Pointer$.base_primed| .cse1) 4) 0) (not (= |v_ULTIMATE.start_main_~p~0#1.base_40| .cse1)) (= (select (select |c_#memory_$Pointer$.offset_primed| .cse0) 4) 0) (= (select (select |c_#memory_$Pointer$.offset_primed| .cse1) 4) 0) (= .cse1 |c_ULTIMATE.start_main_~p~0#1.base_primed|) (= (select (select |c_#memory_$Pointer$.offset_primed| |v_ULTIMATE.start_main_~p~0#1.base_40|) 4) 0))))) (= |c_ULTIMATE.start_main_~p~0#1.offset_primed| 0))))
(check-sat)
(exit)
