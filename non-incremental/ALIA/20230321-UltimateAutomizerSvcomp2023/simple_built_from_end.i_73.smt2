...
(assert (not (and (or (forall ((v_arrayElimCell_57 Int)) (or (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int)) (not (= (select (store |c_#valid| v_arrayElimCell_57 1) |v_ULTIMATE.start_main_~t~0#1.base_17|) 0))) (= v_arrayElimCell_57 0) (not (= (select |c_#valid| v_arrayElimCell_57) 0)))) (= 0 |c_ULTIMATE.start_main_~p~0#1.base_primed|)) (or (forall ((v_arrayElimCell_64 Int)) (or (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int)) (or (= |v_ULTIMATE.start_main_~t~0#1.base_17| |c_ULTIMATE.start_main_~t~0#1.base|) (not (= (select (store |c_#valid| v_arrayElimCell_64 1) |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)))) (not (= (select |c_#valid| v_arrayElimCell_64) 0)) (= |c_ULTIMATE.start_main_~t~0#1.base| v_arrayElimCell_64))) (= |c_ULTIMATE.start_main_~p~0#1.offset_primed| 0)) (or (not (= (select |c_#valid| |c_ULTIMATE.start_main_~t~0#1.base|) 0)) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int)) (not (= (select (store |c_#valid| |c_ULTIMATE.start_main_~t~0#1.base| 1) |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)))))))
(check-sat)
(exit)
