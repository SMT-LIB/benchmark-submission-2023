...
(assert (and (= (select |c_old(#valid)| |c_ldv_successful_malloc_~ptr~0#1.base|) 0) (<= 0 |c_ldv_successful_malloc_~ptr~0#1.offset|) (<= |c_ldv_successful_malloc_~ptr~0#1.offset| 0) (= (select |c_#valid| |c_ldv_successful_malloc_~ptr~0#1.base|) 1)))
