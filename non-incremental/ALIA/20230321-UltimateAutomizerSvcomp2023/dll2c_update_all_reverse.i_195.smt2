...
(assert (not (forall ((|v_node_create_~temp~0#1.base_14| Int)) (or (not (= (select |c_#valid| |v_node_create_~temp~0#1.base_14|) 0)) (= (select |c_old(#valid)| |v_node_create_~temp~0#1.base_14|) 0)))))
(check-sat)
(exit)
