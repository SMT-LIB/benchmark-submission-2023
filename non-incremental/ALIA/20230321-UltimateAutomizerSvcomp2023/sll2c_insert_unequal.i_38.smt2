...
(assert (exists ((v_ArrVal_424 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_424) |#memory_$Pointer$.base|)))
(assert (= 0 (select |old(#valid)| |node_create_~temp~0#1.base|)))
(assert (= 0 |node_create_#res#1.offset|))
(assert (exists ((v_ArrVal_422 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_422))))
...
(assert (< |node_create_~temp~0#1.base| |#StackHeapBarrier|))
...
(assert (not (exists ((v_ArrVal_423 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_423)))))
(check-sat)
(exit)
