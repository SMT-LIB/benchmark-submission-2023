...
(declare-fun |chain_node_alloc_node_#res#1.offset| () Int)
...
(assert (exists ((v_ArrVal_1345 Int)) (= (store |old(#memory_$Pointer$.base)| |chain_node_alloc_node_#res#1.base| (store (store (select |old(#memory_$Pointer$.base)| |chain_node_alloc_node_#res#1.base|) 0 v_ArrVal_1345) 8 0)) |#memory_$Pointer$.base|)))
(assert (= |chain_node_~ppnode#1.offset| |chain_node_#in~ppnode#1.offset|))
(assert (< |chain_node_alloc_node_#res#1.base| |#StackHeapBarrier|))
(assert (= (select |old(#valid)| |chain_node_alloc_node_#res#1.base|) 0))
(assert (= |chain_node_alloc_node_#res#1.offset| 0))
(assert (not (exists ((v_ArrVal_1342 Int)) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |chain_node_alloc_node_#res#1.base| (store (store (select |old(#memory_$Pointer$.offset)| |chain_node_alloc_node_#res#1.base|) 0 v_ArrVal_1342) 8 0))))))
(check-sat)
(exit)
