...
(assert (not (and (= (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 0) 0) (not (= |c_ULTIMATE.start_dll_circular_create_#res#1.base| (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 0))) (= |c_ULTIMATE.start_main_~len~0#1| 2) (= |c_ULTIMATE.start_dll_circular_create_#res#1.offset| 0))))
(check-sat)
(exit)
