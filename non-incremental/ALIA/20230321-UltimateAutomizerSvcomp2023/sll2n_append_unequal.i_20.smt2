...
(assert (= (select (select |#memory_int| |node_create_#res#1.base|) 0) |node_create_#in~data#1|))
...
(assert (not (= |node_create_#res#1.base| 0)))
(assert (= (store |old(#valid)| |node_create_#res#1.base| 1) |#valid|))
(assert (exists ((|node_create_~temp~0#1.base| Int)) (and (exists ((v_ArrVal_907 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_907) |#memory_$Pointer$.base|)) (exists ((v_ArrVal_908 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_~temp~0#1.base| v_ArrVal_908))) (exists ((v_ArrVal_909 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_~temp~0#1.base| v_ArrVal_909))) (<= (+ |node_create_~temp~0#1.base| 1) |#StackHeapBarrier|) (= 0 (select |old(#valid)| |node_create_~temp~0#1.base|)))))
(assert (= (select |old(#valid)| |node_create_#res#1.base|) 0))
(assert (= |node_create_~temp~0#1.offset| 0))
(assert (or (<= (+ (ULTIMATE@diffIntArray_Int_Int |old(#memory_$Pointer$.base)| |#memory_$Pointer$.base|) 1) |#StackHeapBarrier|) (= |#memory_$Pointer$.base| |old(#memory_$Pointer$.base)|)))
(assert (= 1 (select |#valid| |node_create_~temp~0#1.base|)))
(assert (or (= (select |old(#valid)| (ULTIMATE@diffIntArray_Int_Int |old(#memory_$Pointer$.offset)| |#memory_$Pointer$.offset|)) 0) (= |#memory_$Pointer$.offset| |old(#memory_$Pointer$.offset)|)))
(assert (< |node_create_#res#1.base| |#StackHeapBarrier|))
(assert (not (exists ((v_ArrVal_899 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_899) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
