...
(assert (not (let ((.cse0 (select (select |#memory_$Pointer$.base| |chain_node_#in~ppnode#1.base|) |chain_node_#in~ppnode#1.offset|))) (and (not (= .cse0 0)) (exists ((v_DerPreprocessor_1 (Array Int Int)) (v_DerPreprocessor_2 (Array Int Int))) (and (= (select v_DerPreprocessor_2 |chain_node_#in~ppnode#1.offset|) .cse0) (= (select (store (store (store (store |#memory_$Pointer$.base| .cse0 v_DerPreprocessor_1) |chain_node_#in~ppnode#1.base| v_DerPreprocessor_2) .cse0 v_DerPreprocessor_1) |chain_node_#in~ppnode#1.base| v_DerPreprocessor_2) .cse0) (select |#memory_$Pointer$.base| .cse0))))))))
(assert (not (let ((.cse0 (select (select |#memory_$Pointer$.base| |chain_node_#in~ppnode#1.base|) |chain_node_#in~ppnode#1.offset|))) (and (= .cse0 |chain_node_#in~ppnode#1.base|) (not (= .cse0 0))))))
(check-sat)
(exit)
