...
(assert (let ((.cse3 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) 0))) (and (exists ((|chain_node_~node~0#1.base| Int) (|ULTIMATE.start_create_sll_~#list~0#1.base| Int)) (let ((.cse0 (select (select |c_#memory_$Pointer$.base_Hier| |chain_node_~node~0#1.base|) 0))) (let ((.cse1 (+ .cse0 2)) (.cse2 (+ 2 |chain_node_~node~0#1.base|))) (and (not (= (select (select |c_#memory_$Pointer$.base_Hier| .cse0) 0) 0)) (not (= .cse0 0)) (= .cse0 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) 0)) (not (= .cse0 |chain_node_~node~0#1.base|)) (<= .cse1 |ULTIMATE.start_create_sll_~#list~0#1.base|) (not (= |ULTIMATE.start_create_sll_~#list~0#1.base| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|)) (<= .cse1 |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (<= .cse2 |ULTIMATE.start_create_sll_~#list~0#1.base|) (<= .cse2 |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= (select (select |c_#memory_$Pointer$.offset_Hier| |chain_node_~node~0#1.base|) 0) 0) (= (select (select |c_#memory_$Pointer$.offset_Hier| |ULTIMATE.start_create_sll_~#list~0#1.base|) 0) 0))))) (= (select |c_#valid_Hier| .cse3) 1) (= |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier| 0) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (not (= (select (select |c_#memory_$Pointer$.base_Hier| .cse3) 0) 0)) (not (= .cse3 0)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_main_~#p2~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp2#1.base_Hier|) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p2~0#1.base_Hier|)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (< .cse3 |c_#StackHeapBarrier|) (= (select (select |c_#memory_$Pointer$.offset_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) 0) 0) (= (select (select |c_#memory_$Pointer$.offset_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) 0) 0) (= |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier| 0))))
