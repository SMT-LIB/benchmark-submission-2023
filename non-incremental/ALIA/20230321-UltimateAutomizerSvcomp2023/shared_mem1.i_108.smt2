...
(assert (<= (let ((.cse2 (+ |c_ULTIMATE.start_main_~list~0#1.offset| 12))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|) .cse2)) (.cse1 (+ (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|) .cse2) 4))) (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| .cse0) .cse1)) (select (select |c_#memory_$Pointer$.offset| .cse0) .cse1)))) 100))
(check-sat)
(exit)
