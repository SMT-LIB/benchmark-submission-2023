...
(assert (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= (select v_arrayElimArr_1 8) |node_create_#in~data#1|) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_arrayElimArr_1)))))
...
(assert (exists ((v_ArrVal_429 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_429))))
...
(assert (= (select (select |#memory_$Pointer$.offset| |node_create_#res#1.base|) 0) 0))
(assert (= |node_create_~temp~0#1.offset| 0))
(assert (not (exists ((v_ArrVal_427 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_427)))))
(check-sat)
(exit)
