...
(assert (not (and (exists ((v_DerPreprocessor_3 (Array Int Int)) (v_DerPreprocessor_4 (Array Int Int)) (v_ArrVal_1355 (Array Int Int))) (let ((.cse0 (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base v_DerPreprocessor_3))) (and (= (select (store .cse0 |c_append_#in~head.base| v_DerPreprocessor_4) c_append_~node~0.base) v_DerPreprocessor_3) (= (store .cse0 |c_append_#in~head.base| v_ArrVal_1355) |c_#memory_$Pointer$.base|)))) (= (select |c_old(#valid)| c_append_~node~0.base) 0) (= |c_#valid| (store |c_old(#valid)| c_append_~node~0.base (select |c_#valid| c_append_~node~0.base))) (exists ((v_DerPreprocessor_5 (Array Int Int)) (v_ArrVal_1356 (Array Int Int)) (v_DerPreprocessor_6 (Array Int Int))) (let ((.cse1 (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base v_DerPreprocessor_5))) (and (= v_DerPreprocessor_5 (select (store .cse1 |c_append_#in~head.base| v_DerPreprocessor_6) c_append_~node~0.base)) (= |c_#memory_$Pointer$.offset| (store .cse1 |c_append_#in~head.base| v_ArrVal_1356))))))))
(check-sat)
(exit)
