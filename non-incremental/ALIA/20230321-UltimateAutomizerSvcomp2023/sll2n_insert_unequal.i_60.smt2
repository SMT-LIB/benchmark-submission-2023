...
(assert (not (and (exists ((v_ArrVal_615 (Array Int Int))) (= (store |c_old(#memory_int)| |c_node_create_#res#1.base| v_ArrVal_615) |c_#memory_int|)) (= |c_node_create_#res#1.offset| 0) (< |c_node_create_#res#1.base| |c_#StackHeapBarrier|) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (= (select |c_#valid| |c_node_create_#res#1.base|) 1) (exists ((v_ArrVal_613 (Array Int Int))) (= (store |c_old(#memory_$Pointer$.base)| |c_node_create_#res#1.base| v_ArrVal_613) |c_#memory_$Pointer$.base|)) (= |c_node_create_#in~data#1| |c_node_create_~data#1|) (= |c_node_create_~temp~0#1.offset| 0) (= (select |c_#valid| |c_node_create_~temp~0#1.base|) 1) (<= (+ |c_node_create_#res#1.base| 1) |c_#StackHeapBarrier|) (<= (+ |c_node_create_~temp~0#1.base| 1) |c_#StackHeapBarrier|) (exists ((v_ArrVal_612 (Array Int Int))) (= (store |c_old(#memory_$Pointer$.offset)| |c_node_create_#res#1.base| v_ArrVal_612) |c_#memory_$Pointer$.offset|)) (= (select (select |c_#memory_int| |c_node_create_#res#1.base|) 0) |c_node_create_#in~data#1|))))
(check-sat)
(exit)
