...
(assert (not (exists ((v_ArrVal_649 (Array Int Int)) (|chain_node_~node~0#1.base| Int) (v_ArrVal_650 (Array Int Int))) (and (= (store (store |old(#memory_$Pointer$.base)| |chain_node_~node~0#1.base| v_ArrVal_649) |chain_node_#in~ppnode#1.base| (store (select (store |old(#memory_$Pointer$.base)| |chain_node_~node~0#1.base| v_ArrVal_650) |chain_node_#in~ppnode#1.base|) |chain_node_#in~ppnode#1.offset| |chain_node_~node~0#1.base|)) |#memory_$Pointer$.base|) (< |chain_node_~node~0#1.base| |#StackHeapBarrier|) (not (= |chain_node_~node~0#1.base| 0))))))
(check-sat)
(exit)
