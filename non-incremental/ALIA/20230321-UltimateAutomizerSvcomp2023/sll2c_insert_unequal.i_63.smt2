...
(assert (not (and (= |c_ULTIMATE.start_sll_circular_insert_~new_node~0#1.offset| 0) (not (= |c_ULTIMATE.start_sll_circular_insert_~snd_to_last~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= |c_ULTIMATE.start_main_~uneq~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_insert_~new_node~0#1.base|) 8)) (not (= |c_ULTIMATE.start_sll_circular_insert_~new_node~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= |c_ULTIMATE.start_sll_circular_insert_~snd_to_last~0#1.offset| (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (not (= |c_ULTIMATE.start_sll_circular_insert_~snd_to_last~0#1.base| |c_ULTIMATE.start_sll_circular_insert_~new_node~0#1.base|)) (= |c_ULTIMATE.start_sll_circular_insert_~snd_to_last~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)))))
(check-sat)
(exit)
