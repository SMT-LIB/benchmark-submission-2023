...
(assert (or (not (= (select |#valid| |ULTIMATE.start_main_~x~0#1.base|) 0)) (forall ((v_prenex_9 Int)) (or (not (= (select (store |#valid| |ULTIMATE.start_main_~x~0#1.base| 1) v_prenex_9) 0)) (forall ((v_prenex_8 (Array Int Int)) (v_ArrVal_1082 (Array Int Int)) (v_ArrVal_1070 (Array Int Int)) (v_arrayElimCell_14 Int) (v_arrayElimCell_12 Int) (v_prenex_7 (Array Int Int))) (let ((.cse0 (store (store |#memory_int| |ULTIMATE.start_main_~x~0#1.base| v_ArrVal_1070) v_arrayElimCell_14 v_prenex_8)) (.cse1 (+ |ULTIMATE.start_main_~head~0#1.offset| 16))) (or (= (select (select (store .cse0 v_prenex_9 v_prenex_7) |ULTIMATE.start_main_~head~0#1.base|) .cse1) 0) (= (select (select (store (store .cse0 v_prenex_9 v_ArrVal_1082) v_arrayElimCell_12 v_prenex_7) |ULTIMATE.start_main_~head~0#1.base|) .cse1) 0))))))))
