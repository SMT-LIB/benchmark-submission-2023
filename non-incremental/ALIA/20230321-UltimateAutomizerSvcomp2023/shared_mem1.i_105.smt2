...
(assert (not (and (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (exists ((|v_ULTIMATE.start_main_~list~0#1.base_27| Int)) (let ((.cse4 (select |c_#memory_$Pointer$.base| |v_ULTIMATE.start_main_~list~0#1.base_27|))) (let ((.cse0 (select .cse4 12))) (let ((.cse5 (select |c_#memory_$Pointer$.base| .cse0))) (let ((.cse2 (select |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_main_~list~0#1.base_27|)) (.cse1 (select (select |c_#memory_int| |v_ULTIMATE.start_main_~list~0#1.base_27|) 0)) (.cse3 (select .cse5 4))) (and (= (select (select |c_#memory_$Pointer$.offset| .cse0) 4) 0) (<= 1 .cse1) (= (select .cse2 4) 0) (= (select .cse2 12) 0) (= |c_ULTIMATE.start_main_~list~0#1.base| .cse0) (<= (+ 100 .cse1) (select (select |c_#memory_int| .cse3) 0)) (= (select .cse4 4) .cse3) (not (= .cse0 .cse3)) (= |v_ULTIMATE.start_main_~list~0#1.base_27| (select .cse5 12)) (not (= |v_ULTIMATE.start_main_~list~0#1.base_27| .cse0)))))))))))
(check-sat)
(exit)
