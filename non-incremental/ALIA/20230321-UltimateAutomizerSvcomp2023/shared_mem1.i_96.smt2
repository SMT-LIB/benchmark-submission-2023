...
(assert (not (let ((.cse0 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~m~0#1.base|) |c_ULTIMATE.start_main_~m~0#1.offset|))) (and (<= .cse0 101) (let ((.cse1 (+ |c_ULTIMATE.start_main_~list~0#1.offset| 4))) (or (not (= |c_ULTIMATE.start_main_~m~0#1.offset| (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|) .cse1))) (<= 101 .cse0) (not (= |c_ULTIMATE.start_main_~m~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|) .cse1)))))))))
(check-sat)
(exit)
