...
(assert (not (and (= |c_ULTIMATE.start_main_~ptr~0#1.offset| 0) (= |c_ULTIMATE.start_main_~data_init~0#1| 1) (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~ptr~0#1.base|) 0) 1))))
(check-sat)
(exit)
