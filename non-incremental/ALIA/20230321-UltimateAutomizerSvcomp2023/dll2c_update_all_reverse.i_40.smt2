...
(assert (not (and (= 3 (select (select |c_#memory_int| |c_ULTIMATE.start_dll_circular_get_data_at_~head#1.base|) (+ |c_ULTIMATE.start_dll_circular_get_data_at_~head#1.offset| 16))) (= |c_ULTIMATE.start_main_~expected~0#1| 3))))
(check-sat)
(exit)
