...
(assert (let ((.cse0 (select |c_#memory_$Pointer$.base| 3))) (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (not (= (select .cse0 |c_~#gl_list~0.offset|) 3)) (= (select |c_#valid| 3) 1) (or (= 3 |c_list_add_#in~new#1.base|) (and (not (= 3 (select .cse0 (+ (select (select |c_old(#memory_$Pointer$.offset)| 3) |c_list_add_#in~head#1.offset|) 8)))) (not (= (select .cse0 |c_list_add_#in~head#1.offset|) 3))) (not (= |c_list_add_#in~head#1.base| 3)) (not (= 3 (select (select |c_old(#memory_$Pointer$.base)| 3) |c_list_add_#in~head#1.offset|)))) (not (= (select .cse0 (+ |c_~#gl_list~0.offset| 8)) 3)) (= 3 |c_~#gl_list~0.base|) (= |c_old(#memory_int)| |c_#memory_int|) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|))))
