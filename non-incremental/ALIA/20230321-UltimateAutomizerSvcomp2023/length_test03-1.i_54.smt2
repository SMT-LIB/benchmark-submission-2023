...
(assert (exists ((v_DerPreprocessor_5 (Array Int Int)) (v_ArrVal_1357 (Array Int Int)) (v_ArrVal_1356 (Array Int Int)) (v_DerPreprocessor_6 (Array Int Int))) (let ((.cse0 (store |old(#memory_$Pointer$.offset)| append_~node~0.base v_DerPreprocessor_5))) (and (= |#memory_$Pointer$.offset| (store (store .cse0 |append_#in~head.base| v_ArrVal_1356) append_~node~0.base v_ArrVal_1357)) (= (select (store .cse0 |append_#in~head.base| v_DerPreprocessor_6) append_~node~0.base) v_DerPreprocessor_5)))))
...
(assert (not (exists ((v_DerPreprocessor_3 (Array Int Int)) (v_ArrVal_1358 (Array Int Int)) (v_DerPreprocessor_4 (Array Int Int)) (v_ArrVal_1355 (Array Int Int))) (let ((.cse0 (store |old(#memory_$Pointer$.base)| append_~node~0.base v_DerPreprocessor_3))) (and (= (store (store .cse0 |append_#in~head.base| v_ArrVal_1355) append_~node~0.base v_ArrVal_1358) |#memory_$Pointer$.base|) (= v_DerPreprocessor_3 (select (store .cse0 |append_#in~head.base| v_DerPreprocessor_4) append_~node~0.base)))))))
(check-sat)
(exit)
