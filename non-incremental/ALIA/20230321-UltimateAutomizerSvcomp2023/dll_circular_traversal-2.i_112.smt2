...
(assert (let ((.cse3 (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_dll_circular_create_~head~0#1.base|) 4)) (.cse0 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_circular_create_~head~0#1.base|) 4))) (and (= (select |#valid| |ULTIMATE.start_dll_circular_create_~new_head~0#1.base|) 1) (= |ULTIMATE.start_dll_circular_create_~head~0#1.offset| 0) (= (select |#valid| |ULTIMATE.start_dll_circular_create_~last~0#1.base|) 1) (not (= |ULTIMATE.start_dll_circular_create_~head~0#1.base| .cse0)) (forall ((v_arrayElimArr_6 (Array Int Int))) (or (forall ((v_ArrVal_667 (Array Int Int)) (v_arrayElimCell_39 Int) (v_arrayElimCell_35 Int) (v_arrayElimCell_38 Int) (v_ArrVal_671 (Array Int Int)) (v_arrayElimCell_37 Int) (v_ArrVal_646 Int)) (let ((.cse1 (store (store (let ((.cse2 (store |#memory_int| |ULTIMATE.start_dll_circular_create_~new_head~0#1.base| v_arrayElimArr_6))) (store .cse2 |ULTIMATE.start_dll_circular_create_~head~0#1.base| (store (select .cse2 |ULTIMATE.start_dll_circular_create_~head~0#1.base|) (+ |ULTIMATE.start_dll_circular_create_~head~0#1.offset| 12) v_ArrVal_646))) |ULTIMATE.start_dll_circular_create_~last~0#1.base| v_ArrVal_667) |ULTIMATE.start_dll_circular_create_~new_head~0#1.base| v_ArrVal_671))) (or (= (select (select .cse1 v_arrayElimCell_38) v_arrayElimCell_39) |ULTIMATE.start_main_~data_init~0#1|) (= |ULTIMATE.start_main_~data_init~0#1| (select (select .cse1 |ULTIMATE.start_dll_circular_create_~head~0#1.base|) |ULTIMATE.start_dll_circular_create_~head~0#1.offset|)) (= |ULTIMATE.start_main_~data_init~0#1| (select (select .cse1 v_arrayElimCell_35) v_arrayElimCell_37))))) (not (= (select v_arrayElimArr_6 |ULTIMATE.start_dll_circular_create_~new_head~0#1.offset|) |ULTIMATE.start_dll_circular_create_~data#1|)))) (= (select |#valid| |ULTIMATE.start_dll_circular_create_~head~0#1.base|) 1) (= .cse3 0) (not (= |ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |ULTIMATE.start_dll_circular_create_~last~0#1.base|)) (= (select (select |#memory_int| .cse0) .cse3) 1) (= (select (select |#memory_int| |ULTIMATE.start_dll_circular_create_~head~0#1.base|) 0) 1) (= |ULTIMATE.start_dll_circular_create_~last~0#1.offset| 0) (not (= |ULTIMATE.start_dll_circular_create_~last~0#1.base| .cse0)) (not (= |ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |ULTIMATE.start_dll_circular_create_~head~0#1.base|)) (= |ULTIMATE.start_dll_circular_create_~new_head~0#1.offset| 0) (= |ULTIMATE.start_dll_circular_create_~data#1| 1) (not (= |ULTIMATE.start_dll_circular_create_~head~0#1.base| |ULTIMATE.start_dll_circular_create_~last~0#1.base|)))))
(check-sat)
(exit)
