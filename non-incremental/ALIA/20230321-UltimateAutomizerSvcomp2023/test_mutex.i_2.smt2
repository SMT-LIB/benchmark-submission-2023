...
(declare-fun |c_ULTIMATE.start_foo_~m2~0#1.base| () Int)
(declare-fun |c_ULTIMATE.start_foo_~m2~0#1.offset| () Int)
(assert (= ~unnamed0~0~P_ALL 0))
(assert (= ~unnamed0~0~P_PID 1))
(assert (= 2 ~unnamed0~0~P_PGID))
(assert (and (not (= |c_ULTIMATE.start_foo_~m1~0#1.base| |c_ULTIMATE.start_foo_~m2~0#1.base|)) (<= |c_~#mutexes~0.offset| 0) (= |c_ULTIMATE.start_foo_~m1~0#1.offset| 0) (= |c_ULTIMATE.start_foo_~m2~0#1.offset| 0) (<= 0 |c_~#mutexes~0.offset|) (= (select |c_#valid| |c_ULTIMATE.start_foo_~m2~0#1.base|) 1)))
