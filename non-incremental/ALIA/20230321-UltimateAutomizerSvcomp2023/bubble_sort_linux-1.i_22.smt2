...
(assert (not (exists ((v_ArrVal_1458 (Array Int Int)) (v_ArrVal_1465 (Array Int Int)) (v_ArrVal_1462 (Array Int Int)) (|list_add___list_add_~next#1.offset| Int)) (= (let ((.cse0 (select (select |old(#memory_$Pointer$.base)| |list_add_#in~head#1.base|) |list_add_#in~head#1.offset|))) (store (store (store |old(#memory_$Pointer$.base)| .cse0 v_ArrVal_1458) |list_add_#in~new#1.base| v_ArrVal_1462) |list_add_#in~head#1.base| (store (select (store (store |old(#memory_$Pointer$.base)| .cse0 (store (select |old(#memory_$Pointer$.base)| .cse0) (+ |list_add___list_add_~next#1.offset| 8) |list_add_#in~new#1.base|)) |list_add_#in~new#1.base| v_ArrVal_1465) |list_add_#in~head#1.base|) |list_add_#in~head#1.offset| |list_add_#in~new#1.base|))) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
