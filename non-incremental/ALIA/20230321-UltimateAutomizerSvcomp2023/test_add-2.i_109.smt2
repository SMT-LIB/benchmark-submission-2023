...
(assert (= (select (select |#memory_$Pointer$.offset| (select (select |#memory_$Pointer$.base| |ldv_is_in_set_#in~s.base|) ldv_is_in_set_~s.offset)) (select (select |#memory_$Pointer$.offset| |ldv_is_in_set_#in~s.base|) ldv_is_in_set_~s.offset)) (+ ldv_is_in_set_~m~1.offset 4)))
(assert (not (= (select (select |#memory_int| (select (select |#memory_$Pointer$.base| |ldv_is_in_set_#in~s.base|) ldv_is_in_set_~s.offset)) (+ (select (select |#memory_$Pointer$.offset| |ldv_is_in_set_#in~s.base|) ldv_is_in_set_~s.offset) (- 4))) |ldv_is_in_set_#in~e|)))
(assert (= |~#s1~0.base| 3))
