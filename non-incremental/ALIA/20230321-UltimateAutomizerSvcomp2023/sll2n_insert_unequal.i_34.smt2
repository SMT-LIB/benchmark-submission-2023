...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))) (and (= |c_ULTIMATE.start_sll_insert_~last~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (not (= |c_ULTIMATE.start_sll_insert_~new_node~0#1.base| |c_ULTIMATE.start_sll_insert_~last~0#1.base|)) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_insert_~last~0#1.base|) .cse0)) (not (= |c_ULTIMATE.start_sll_insert_~last~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (not (= |c_ULTIMATE.start_sll_insert_~new_node~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= |c_ULTIMATE.start_sll_insert_~last~0#1.offset| 0) (<= .cse0 0)))))
(check-sat)
(exit)
