...
(assert (let ((.cse0 (<= (+ |c_dll_insert_master_~dll#1.base| 1) |c_#StackHeapBarrier|)) (.cse2 (select (select |c_old(#memory_$Pointer$.base)| |c_dll_insert_master_~dll#1.base|) |c_dll_insert_master_~dll#1.offset|)) (.cse1 (select (select |c_old(#memory_$Pointer$.offset)| |c_dll_insert_master_~dll#1.base|) |c_dll_insert_master_~dll#1.offset|)) (.cse3 (= |c_dll_insert_master_#in~dll#1.offset| |c_dll_insert_master_~dll#1.offset|))) (and (or .cse0 (and (or (= |c_dll_insert_master_~next~3#1.offset| .cse1) (= |c_dll_insert_master_~next~3#1.offset| 0)) (= .cse2 |c_dll_insert_master_~next~3#1.base|) .cse3)) (= |c_dll_insert_master_#in~dll#1.base| |c_dll_insert_master_~dll#1.base|) (or .cse0 (and .cse3 (not (= .cse2 0))) (and (not (= 0 .cse1)) .cse3)))))
