...
(assert (not (let ((.cse0 (+ |c_ULTIMATE.start_main_~p~0#1.offset_primed| 4))) (and (= (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) .cse0) 0) (= (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~p~0#1.base_primed|) .cse0) 0)))))
(check-sat)
(exit)
