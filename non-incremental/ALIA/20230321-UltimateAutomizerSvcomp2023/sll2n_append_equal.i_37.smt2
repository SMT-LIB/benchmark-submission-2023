...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_create_#res#1.base|) 4))) (and (= (select |c_#valid| |c_ULTIMATE.start_sll_create_#res#1.base|) 1) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (= (select (select |c_#memory_int| |c_ULTIMATE.start_sll_create_#res#1.base|) 0) 1) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (not (= |c_ULTIMATE.start_sll_create_#res#1.base| .cse0)) (= |c_ULTIMATE.start_sll_create_#res#1.offset| 0) (not (= |c_ULTIMATE.start_sll_create_#res#1.base| 0)) (= |c_ULTIMATE.start_main_~data~0#1| 1) (< |c_ULTIMATE.start_sll_create_#res#1.base| |c_#StackHeapBarrier|) (= (select |c_#valid| .cse0) 1)))))
(check-sat)
(exit)
