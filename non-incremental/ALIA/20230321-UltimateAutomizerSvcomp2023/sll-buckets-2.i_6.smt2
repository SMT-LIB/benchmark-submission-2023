...
(declare-fun |c_ULTIMATE.start_main_#t~nondet8#1| () Int)
...
(declare-fun |c_ULTIMATE.start_main_~bcki~0#1.offset| () Int)
...
(assert (let ((.cse0 (+ |c_ULTIMATE.start_main_~item~0#1.offset| 8))) (and (= |c_#memory_int_primed| (store |c_#memory_int| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 0))) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0)))) (= (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0))) |c_#memory_$Pointer$.offset_primed|) (not (= |c_ULTIMATE.start_main_#t~nondet8#1| 0)))))
...
(assert (not (and (exists ((|ULTIMATE.start_main_~item~0#1.base| Int) (|v_ULTIMATE.start_main_~bcki~0#1.base_29| Int)) (let ((.cse1 (select (select |c_#memory_$Pointer$.base_primed| |v_ULTIMATE.start_main_~bcki~0#1.base_29|) 0))) (let ((.cse2 (select |c_#memory_$Pointer$.base_primed| .cse1))) (let ((.cse0 (select .cse2 0))) (and (not (= .cse0 0)) (= 0 (select (select |c_#memory_$Pointer$.base_primed| |ULTIMATE.start_main_~item~0#1.base|) 0)) (not (= |v_ULTIMATE.start_main_~bcki~0#1.base_29| .cse0)) (not (= |ULTIMATE.start_main_~item~0#1.base| 0)) (= .cse1 |c_ULTIMATE.start_main_~bcki~0#1.base|) (not (= .cse1 .cse0)) (not (= |ULTIMATE.start_main_~item~0#1.base| |v_ULTIMATE.start_main_~bcki~0#1.base_29|)) (= (select .cse2 8) 0)))))) (= |c_ULTIMATE.start_main_~bcki~0#1.offset| 0))))
(check-sat)
(exit)
