...
(assert (not (let ((.cse4 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~head~0#1.base|))) (let ((.cse3 (select .cse4 12))) (let ((.cse0 (select |c_#memory_$Pointer$.base| .cse3))) (let ((.cse1 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~head~0#1.base|)) (.cse2 (select .cse0 4))) (and (= (select .cse0 12) |c_ULTIMATE.start_main_~head~0#1.base|) (= (select .cse1 12) 0) (= |c_ULTIMATE.start_main_~head~0#1.offset| 0) (<= 100 (select (select |c_#memory_int| .cse2) 0)) (= (select (select |c_#memory_$Pointer$.offset| .cse3) 4) 0) (<= 1 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~head~0#1.base|) 0)) (not (= |c_ULTIMATE.start_main_~head~0#1.base| .cse2)) (= 0 (select .cse1 4)) (not (= .cse3 .cse2)) (= (select .cse4 4) .cse2) (not (= |c_ULTIMATE.start_main_~head~0#1.base| .cse3)))))))))
(check-sat)
(exit)
