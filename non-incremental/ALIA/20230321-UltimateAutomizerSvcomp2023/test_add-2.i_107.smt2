...
(declare-fun |ldv_is_in_set_#t~mem25| () Int)
...
(declare-fun ldv_is_in_set_~e () Int)
(declare-fun |ldv_is_in_set_#in~s.base| () Int)
(assert (= |ldv_is_in_set_#in~e| ldv_is_in_set_~e))
...
(assert (= (select (select |#memory_int| ldv_is_in_set_~m~1.base) ldv_is_in_set_~m~1.offset) |ldv_is_in_set_#t~mem25|))
