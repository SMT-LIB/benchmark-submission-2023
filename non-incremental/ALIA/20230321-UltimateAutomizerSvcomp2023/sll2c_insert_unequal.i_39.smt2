...
(assert (exists ((v_ArrVal_423 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_423))))
(assert (= (store |old(#valid)| |node_create_#res#1.base| 1) |#valid|))
(assert (not (exists ((v_ArrVal_422 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_422)))))
(check-sat)
(exit)
