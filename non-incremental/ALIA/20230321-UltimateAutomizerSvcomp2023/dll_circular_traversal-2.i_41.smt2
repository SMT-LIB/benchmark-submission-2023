...
(assert (forall ((v_ArrVal_667 (Array Int Int)) (v_arrayElimArr_10 (Array Int Int)) (v_arrayElimCell_39 Int) (v_arrayElimCell_35 Int) (v_arrayElimCell_38 Int) (v_ArrVal_671 (Array Int Int)) (v_arrayElimCell_37 Int)) (let ((.cse0 (store (store (store |#memory_int| |ULTIMATE.start_dll_circular_create_~head~0#1.base| v_arrayElimArr_10) |ULTIMATE.start_dll_circular_create_~last~0#1.base| v_ArrVal_667) |ULTIMATE.start_dll_circular_create_~head~0#1.base| v_ArrVal_671))) (or (= |ULTIMATE.start_main_~data_init~0#1| (select (select .cse0 v_arrayElimCell_38) v_arrayElimCell_39)) (= (select (select .cse0 v_arrayElimCell_35) v_arrayElimCell_37) |ULTIMATE.start_main_~data_init~0#1|) (not (= (select v_arrayElimArr_10 0) |ULTIMATE.start_dll_circular_create_~data#1|))))))
(assert (not (forall ((v_ArrVal_667 (Array Int Int)) (v_arrayElimArr_10 (Array Int Int)) (v_arrayElimCell_39 Int) (v_arrayElimCell_35 Int) (v_arrayElimCell_38 Int) (v_ArrVal_671 (Array Int Int)) (v_arrayElimCell_37 Int)) (let ((.cse0 (store (store (store |#memory_int| |ULTIMATE.start_dll_circular_create_~head~0#1.base| v_arrayElimArr_10) |ULTIMATE.start_dll_circular_create_~last~0#1.base| v_ArrVal_667) |ULTIMATE.start_dll_circular_create_~head~0#1.base| v_ArrVal_671))) (or (= |ULTIMATE.start_main_~data_init~0#1| (select (select .cse0 v_arrayElimCell_38) v_arrayElimCell_39)) (= (select (select .cse0 v_arrayElimCell_35) v_arrayElimCell_37) |ULTIMATE.start_main_~data_init~0#1|))))))
(assert (not (= (+ |ULTIMATE.start_dll_circular_create_~head~0#1.offset| 12) 0)))
(check-sat)
(exit)
