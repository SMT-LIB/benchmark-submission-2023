...
(assert (not (let ((.cse0 (<= (+ |c_dll_insert_master_~dll#1.base| 1) |c_#StackHeapBarrier|))) (and (or .cse0 (= (select |c_#memory_$Pointer$.base| |c_dll_insert_master_~dll#1.base|) (select |c_old(#memory_$Pointer$.base)| |c_dll_insert_master_~dll#1.base|))) (= |c_dll_insert_master_#in~dll#1.offset| |c_dll_insert_master_~dll#1.offset|) (or .cse0 (= (select |c_#memory_$Pointer$.offset| |c_dll_insert_master_~dll#1.base|) (select |c_old(#memory_$Pointer$.offset)| |c_dll_insert_master_~dll#1.base|))) (= |c_dll_insert_master_#in~dll#1.base| |c_dll_insert_master_~dll#1.base|)))))
(check-sat)
(exit)
