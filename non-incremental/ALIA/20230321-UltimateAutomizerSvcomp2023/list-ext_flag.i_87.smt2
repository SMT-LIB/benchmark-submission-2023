...
(assert (and (let ((.cse0 (= |c_ULTIMATE.start_main_#t~nondet4#1_primed| 0))) (or (and .cse0 (not |c_ULTIMATE.start_main_#t~short5#1_primed|)) (and |c_ULTIMATE.start_main_#t~short5#1_primed| (not .cse0)))) (<= 0 (+ |c_ULTIMATE.start_main_#t~nondet4#1_primed| 2147483648)) (<= |c_ULTIMATE.start_main_#t~nondet4#1_primed| 2147483647) |c_ULTIMATE.start_main_#t~short5#1|))
...
(assert (not (and (= |c_ULTIMATE.start_main_~a~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|)) (= 0 (select (select |c_#memory_int| |c_ULTIMATE.start_main_~a~0#1.base|) 4)))))
(check-sat)
(exit)
