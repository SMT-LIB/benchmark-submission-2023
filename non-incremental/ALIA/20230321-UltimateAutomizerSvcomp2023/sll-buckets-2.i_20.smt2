...
(assert (let ((.cse0 (+ |c_ULTIMATE.start_main_~item~0#1.offset| 8))) (and (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0)))) (= |c_#memory_int_primed| (store |c_#memory_int| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 2))) (= |c_ULTIMATE.start_main_#t~nondet9#1| 0) (= (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~item~0#1.base| (store (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~item~0#1.base|) .cse0))) |c_#memory_$Pointer$.offset_primed|))))
