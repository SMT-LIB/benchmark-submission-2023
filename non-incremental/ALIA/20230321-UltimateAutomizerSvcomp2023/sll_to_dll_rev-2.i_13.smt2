...
(assert (<= (+ |chain_node_alloc_node_#res#1.base| 1) |#StackHeapBarrier|))
(assert (= |chain_node_~ppnode#1.base| |chain_node_#in~ppnode#1.base|))
(assert (not (exists ((v_ArrVal_643 (Array Int Int))) (= (store |old(#memory_$Pointer$.base)| |chain_node_alloc_node_#res#1.base| v_ArrVal_643) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
