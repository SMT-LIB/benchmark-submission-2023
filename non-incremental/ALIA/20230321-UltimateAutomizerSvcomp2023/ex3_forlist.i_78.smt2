...
(declare-fun |c_ULTIMATE.start_main_~a~0#1.offset_Hier| () Int)
(declare-fun |c_ULTIMATE.start_main_~a~0#1.base_Hier| () Int)
(assert (and (= |c_ULTIMATE.start_main_~a~0#1.base_Hier| |c_g_#in~pointer#1.base|) (= |c_g_#in~pointer#1.offset| |c_ULTIMATE.start_main_~a~0#1.offset_Hier|)))
