...
(assert (and (= |c_ULTIMATE.start_main_~a~0#1.base_Hier| |c_f_#in~pointer.base|) (= |c_f_#in~pointer.offset| |c_ULTIMATE.start_main_~a~0#1.offset_Hier|)))
...
(assert (and (= |c_~#pstate~0.offset| 0) (<= |c_~#pp~0.base| 4) (<= 5 |c_~#pstate~0.base|)))
