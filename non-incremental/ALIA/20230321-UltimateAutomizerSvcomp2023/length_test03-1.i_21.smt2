...
(assert (not (and (exists ((v_DerPreprocessor_2 (Array Int Int)) (v_ArrVal_1353 (Array Int Int))) (= |c_#memory_$Pointer$.base| (store (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base v_DerPreprocessor_2) c_append_~head.base v_ArrVal_1353))) (= |c_append_#in~head.base| c_append_~head.base) (exists ((v_DerPreprocessor_1 (Array Int Int)) (v_ArrVal_1354 (Array Int Int))) (= |c_#memory_$Pointer$.offset| (store (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base v_DerPreprocessor_1) c_append_~head.base v_ArrVal_1354))) (= (select |c_old(#valid)| c_append_~node~0.base) 0) (= |c_#valid| (store |c_old(#valid)| c_append_~node~0.base (select |c_#valid| c_append_~node~0.base))))))
(check-sat)
(exit)
