...
(assert (exists ((v_ArrVal_1686 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| ~head~0.base v_ArrVal_1686))))
(assert (= |insert_list_#in~k| (select (select |#memory_int| insert_list_~l.base) 0)))
(assert (not (exists ((v_arrayElimArr_11 (Array Int Int))) (and (= |old(~head~0.offset)| (select v_arrayElimArr_11 4)) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| insert_list_~l.base v_arrayElimArr_11))))))
(check-sat)
(exit)
