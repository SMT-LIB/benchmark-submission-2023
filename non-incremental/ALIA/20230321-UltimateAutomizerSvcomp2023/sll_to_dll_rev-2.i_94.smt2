...
(assert (and (= |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier| 0) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (not (= (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) 0) 0)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_main_~#p2~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp2#1.base_Hier|) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p2~0#1.base_Hier|)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (= |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier| 0)))
