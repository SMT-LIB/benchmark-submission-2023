...
(assert (let ((.cse0 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|)) (.cse1 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|)) (.cse2 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_int)| |c_#memory_int|))) (and (= |c_node_create_#res#1.offset| 0) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (= (select (select |c_#memory_$Pointer$.base| |c_node_create_#res#1.base|) 4) 0) (= (select (select |c_#memory_$Pointer$.offset| |c_node_create_#res#1.base|) 4) 0) (or (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (<= (+ .cse0 1) |c_#StackHeapBarrier|)) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| .cse0 (select |c_#memory_$Pointer$.offset| .cse0))) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| .cse1 (select |c_#memory_$Pointer$.base| .cse1))) (or (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (<= (+ .cse1 1) |c_#StackHeapBarrier|)) (<= (+ |c_node_create_#res#1.base| 1) |c_#StackHeapBarrier|) (= (store |c_old(#memory_int)| .cse2 (select |c_#memory_int| .cse2)) |c_#memory_int|) (or (= |c_old(#memory_int)| |c_#memory_int|) (= .cse2 |c_node_create_#res#1.base|)))))
(assert (not (and (< |c_node_create_#res#1.base| |c_#StackHeapBarrier|) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (exists ((v_ArrVal_585 (Array Int Int))) (= (store |c_old(#memory_int)| |c_node_create_#res#1.base| v_ArrVal_585) |c_#memory_int|)) (exists ((v_ArrVal_584 (Array Int Int))) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| |c_node_create_#res#1.base| v_ArrVal_584))) (exists ((v_ArrVal_587 (Array Int Int))) (= (store |c_old(#memory_$Pointer$.offset)| |c_node_create_#res#1.base| v_ArrVal_587) |c_#memory_$Pointer$.offset|)))))
(check-sat)
(exit)
