...
(assert (not (and (= (select |c_#valid| |c_ULTIMATE.start_sl_random_insert_~a3~0#1.base|) 1) (exists ((|ULTIMATE.start_sl_random_insert_~sl#1.base| Int) (v_arrayElimIndex_10 Int)) (and (= (select |c_#valid| v_arrayElimIndex_10) 1) (not (= |c_ULTIMATE.start_sl_random_insert_~a3~0#1.base| v_arrayElimIndex_10)) (= (select |c_#valid| |ULTIMATE.start_sl_random_insert_~sl#1.base|) 1) (not (= |ULTIMATE.start_sl_random_insert_~sl#1.base| v_arrayElimIndex_10)) (not (= |c_ULTIMATE.start_sl_random_insert_~a3~0#1.base| |ULTIMATE.start_sl_random_insert_~sl#1.base|)))))))
(check-sat)
(exit)
