...
(assert (let ((.cse0 (select (select |c_#memory_int| c_~head~0.base) 0))) (and (<= |c_insert_list_#in~k| .cse0) (= |c_#valid| (store |c_old(#valid)| c_insert_list_~l.base 1)) (<= 5 .cse0) (= c_~head~0.offset 0) (= (store |c_old(#memory_$Pointer$.offset)| c_insert_list_~l.base (select |c_#memory_$Pointer$.offset| c_insert_list_~l.base)) |c_#memory_$Pointer$.offset|) (= |c_old(~head~0.base)| c_~head~0.base) (= c_insert_list_~k |c_insert_list_#in~k|) (= (select |c_#valid| c_~head~0.base) 1) (= c_insert_list_~l.offset 0) (= c_~head~0.offset |c_old(~head~0.offset)|) (exists ((v_ArrVal_1070 (Array Int Int))) (= (store |c_old(#memory_int)| c_insert_list_~l.base v_ArrVal_1070) |c_#memory_int|)) (= (select (select |c_#memory_int| c_insert_list_~l.base) 0) |c_insert_list_#in~k|) (= (select |c_old(#valid)| c_insert_list_~l.base) 0) (= (store |c_old(#memory_$Pointer$.base)| c_insert_list_~l.base (select |c_#memory_$Pointer$.base| c_insert_list_~l.base)) |c_#memory_$Pointer$.base|))))
