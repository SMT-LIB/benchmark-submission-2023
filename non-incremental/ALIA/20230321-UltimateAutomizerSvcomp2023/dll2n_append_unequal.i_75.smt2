...
(assert (< 0 |#StackHeapBarrier|))
(assert (= 0 |node_create_#res#1.offset|))
(assert (< |node_create_#res#1.base| |#StackHeapBarrier|))
(assert (exists ((v_ArrVal_1449 (Array Int Int))) (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| |node_create_#res#1.base| v_ArrVal_1449))))
(assert (exists ((v_ArrVal_1452 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1452))))
(assert (= (select |old(#valid)| |node_create_#res#1.base|) 0))
(assert (not (exists ((v_ArrVal_1450 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1450)))))
(check-sat)
(exit)
