...
(assert (not (and (<= |c_ULTIMATE.start_main_~expected~0#1| |c_ULTIMATE.start_dll_circular_get_data_at_#res#1|) (<= |c_ULTIMATE.start_dll_circular_get_data_at_#res#1| |c_ULTIMATE.start_main_~expected~0#1|))))
(check-sat)
(exit)
