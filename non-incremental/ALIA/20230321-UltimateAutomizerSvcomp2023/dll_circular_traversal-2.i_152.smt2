...
(assert (not (and (= |c_ULTIMATE.start_main_~data_init~0#1| 1) (= |c_ULTIMATE.start_dll_circular_create_#res#1.offset| 0) (= (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 4)) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 4)) 1))))
(check-sat)
(exit)
