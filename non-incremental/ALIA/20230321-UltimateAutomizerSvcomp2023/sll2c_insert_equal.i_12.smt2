...
(assert (not (let ((.cse0 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_circular_insert_~head#1.base|))) (let ((.cse1 (select .cse0 |c_ULTIMATE.start_sll_circular_insert_~head#1.offset|)) (.cse2 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_circular_insert_~head#1.base|))) (let ((.cse3 (select (select |c_#memory_$Pointer$.offset| .cse1) (select .cse2 |c_ULTIMATE.start_sll_circular_insert_~head#1.offset|)))) (and (not (= .cse0 (select |c_#memory_$Pointer$.base| .cse1))) (= |c_ULTIMATE.start_sll_circular_insert_~head#1.offset| |c_ULTIMATE.start_main_~#s~0#1.offset|) (= (select .cse2 |c_ULTIMATE.start_main_~#s~0#1.offset|) 0) (not (= |c_ULTIMATE.start_sll_circular_insert_#t~ret9#1.base| |c_ULTIMATE.start_sll_circular_insert_~head#1.base|)) (not (= .cse1 |c_ULTIMATE.start_sll_circular_insert_#t~ret9#1.base|)) (= |c_ULTIMATE.start_sll_circular_insert_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| .cse1) 8)) (= |c_ULTIMATE.start_sll_circular_insert_#t~ret9#1.offset| .cse3) (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_circular_insert_#t~ret9#1.base|) |c_ULTIMATE.start_sll_circular_insert_#t~ret9#1.offset|) .cse3)))))))
(check-sat)
(exit)
