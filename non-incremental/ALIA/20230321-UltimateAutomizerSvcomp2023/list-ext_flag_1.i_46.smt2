...
(assert (not (and (= |c_ULTIMATE.start_main_~a~0#1.offset| 0) (not (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|)) (= 0 (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~a~0#1.base|) 4)))))
(check-sat)
(exit)
