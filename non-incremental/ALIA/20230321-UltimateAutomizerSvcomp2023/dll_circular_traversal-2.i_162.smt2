...
(assert (not (and (= |c_ULTIMATE.start_dll_circular_create_~head~0#1.offset_primed| 0) (= |c_ULTIMATE.start_main_~data_init~0#1| 1) (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|)) (= (select (select |c_#memory_int_primed| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base_primed|) 0) 1) (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base_primed|)) (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.offset| 0) (= |c_ULTIMATE.start_dll_circular_create_~data#1| 1) (not (= |c_ULTIMATE.start_dll_circular_create_~head~0#1.base_primed| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|)))))
(check-sat)
(exit)
