...
(assert (exists ((v_ArrVal_1087 (Array Int Int))) (= |#memory_int| (store |old(#memory_int)| |node_create_#res#1.base| v_ArrVal_1087))))
...
(assert (not (exists ((v_ArrVal_1086 (Array Int Int))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_1086)))))
(check-sat)
(exit)
