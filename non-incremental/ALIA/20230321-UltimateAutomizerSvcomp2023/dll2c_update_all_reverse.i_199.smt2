...
(assert (not (and (= |c_ULTIMATE.start_main_~len~0#1| 2) (= |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.offset| 0) (= |c_ULTIMATE.start_dll_circular_create_~head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|) (not (= |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.base| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base|)))))
(check-sat)
(exit)
