...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 4))) (and (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) 4) 0) (= |c_ULTIMATE.start_main_~data_init~0#1| 1) (not (= |c_ULTIMATE.start_dll_circular_create_#res#1.base| .cse0)) (= (select (select |c_#memory_int| .cse0) 0) 1) (= |c_ULTIMATE.start_dll_circular_create_#res#1.offset| 0)))))
(check-sat)
(exit)
