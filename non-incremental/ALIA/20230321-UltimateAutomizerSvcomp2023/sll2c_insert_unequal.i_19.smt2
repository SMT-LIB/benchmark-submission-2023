...
(assert (not (let ((.cse0 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_int)| |c_#memory_int|))) (let ((.cse3 (store |c_old(#memory_int)| .cse0 (select |c_#memory_int| .cse0)))) (let ((.cse2 (ULTIMATE@diffIntArray_Int_Int .cse3 |c_#memory_int|)) (.cse1 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|)) (.cse4 (ULTIMATE@diffIntArray_Int_Int |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|))) (and (or (= |c_old(#memory_int)| |c_#memory_int|) (= (select |c_old(#valid)| .cse0) 0)) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (or (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (<= (+ .cse1 1) |c_#StackHeapBarrier|)) (or (= (select |c_old(#valid)| .cse2) 0) (= .cse3 |c_#memory_int|)) (= (store .cse3 .cse2 (select |c_#memory_int| .cse2)) |c_#memory_int|) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| .cse1 (select |c_#memory_$Pointer$.offset| .cse1))) (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)| .cse4 (select |c_#memory_$Pointer$.base| .cse4))) (or (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (<= (+ .cse4 1) |c_#StackHeapBarrier|)) (<= (+ |c_node_create_#res#1.base| 1) |c_#StackHeapBarrier|)))))))
(check-sat)
(exit)
