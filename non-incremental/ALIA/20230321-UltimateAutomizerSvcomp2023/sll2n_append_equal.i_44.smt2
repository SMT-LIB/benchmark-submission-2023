...
(assert (not (forall ((v_ArrVal_885 Int) (v_ArrVal_882 (Array Int Int)) (|v_ULTIMATE.start_sll_append_~last~0#1.offset_11| Int) (v_ArrVal_886 Int)) (let ((.cse2 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_append_~last~0#1.base|) (+ |c_ULTIMATE.start_sll_append_~last~0#1.offset| 4)))) (let ((.cse0 (select |c_#memory_$Pointer$.base| .cse2)) (.cse1 (+ |v_ULTIMATE.start_sll_append_~last~0#1.offset_11| 4))) (or (not (= (select .cse0 .cse1) 0)) (= (select (select (store |c_#memory_int| .cse2 v_ArrVal_882) (select (select (store |c_#memory_$Pointer$.base| .cse2 (store .cse0 .cse1 v_ArrVal_886)) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (select (select (store |c_#memory_$Pointer$.offset| .cse2 (store (select |c_#memory_$Pointer$.offset| .cse2) .cse1 v_ArrVal_885)) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) |c_ULTIMATE.start_main_~data~0#1|)))))))
(check-sat)
(exit)
