...
(assert (let ((.cse0 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) 0))) (and (= .cse0 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) 0)) (= (select |c_#valid_Hier| .cse0) 1) (= |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier| 0) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (not (= (select (select |c_#memory_$Pointer$.base_Hier| .cse0) 0) 0)) (not (= .cse0 0)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (= |c_ULTIMATE.start_main_~#p2~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp2#1.base_Hier|) (not (= |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| |c_ULTIMATE.start_main_~#p2~0#1.base_Hier|)) (< |c_#StackHeapBarrier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (< .cse0 |c_#StackHeapBarrier|) (= (select (select |c_#memory_$Pointer$.offset_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) 0) 0) (= (select (select |c_#memory_$Pointer$.offset_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) 0) 0) (= |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier| 0))))
