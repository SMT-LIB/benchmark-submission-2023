...
(assert (let ((.cse1 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|))) (let ((.cse0 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|)) (.cse2 (select .cse1 4))) (and (= (select .cse0 4) 0) (= |c_ULTIMATE.start_main_~list~0#1.offset| 0) (<= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~list~0#1.base|) 0) 1) (= |c_ULTIMATE.start_main_~list~0#1.base| (select .cse1 12)) (= (select .cse0 12) 0) (= |c_ULTIMATE.start_main_~m~0#1.base| .cse2) (not (= |c_ULTIMATE.start_main_~m~0#1.base| |c_ULTIMATE.start_main_~list~0#1.base|)) (= |c_ULTIMATE.start_main_~m~0#1.offset| 0) (<= |c_ULTIMATE.start_main_#t~mem9#1| (select (select |c_#memory_int| .cse2) 0))))))
