...
(assert (forall ((v_ArrVal_277 Int) (v_ArrVal_280 (Array Int Int))) (= (select (select (store (store |#memory_int| |ULTIMATE.start_main_~p~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~p~0#1.base|) (+ |ULTIMATE.start_main_~p~0#1.offset| 4) v_ArrVal_277)) |ULTIMATE.start_main_~t~0#1.base| v_ArrVal_280) |ULTIMATE.start_main_~a~0#1.base|) |ULTIMATE.start_main_~a~0#1.offset|) 1)))
(assert (= |ULTIMATE.start_main_~a~0#1.offset| 0))
(assert (forall ((v_ArrVal_280 (Array Int Int))) (= (select (select (store |#memory_int| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_280) |ULTIMATE.start_main_~a~0#1.base|) |ULTIMATE.start_main_~a~0#1.offset|) 1)))
(check-sat)
(exit)
