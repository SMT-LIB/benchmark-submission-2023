...
(assert (not (and (exists ((v_DerPreprocessor_5 (Array Int Int)) (v_ArrVal_1357 (Array Int Int)) (v_ArrVal_1356 (Array Int Int)) (v_DerPreprocessor_6 (Array Int Int))) (let ((.cse0 (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base v_DerPreprocessor_5))) (and (= (store (store .cse0 |c_append_#in~head.base| v_ArrVal_1356) c_append_~node~0.base v_ArrVal_1357) |c_#memory_$Pointer$.offset|) (= v_DerPreprocessor_5 (select (store .cse0 |c_append_#in~head.base| v_DerPreprocessor_6) c_append_~node~0.base))))) (= (store (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base (select |c_#memory_$Pointer$.base| c_append_~node~0.base)) c_append_~head.base (select |c_#memory_$Pointer$.base| c_append_~head.base)) |c_#memory_$Pointer$.base|) (= |c_#memory_$Pointer$.offset| (store (store |c_old(#memory_$Pointer$.offset)| c_append_~node~0.base (select |c_#memory_$Pointer$.offset| c_append_~node~0.base)) c_append_~head.base (select |c_#memory_$Pointer$.offset| c_append_~head.base))) (= |c_append_#in~head.base| c_append_~head.base) (exists ((v_DerPreprocessor_3 (Array Int Int)) (v_ArrVal_1358 (Array Int Int)) (v_DerPreprocessor_4 (Array Int Int)) (v_ArrVal_1355 (Array Int Int))) (let ((.cse1 (store |c_old(#memory_$Pointer$.base)| c_append_~node~0.base v_DerPreprocessor_3))) (and (= (select (store .cse1 |c_append_#in~head.base| v_DerPreprocessor_4) c_append_~node~0.base) v_DerPreprocessor_3) (= |c_#memory_$Pointer$.base| (store (store .cse1 |c_append_#in~head.base| v_ArrVal_1355) c_append_~node~0.base v_ArrVal_1358))))) (= (select |c_old(#valid)| c_append_~node~0.base) 0) (= |c_#valid| (store |c_old(#valid)| c_append_~node~0.base (select |c_#valid| c_append_~node~0.base))))))
(check-sat)
(exit)
