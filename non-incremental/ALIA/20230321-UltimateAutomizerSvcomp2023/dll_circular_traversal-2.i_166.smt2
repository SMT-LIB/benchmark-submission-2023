...
(assert (not (forall ((v_ArrVal_671 (Array Int Int))) (= |c_ULTIMATE.start_main_~data_init~0#1| (let ((.cse0 (+ |c_ULTIMATE.start_dll_circular_create_#res#1.offset| 4))) (select (select (store |c_#memory_int_primed| |c_ULTIMATE.start_dll_circular_create_#res#1.base| v_ArrVal_671) (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) .cse0)) (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_dll_circular_create_#res#1.base|) .cse0)))))))
(check-sat)
(exit)
