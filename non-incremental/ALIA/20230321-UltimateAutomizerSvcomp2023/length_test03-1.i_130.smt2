...
(assert (exists ((v_DerPreprocessor_11 (Array Int Int)) (v_ArrVal_1591 (Array Int Int)) (v_DerPreprocessor_12 (Array Int Int))) (let ((.cse0 (store |old(#memory_$Pointer$.base)| append_~node~0.base v_DerPreprocessor_11))) (and (= (store .cse0 |append_#in~head.base| v_ArrVal_1591) |#memory_$Pointer$.base|) (= v_DerPreprocessor_11 (select (store .cse0 |append_#in~head.base| v_DerPreprocessor_12) append_~node~0.base))))))
(assert (not (exists ((v_DerPreprocessor_10 (Array Int Int)) (v_DerPreprocessor_9 (Array Int Int)) (v_ArrVal_1592 (Array Int Int))) (let ((.cse0 (store |old(#memory_$Pointer$.offset)| append_~node~0.base v_DerPreprocessor_9))) (and (= (select (store .cse0 |append_#in~head.base| v_DerPreprocessor_10) append_~node~0.base) v_DerPreprocessor_9) (= |#memory_$Pointer$.offset| (store .cse0 |append_#in~head.base| v_ArrVal_1592)))))))
(check-sat)
(exit)
