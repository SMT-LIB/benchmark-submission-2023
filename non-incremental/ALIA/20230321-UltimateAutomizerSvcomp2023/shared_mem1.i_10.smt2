...
(assert (<= (select (select |#memory_int| |ULTIMATE.start_main_~head~0#1.base|) 0) 1))
(assert (not (exists ((v_DerPreprocessor_1 (Array Int Int)) (v_DerPreprocessor_2 (Array Int Int))) (let ((.cse0 (select |#memory_int| |ULTIMATE.start_main_~head~0#1.base|))) (and (= (select |#memory_int| |ULTIMATE.start_main_~m~0#1.base|) (select (store (store (store (store |#memory_int| |ULTIMATE.start_main_~m~0#1.base| v_DerPreprocessor_1) |ULTIMATE.start_main_~head~0#1.base| v_DerPreprocessor_2) |ULTIMATE.start_main_~m~0#1.base| v_DerPreprocessor_1) |ULTIMATE.start_main_~head~0#1.base| v_DerPreprocessor_2) |ULTIMATE.start_main_~m~0#1.base|)) (= (select v_DerPreprocessor_2 12) (select .cse0 12)) (= (select .cse0 0) (select v_DerPreprocessor_2 0)) (= (select v_DerPreprocessor_2 4) (select .cse0 4)))))))
(check-sat)
(exit)
