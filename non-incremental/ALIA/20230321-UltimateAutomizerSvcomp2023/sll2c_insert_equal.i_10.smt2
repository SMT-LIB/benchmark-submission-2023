...
(assert (not (and (= |c_ULTIMATE.start_sll_circular_create_#res#1.offset| 0) (= 0 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) 0)) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) 8)) (let ((.cse0 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|))) (or (not (= |c_ULTIMATE.start_sll_circular_create_#res#1.base| (select .cse0 |c_ULTIMATE.start_main_~#s~0#1.offset|))) (not (= (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) .cse0)))) (<= (+ |c_#StackHeapBarrier| 1) |c_ULTIMATE.start_main_~#s~0#1.base|) (= (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) 1))))
(check-sat)
(exit)
