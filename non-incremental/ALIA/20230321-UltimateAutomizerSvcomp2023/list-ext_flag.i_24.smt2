...
(assert (not (and (= |c_ULTIMATE.start_main_~a~0#1.offset| 0) (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|) (= |c_ULTIMATE.start_main_~p~0#1.offset| 0) (= (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|) 1) (= (select (select |c_#memory_int_primed| |c_ULTIMATE.start_main_~p~0#1.base|) 0) 2))))
(check-sat)
(exit)
