...
(assert (not (exists ((v_arrayElimArr_5 (Array Int Int))) (and (= |old(~head~0.base)| (select v_arrayElimArr_5 4)) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| insert_list_~l.base v_arrayElimArr_5))))))
(check-sat)
(exit)
