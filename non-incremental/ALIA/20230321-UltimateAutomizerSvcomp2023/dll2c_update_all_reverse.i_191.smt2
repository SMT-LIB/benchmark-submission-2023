...
(assert (not (and (not (= 0 (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|))) (not (= (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base|) 0)))))
(check-sat)
(exit)
