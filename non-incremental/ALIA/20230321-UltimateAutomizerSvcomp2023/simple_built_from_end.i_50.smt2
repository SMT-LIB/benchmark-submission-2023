...
(assert (not (let ((.cse1 (+ |c_ULTIMATE.start_main_~p~0#1.offset| 4))) (and (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int)) (or (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_17|) 0)) (forall ((v_arrayElimArr_15 (Array Int Int)) (v_arrayElimArr_16 (Array Int Int))) (or (= (select (let ((.cse0 (store |c_#memory_$Pointer$.base| |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_15))) (select .cse0 (select (select .cse0 |c_ULTIMATE.start_main_~p~0#1.base|) .cse1))) (+ (select (select (store |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_16) |c_ULTIMATE.start_main_~p~0#1.base|) .cse1) 4)) 0) (not (= (select v_arrayElimArr_16 4) |c_ULTIMATE.start_main_~p~0#1.offset|)) (not (= (select v_arrayElimArr_15 4) |c_ULTIMATE.start_main_~p~0#1.base|)))))) (forall ((|v_ULTIMATE.start_main_~t~0#1.base_17| Int)) (or (forall ((v_arrayElimArr_17 (Array Int Int)) (v_arrayElimArr_18 (Array Int Int))) (or (not (= (select v_arrayElimArr_18 4) |c_ULTIMATE.start_main_~p~0#1.offset|)) (not (= |c_ULTIMATE.start_main_~p~0#1.base| (select v_arrayElimArr_17 4))) (= (let ((.cse2 (store |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_18))) (select (select .cse2 (select (select (store |c_#memory_$Pointer$.base| |v_ULTIMATE.start_main_~t~0#1.base_17| v_arrayElimArr_17) |c_ULTIMATE.start_main_~p~0#1.base|) .cse1)) (+ (select (select .cse2 |c_ULTIMATE.start_main_~p~0#1.base|) .cse1) 4))) 0))) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_17|) 0))))))))
(check-sat)
(exit)
