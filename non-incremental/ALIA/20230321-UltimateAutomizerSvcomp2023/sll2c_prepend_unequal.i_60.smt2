...
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.offset| () Int)
...
(assert (not (let ((.cse3 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|))) (let ((.cse2 (select |c_#memory_$Pointer$.base| .cse3)) (.cse1 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|))) (let ((.cse0 (select .cse2 .cse1))) (and (= |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.offset| 0) (= (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base|) 8) |c_ULTIMATE.start_main_~uneq~0#1|) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset| |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_sll_circular_prepend_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= .cse0 |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|)) (not (= |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|)) (or (and (= .cse1 0) (= (select (select |c_#memory_$Pointer$.base| (select .cse2 0)) (select (select |c_#memory_$Pointer$.offset| .cse3) 0)) 0)) (not (= |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base| .cse0)))))))))
(check-sat)
(exit)
