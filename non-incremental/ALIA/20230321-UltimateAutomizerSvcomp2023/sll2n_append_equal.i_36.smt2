...
(declare-fun |c_ULTIMATE.start_sll_create_#t~ret5#1.base| () Int)
(declare-fun |c_ULTIMATE.start_sll_create_#t~ret5#1.offset| () Int)
...
(assert (not (and (< |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= |c_ULTIMATE.start_sll_create_#t~ret5#1.base| 0)) (= |c_ULTIMATE.start_main_~#s~0#1.offset| 0) (= (select |c_#valid| |c_ULTIMATE.start_sll_create_~head~0#1.base|) 1) (= |c_ULTIMATE.start_main_~data~0#1| 1) (= |c_ULTIMATE.start_sll_create_#t~ret5#1.offset| 0) (not (= |c_ULTIMATE.start_sll_create_#t~ret5#1.base| |c_ULTIMATE.start_sll_create_~head~0#1.base|)) (= (select |c_#valid| |c_ULTIMATE.start_sll_create_#t~ret5#1.base|) 1) (< |c_ULTIMATE.start_sll_create_#t~ret5#1.base| |c_#StackHeapBarrier|) (= (select (select |c_#memory_int| |c_ULTIMATE.start_sll_create_#t~ret5#1.base|) 0) 1))))
(check-sat)
(exit)
