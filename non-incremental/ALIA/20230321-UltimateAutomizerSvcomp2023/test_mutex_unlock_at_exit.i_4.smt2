...
(declare-fun |c_ULTIMATE.start_foo_#t~ret31#1.base| () Int)
(declare-fun |c_ULTIMATE.start_foo_~m1~0#1.base| () Int)
...
(assert (and (not (= |c_ULTIMATE.start_foo_~m1~0#1.base| 3)) (= (select |c_#valid| 3) 1) (= |c_~#mutexes~0.offset| 0) (not (= |c_ULTIMATE.start_foo_~m1~0#1.base| |c_ULTIMATE.start_foo_#t~ret31#1.base|)) (= (select (select |c_#memory_$Pointer$.offset| 3) 0) 0) (= (select (select |c_#memory_$Pointer$.base| 3) 0) 3) (= 3 |c_~#mutexes~0.base|) (= (select |c_#valid| |c_ULTIMATE.start_foo_#t~ret31#1.base|) 1) (= (select |c_#valid| |c_ULTIMATE.start_foo_~m1~0#1.base|) 1) (not (= 3 |c_ULTIMATE.start_foo_#t~ret31#1.base|))))
