...
(assert (not (and (= (select (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~prev.base|) |__ldv_list_add_#in~prev.offset|) |__ldv_list_add_#in~new.offset|) (= |__ldv_list_add_#in~new.base| |__ldv_list_add_#in~prev.base|))))
