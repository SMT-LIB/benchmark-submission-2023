...
(assert (exists ((v_arrayElimArr_2 (Array Int Int))) (and (= |#memory_$Pointer$.offset| (store |old(#memory_$Pointer$.offset)| insert_list_~l.base v_arrayElimArr_2)) (= (select v_arrayElimArr_2 4) |old(~head~0.offset)|))))
(assert (= insert_list_~l.offset 0))
(assert (not (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= |old(~head~0.base)| (select v_arrayElimArr_1 4)) (= (store |old(#memory_$Pointer$.base)| insert_list_~l.base v_arrayElimArr_1) |#memory_$Pointer$.base|)))))
(check-sat)
(exit)
