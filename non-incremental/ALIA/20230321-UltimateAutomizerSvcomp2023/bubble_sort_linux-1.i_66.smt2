...
(assert (let ((.cse1 (select |#memory_$Pointer$.offset| 3))) (and (exists ((v_arrayElimArr_11 (Array Int Int)) (v_ArrVal_1911 (Array Int Int)) (v_DerPreprocessor_4 (Array Int Int)) (v_ArrVal_1910 Int) (|list_add___list_add_~next#1.offset| Int)) (let ((.cse0 (store (store (store |#memory_$Pointer$.base| 3 v_arrayElimArr_11) |ULTIMATE.start_gl_insert_~node~1#1.base| v_DerPreprocessor_4) 3 v_arrayElimArr_11)) (.cse2 (+ |list_add___list_add_~next#1.offset| 8))) (and (= 3 (select v_arrayElimArr_11 8)) (= (store (select (store .cse0 |ULTIMATE.start_gl_insert_~node~1#1.base| v_ArrVal_1911) 3) 0 |ULTIMATE.start_gl_insert_~node~1#1.base|) (select |#memory_$Pointer$.base| 3)) (= (select |#memory_$Pointer$.base| |ULTIMATE.start_gl_insert_~node~1#1.base|) (store (store (select .cse0 |ULTIMATE.start_gl_insert_~node~1#1.base|) 4 3) 12 v_ArrVal_1910)) (= (select .cse1 .cse2) 4) (= |ULTIMATE.start_gl_insert_~node~1#1.base| (select v_arrayElimArr_11 .cse2)) (= 3 (select v_arrayElimArr_11 0))))) (= (select .cse1 8) 0))))
(check-sat)
(exit)
