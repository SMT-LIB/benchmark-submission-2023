...
(assert (not (and (<= 0 |c_ULTIMATE.start_sll_create_~head~0#1.offset|) (<= |c_ULTIMATE.start_sll_create_~head~0#1.offset| 0) (not (= |c_ULTIMATE.start_sll_create_~head~0#1.base| 0)) (= (select |c_#valid| |c_ULTIMATE.start_sll_create_~head~0#1.base|) 1) (not (= |c_ULTIMATE.start_sll_create_~head~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_sll_create_~head~0#1.base|) (+ 4 |c_ULTIMATE.start_sll_create_~head~0#1.offset|)) 0) (<= (+ |c_#StackHeapBarrier| 1) |c_ULTIMATE.start_main_~#s~0#1.base|) (= |c_ULTIMATE.start_main_~data~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_create_~head~0#1.base|) 0)))))
(check-sat)
(exit)
