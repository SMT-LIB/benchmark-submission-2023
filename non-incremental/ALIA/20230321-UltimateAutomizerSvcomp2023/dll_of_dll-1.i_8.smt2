...
(assert (or (<= (+ |c_##fun~$Pointer$~TO~VOID_#in~10#1.base| 1) |c_#StackHeapBarrier|) (not (= (select (select |c_old(#memory_$Pointer$.offset)| |c_##fun~$Pointer$~TO~VOID_#in~10#1.base|) |c_##fun~$Pointer$~TO~VOID_#in~10#1.offset|) 0)) (not (= (select (select |c_old(#memory_$Pointer$.base)| |c_##fun~$Pointer$~TO~VOID_#in~10#1.base|) |c_##fun~$Pointer$~TO~VOID_#in~10#1.offset|) 0))))
