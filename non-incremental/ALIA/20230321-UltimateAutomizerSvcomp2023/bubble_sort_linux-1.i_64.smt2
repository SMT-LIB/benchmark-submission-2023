...
(declare-fun |c_ULTIMATE.start_gl_sort_pass_#t~ret58#1_primed| () Int)
...
(declare-fun |c_ULTIMATE.start_gl_sort_pass_~pos1~0#1.offset_Hier| () Int)
(declare-fun |c_ULTIMATE.start_gl_sort_pass_~pos1~0#1.base_Hier| () Int)
(assert (and (= |c_val_from_node_#in~head.offset| |c_ULTIMATE.start_gl_sort_pass_~pos1~0#1.offset_Hier|) (= |c_val_from_node_#in~head.base| |c_ULTIMATE.start_gl_sort_pass_~pos1~0#1.base_Hier|)))
(assert (and (= |c_#memory_$Pointer$.base| |c_old(#memory_$Pointer$.base)|) (= (select |c_#valid| 3) 1) (= |c_~#gl_list~0.offset| 0) (= 3 |c_~#gl_list~0.base|) (= |c_old(#memory_int)| |c_#memory_int|) (let ((.cse3 (select |c_#memory_$Pointer$.base| 3))) (let ((.cse2 (select .cse3 8))) (let ((.cse0 (select .cse3 0)) (.cse1 (= .cse2 3))) (or (and (not (= .cse0 3)) .cse1 (not (= .cse0 0))) (and (= .cse0 .cse2) (not .cse1) (not (= .cse2 0))))))) (= |c_#memory_$Pointer$.offset| |c_old(#memory_$Pointer$.offset)|) (not (= (select (select |c_#memory_$Pointer$.offset| 3) 8) 0))))
...
(assert (and (= |c_~#gl_list~0.base| 3) (= (select |c_#valid| 3) 1) (not (= (select (select |c_#memory_$Pointer$.offset| 3) 8) 0)) (= |c_~#gl_list~0.offset| 0) (let ((.cse3 (select |c_#memory_$Pointer$.base| 3))) (let ((.cse2 (select .cse3 8))) (let ((.cse0 (select .cse3 0)) (.cse1 (= .cse2 3))) (or (and (not (= .cse0 0)) (not (= .cse0 3)) .cse1) (and (= .cse0 .cse2) (not .cse1) (not (= .cse2 0)))))))))
