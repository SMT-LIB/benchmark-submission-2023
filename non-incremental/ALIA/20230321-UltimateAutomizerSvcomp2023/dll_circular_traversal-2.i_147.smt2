...
(assert (or (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base| 0)) (not (= |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.offset| 0))))
...
(assert (not (and (= (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~ptr~0#1.base|) 4)) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~ptr~0#1.base|) 4)) |c_ULTIMATE.start_main_~data_init~0#1|) (= |c_ULTIMATE.start_main_~data_init~0#1| |c_ULTIMATE.start_main_~data_new~0#1|) (= |c_ULTIMATE.start_main_~ptr~0#1.offset| 0) (= |c_ULTIMATE.start_main_#t~mem7#1| (select (select |c_#memory_int| |c_ULTIMATE.start_main_~ptr~0#1.base|) 0)))))
(check-sat)
(exit)
