...
(assert (and (= |c_#valid| (store |c_old(#valid)| |c_ldv_successful_malloc_~ptr~0#1.base| 1)) (= |c_~#mutexes~0.offset| 0) (= (select |c_old(#valid)| |c_ldv_successful_malloc_~ptr~0#1.base|) 0) (= (select (select |c_#memory_$Pointer$.offset| 3) 0) 0) (= (select (select |c_#memory_$Pointer$.base| 3) 0) 3) (= 3 |c_~#mutexes~0.base|)))
