...
(assert (or (not (= 0 (select (select |old(#memory_$Pointer$.offset)| |##fun~$Pointer$~TO~VOID_#in~10#1.base|) |##fun~$Pointer$~TO~VOID_#in~10#1.offset|))) (<= (+ |##fun~$Pointer$~TO~VOID_#in~10#1.base| 1) |#StackHeapBarrier|)))
