...
(assert (not (and (= |c_#valid| (store |c_old(#valid)| |c_node_create_#res#1.base| 1)) (= |c_node_create_#res#1.offset| 0) (= (select |c_old(#valid)| |c_node_create_#res#1.base|) 0) (exists ((v_arrayElimArr_1 (Array Int Int))) (and (= (store |c_old(#memory_int)| |c_node_create_#res#1.base| v_arrayElimArr_1) |c_#memory_int|) (= |c_node_create_#in~data#1| (select v_arrayElimArr_1 8)))))))
(check-sat)
(exit)
