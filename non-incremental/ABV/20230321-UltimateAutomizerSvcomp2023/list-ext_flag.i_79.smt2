...
(assert (forall ((v_ArrVal_309 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base|) (bvadd (_ bv8 64) |ULTIMATE.start_main_~p~0#1.offset|)) v_ArrVal_309) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|)) (_ bv0 32))))
