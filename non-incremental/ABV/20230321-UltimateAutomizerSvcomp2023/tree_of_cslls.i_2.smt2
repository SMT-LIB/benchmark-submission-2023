...
(assert (forall ((v_ArrVal_437 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_435 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (_ bv1 1) (select |c_#valid| (let ((.cse1 (bvadd |c_ULTIMATE.start_main_~tree~0#1.offset| (_ bv16 64)))) (select (select (let ((.cse0 (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~tmpList~0#1.base| v_ArrVal_435))) (store .cse0 (select (select .cse0 |c_ULTIMATE.start_main_~tree~0#1.base|) .cse1) v_ArrVal_437)) |c_ULTIMATE.start_main_~tree~0#1.base|) .cse1)))))))
(check-sat)
(exit)
