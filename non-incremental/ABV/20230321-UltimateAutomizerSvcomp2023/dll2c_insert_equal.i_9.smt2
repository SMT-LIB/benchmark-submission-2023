...
(assert (not (let ((.cse2 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (_ bv0 64)))) (let ((.cse0 (select |c_#memory_$Pointer$.base| .cse2))) (let ((.cse1 (select .cse0 (_ bv0 64)))) (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (exists ((v_DerPreprocessor_2 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_1 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (select v_DerPreprocessor_2 (_ bv8 64)) (select .cse0 (_ bv8 64))) (= (select |c_#memory_$Pointer$.base| .cse1) (select (store (store (store (store |c_#memory_$Pointer$.base| .cse1 v_DerPreprocessor_1) .cse2 v_DerPreprocessor_2) .cse1 v_DerPreprocessor_1) .cse2 v_DerPreprocessor_2) .cse1)))) (not (= .cse2 .cse1)) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~#s~0#1.base|)) (_ bv0 1)) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= |c_ULTIMATE.start_dll_circular_insert_~head#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) (_ bv0 64))) (not (= |c_ULTIMATE.start_main_~#s~0#1.base| .cse1)) (= (_ bv0 1) (bvadd (select |c_#valid| .cse1) (_ bv1 1))) (= (_ bv0 64) |c_ULTIMATE.start_dll_circular_insert_~head#1.offset|) (= (bvadd (select |c_#valid| .cse2) (_ bv1 1)) (_ bv0 1)) (= (_ bv1 32) (select (select |c_#memory_int| .cse2) (_ bv16 64))) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|)))))))
(check-sat)
(exit)
