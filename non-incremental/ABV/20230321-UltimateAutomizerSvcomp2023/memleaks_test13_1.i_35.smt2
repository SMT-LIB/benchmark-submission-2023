...
(assert (not (exists ((v_ArrVal_13 (_ BitVec 64)) (|ldv_malloc_#res.base| (_ BitVec 64))) (and (= (_ bv0 1) (select |old(#valid)| |ldv_malloc_#res.base|)) (= (store |old(#length)| |ldv_malloc_#res.base| v_ArrVal_13) |#length|)))))
(check-sat)
(exit)
