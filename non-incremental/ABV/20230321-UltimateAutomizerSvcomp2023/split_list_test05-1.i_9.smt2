...
(assert (not (and (or (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_append_#in~head.base|) (bvadd (_ bv8 64) |c_append_#in~head.offset|)))) (and (= |c_#valid| (store |c_old(#valid)| .cse0 (_ bv1 1))) (= (_ bv0 1) (select |c_old(#valid)| .cse0)))) (and (= (store |c_old(#valid)| |c_append_#in~head.base| (_ bv1 1)) |c_#valid|) (= (_ bv0 1) (select |c_old(#valid)| |c_append_#in~head.base|)))) (= (bvadd (select |c_#valid| |c_append_#in~head.base|) (_ bv1 1)) (_ bv0 1)))))
(check-sat)
(exit)
