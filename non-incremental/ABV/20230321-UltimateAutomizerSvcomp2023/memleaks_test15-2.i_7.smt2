...
(declare-fun |ULTIMATE.start_entry_point_#t~ret53#1.base| () (_ BitVec 64))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_#t~ret53#1.base|)))
(assert (not (exists ((v_ArrVal_52 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_#t~ret53#1.base| v_ArrVal_52)))))
(check-sat)
(exit)
