...
(assert (not (forall ((v_ArrVal_200 (Array (_ BitVec 64) (_ BitVec 32)))) (= (_ bv2 32) (select (select (store |#memory_int| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) (_ bv4 64)) v_ArrVal_200) |ULTIMATE.start_main_~s~0#1.base|) (_ bv0 64))))))
(check-sat)
(exit)
