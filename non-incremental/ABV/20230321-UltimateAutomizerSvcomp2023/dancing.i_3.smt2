...
(declare-fun |c_ULTIMATE.start_remove_#t~mem3#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_remove_#t~mem3#1.offset| () (_ BitVec 64))
...
(assert (let ((.cse3 (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_remove_~x#1.base|)) (.cse2 (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_remove_~x#1.base|)) (.cse4 (bvadd |c_ULTIMATE.start_remove_~x#1.offset| (_ bv8 64)))) (let ((.cse0 (select .cse2 .cse4)) (.cse1 (select .cse3 .cse4))) (and (or (not (= (_ bv0 64) |c_ULTIMATE.start_remove_#t~mem3#1.base|)) (not (= (_ bv0 64) |c_ULTIMATE.start_remove_#t~mem3#1.offset|))) (= (store |c_#memory_int| .cse0 (store (select |c_#memory_int| .cse0) .cse1 (select (select |c_#memory_int_primed| .cse0) .cse1))) |c_#memory_int_primed|) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| .cse0 (store (select |c_#memory_$Pointer$.base| .cse0) .cse1 (select .cse2 |c_ULTIMATE.start_remove_~x#1.offset|)))) (= (store |c_#memory_$Pointer$.offset| .cse0 (store (select |c_#memory_$Pointer$.offset| .cse0) .cse1 (select .cse3 |c_ULTIMATE.start_remove_~x#1.offset|))) |c_#memory_$Pointer$.offset_primed|)))))
