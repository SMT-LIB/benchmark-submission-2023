...
(assert (not (exists ((v_DerPreprocessor_11 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_12 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse0 (select (select |#memory_$Pointer$.base| |dll_insert_master_#in~dll#1.base|) |dll_insert_master_#in~dll#1.offset|))) (and (= (select v_DerPreprocessor_12 |dll_insert_master_#in~dll#1.offset|) .cse0) (= (select (store (store (store (store |#memory_$Pointer$.base| .cse0 v_DerPreprocessor_11) |dll_insert_master_#in~dll#1.base| v_DerPreprocessor_12) .cse0 v_DerPreprocessor_11) |dll_insert_master_#in~dll#1.base| v_DerPreprocessor_12) .cse0) v_DerPreprocessor_11))))))
(check-sat)
(exit)
