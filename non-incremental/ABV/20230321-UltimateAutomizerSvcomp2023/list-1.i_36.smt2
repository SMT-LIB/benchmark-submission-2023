...
(assert (let ((.cse0 (forall ((|v_ULTIMATE.start_main_~t~0#1.base_27| (_ BitVec 64))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_27|)))))) (and (not (= (_ bv0 1) (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|))) (or (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|) .cse0) (or (= |c_ULTIMATE.start_main_~p~0#1.offset| |c_ULTIMATE.start_main_~a~0#1.offset|) .cse0))))
