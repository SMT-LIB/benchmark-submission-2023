...
(declare-fun |ULTIMATE.start_probe3_6_#t~ret40#1.base| () (_ BitVec 64))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe3_6_#t~ret40#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_40 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe3_6_#t~ret40#1.base| v_ArrVal_40) |#valid|))))
(check-sat)
(exit)
