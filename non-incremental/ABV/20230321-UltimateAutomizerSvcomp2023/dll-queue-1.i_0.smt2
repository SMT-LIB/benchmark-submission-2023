...
(assert (forall ((v_ArrVal_229 (Array (_ BitVec 64) (_ BitVec 64)))) (not (= (_ bv0 64) (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~item~0#1.base| v_ArrVal_229) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)))))
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))) (and (= |c_ULTIMATE.start_main_~item~0#1.base| .cse0) (not (= (_ bv0 64) .cse0)) (not (= |c_ULTIMATE.start_main_~head~0#1.base| .cse0))))))
(check-sat)
(exit)
