...
(declare-fun |ULTIMATE.start_h5_#t~ret38#1.base| () (_ BitVec 64))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_h5_#t~ret38#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_11 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_h5_#t~ret38#1.base| v_ArrVal_11) |#valid|))))
(check-sat)
(exit)
