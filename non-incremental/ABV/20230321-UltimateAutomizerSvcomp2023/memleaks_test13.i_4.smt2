...
(assert (= (_ bv0 1) (bvadd (select |#valid| (_ bv2 64)) (_ bv1 1))))
(assert (= (_ bv2 64) |~#global_list_13~0.base|))
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (= (store |old(#valid)| |ldv_malloc_#res.base| (_ bv1 1)) |#valid|))))
(check-sat)
(exit)
