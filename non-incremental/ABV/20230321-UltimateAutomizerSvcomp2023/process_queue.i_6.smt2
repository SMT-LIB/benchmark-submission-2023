...
(declare-fun |c_ULTIMATE.start_choose_next_~node~0#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_choose_next_~node~0#1.offset| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_choose_next_~prev~0#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_choose_next_~prev~0#1.offset| () (_ BitVec 64))
...
(assert (let ((.cse1 (bvadd (_ bv8 64) |c_ULTIMATE.start_choose_next_~node~0#1.offset|)) (.cse0 (bvadd |c_ULTIMATE.start_choose_next_~prev~0#1.offset| (_ bv8 64)))) (and (= (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_choose_next_~prev~0#1.base| (store (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_choose_next_~prev~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_choose_next_~node~0#1.base|) .cse1))) |c_#memory_$Pointer$.offset_primed|) (or (not (= |c_ULTIMATE.start_choose_next_~prev~0#1.offset| (_ bv0 64))) (not (= (_ bv0 64) |c_ULTIMATE.start_choose_next_~prev~0#1.base|))) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_choose_next_~prev~0#1.base| (store (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_choose_next_~prev~0#1.base|) .cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_choose_next_~node~0#1.base|) .cse1)))) (= |c_#memory_int_primed| (store |c_#memory_int| |c_ULTIMATE.start_choose_next_~prev~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_choose_next_~prev~0#1.base|) .cse0 (select (select |c_#memory_int_primed| |c_ULTIMATE.start_choose_next_~prev~0#1.base|) .cse0)))))))
