...
(assert (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_##fun~$Pointer$~TO~VOID_#in~10#1.base|) |c_##fun~$Pointer$~TO~VOID_#in~10#1.offset|))) (and (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (bvult .cse0 |c_#StackHeapBarrier|) (exists ((v_ArrVal_698 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 64) (select (select (store |c_old(#memory_$Pointer$.base)| .cse0 v_ArrVal_698) |c_##fun~$Pointer$~TO~VOID_#in~10#1.base|) |c_##fun~$Pointer$~TO~VOID_#in~10#1.offset|))))))
