...
(assert (not (and (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= (_ bv1 32) (select (select |c_#memory_int| |c_ULTIMATE.start_main_~ptr~0#1.base|) (_ bv0 64))) (exists ((v_arrayElimIndex_4 (_ BitVec 64)) (|#StackHeapBarrier| (_ BitVec 64))) (and (bvult |c_ULTIMATE.start_main_~ptr~0#1.base| |#StackHeapBarrier|) (not (= |c_ULTIMATE.start_main_~ptr~0#1.base| v_arrayElimIndex_4)) (not (= (_ bv0 64) (bvadd |#StackHeapBarrier| (_ bv1 64)))) (bvult v_arrayElimIndex_4 |#StackHeapBarrier|))) (= (_ bv0 64) |c_ULTIMATE.start_main_~ptr~0#1.offset|))))
(check-sat)
(exit)
