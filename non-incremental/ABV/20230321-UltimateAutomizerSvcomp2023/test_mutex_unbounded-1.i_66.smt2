...
(assert (not (and (exists ((v_ArrVal_184 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_188 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_189 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store (store (store |c_#memory_$Pointer$.base| |c___ldv_list_add_#in~next.base| v_ArrVal_189) |c___ldv_list_add_#in~new.base| v_ArrVal_184) |c___ldv_list_add_#in~prev.base| v_ArrVal_188) |c_#memory_$Pointer$.base|)) (= (_ bv0 64) |c_~#drvlist~0.offset|) (= |c_~#drvlist~0.base| (_ bv4 64)) (= |c_~#mutexes~0.offset| (_ bv0 64)) (exists ((v_ArrVal_187 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_186 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_185 (Array (_ BitVec 64) (_ BitVec 64)))) (= |c_#memory_$Pointer$.offset| (store (store (store |c_#memory_$Pointer$.offset| |c___ldv_list_add_#in~next.base| v_ArrVal_185) |c___ldv_list_add_#in~new.base| v_ArrVal_186) |c___ldv_list_add_#in~prev.base| v_ArrVal_187))) (= (_ bv3 64) |c_~#mutexes~0.base|))))
(check-sat)
(exit)
