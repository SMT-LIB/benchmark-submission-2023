...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))) (and (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= |c_ULTIMATE.start_main_~#s~0#1.offset| |c_ULTIMATE.start_dll_prepend_~head#1.offset|) (= (_ bv0 64) |c_ULTIMATE.start_node_create_~temp~0#1.offset|) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (= |c_ULTIMATE.start_main_~#s~0#1.base| |c_ULTIMATE.start_dll_prepend_~head#1.base|) (not (= .cse0 |c_ULTIMATE.start_node_create_~temp~0#1.base|)) (= (_ bv1 32) (select (select |c_#memory_int| .cse0) (_ bv0 64))) (exists ((|#StackHeapBarrier| (_ BitVec 64))) (and (bvult |c_ULTIMATE.start_node_create_~temp~0#1.base| |#StackHeapBarrier|) (bvult |#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (bvult .cse0 |#StackHeapBarrier|)))))))
(check-sat)
(exit)
