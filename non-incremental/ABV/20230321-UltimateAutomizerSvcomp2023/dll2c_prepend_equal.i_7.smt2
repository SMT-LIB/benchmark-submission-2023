...
(declare-fun |c_ULTIMATE.start_dll_circular_create_#t~ret4#1.base_primed| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_dll_circular_create_#t~ret4#1.offset_primed| () (_ BitVec 64))
...
(assert (and (= |c_ULTIMATE.start_dll_circular_create_#t~ret4#1.offset_primed| |c_node_create_#res#1.offset|) (= |c_node_create_#res#1.base| |c_ULTIMATE.start_dll_circular_create_#t~ret4#1.base_primed|)))
