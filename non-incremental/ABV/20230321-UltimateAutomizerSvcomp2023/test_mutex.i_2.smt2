...
(declare-fun |c_ULTIMATE.start_foo_#t~ret31#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_foo_~m1~0#1.base| () (_ BitVec 64))
(assert (= ~unnamed0~0~P_ALL (_ bv0 32)))
(assert (= ~unnamed0~0~P_PID (_ bv1 32)))
(assert (= (_ bv2 32) ~unnamed0~0~P_PGID))
(assert (and (not (= (_ bv3 64) |c_ULTIMATE.start_foo_#t~ret31#1.base|)) (= (_ bv3 64) (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) (_ bv0 64))) (= |c_~#mutexes~0.offset| (_ bv0 64)) (= (_ bv3 64) |c_~#mutexes~0.base|) (not (= |c_ULTIMATE.start_foo_#t~ret31#1.base| |c_ULTIMATE.start_foo_~m1~0#1.base|))))
