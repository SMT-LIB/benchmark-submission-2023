...
(assert (forall ((v_ArrVal_354 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| |ULTIMATE.start_dll_create_~head~0#1.base| v_ArrVal_354) |ULTIMATE.start_dll_create_~new_head~0#1.base|) |ULTIMATE.start_dll_create_~new_head~0#1.offset|) (_ bv0 32))))
(assert (not (= (select (select |#memory_int| |ULTIMATE.start_dll_create_~head~0#1.base|) |ULTIMATE.start_dll_create_~head~0#1.offset|) (_ bv0 32))))
(check-sat)
(exit)
