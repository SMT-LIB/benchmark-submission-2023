...
(assert (not (exists ((|ldv_zalloc_#t~malloc13#1.base| (_ BitVec 64))) (and (exists ((v_ArrVal_130 (_ BitVec 1))) (= (store |c_old(#valid)| |ldv_zalloc_#t~malloc13#1.base| v_ArrVal_130) |c_#valid|)) (= (_ bv0 1) (select |c_old(#valid)| |ldv_zalloc_#t~malloc13#1.base|))))))
(check-sat)
(exit)
