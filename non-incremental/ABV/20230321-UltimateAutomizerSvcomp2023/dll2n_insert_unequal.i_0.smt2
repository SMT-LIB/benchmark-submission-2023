...
(assert (forall ((v_ArrVal_421 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_419 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_420 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |c_#memory_int| |c_ULTIMATE.start_dll_insert_~last~0#1.base| v_ArrVal_421) (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_insert_~last~0#1.base| v_ArrVal_419) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_dll_insert_~last~0#1.base| v_ArrVal_420) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) |c_ULTIMATE.start_main_~data~0#1|)))
(check-sat)
(exit)
