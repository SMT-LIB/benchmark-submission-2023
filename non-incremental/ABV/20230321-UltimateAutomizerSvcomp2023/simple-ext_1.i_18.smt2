...
(assert (let ((.cse0 (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|))) (and (= |ULTIMATE.start_main_~i~0#1| (_ bv1 32)) (= (bvadd (select |#valid| |ULTIMATE.start_main_~a~0#1.base|) (_ bv1 1)) (_ bv0 1)) (forall ((v_ArrVal_116 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.base| (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_116) |ULTIMATE.start_main_~a~0#1.base|) .cse0))) (= |ULTIMATE.start_main_~p~0#1.offset| (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~a~0#1.base|) .cse0)))))
(check-sat)
(exit)
