...
(assert (not (exists ((|ULTIMATE.start_g5_~p#1.base| (_ BitVec 64))) (and (= |c_#valid| (store |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_g5_~p#1.base| (_ bv0 1))) (= (select |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_g5_~p#1.base|) (_ bv0 1))))))
(check-sat)
(exit)
