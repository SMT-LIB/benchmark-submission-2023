...
(assert (not (and (bvult |c_node_create_#res#1.base| |c_#StackHeapBarrier|) (exists ((v_ArrVal_754 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |c_old(#memory_$Pointer$.base)| |c_node_create_#res#1.base| v_ArrVal_754) |c_#memory_$Pointer$.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= (_ bv0 1) (select |c_old(#valid)| |c_node_create_#res#1.base|)) (exists ((v_ArrVal_753 (Array (_ BitVec 64) (_ BitVec 64)))) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| |c_node_create_#res#1.base| v_ArrVal_753))))))
(check-sat)
(exit)
