...
(assert (not (or (not (= (select (select |c_#memory_$Pointer$.base| |c_~#mutexes~0.base|) |c_~#mutexes~0.offset|) |c_~#mutexes~0.base|)) (not (= |c_~#mutexes~0.offset| (select (select |c_#memory_$Pointer$.offset| |c_~#mutexes~0.base|) |c_~#mutexes~0.offset|))) (and (= c_ldv_is_in_set_~m~1.base c_ldv_is_in_set_~s.base) (= c_ldv_is_in_set_~s.offset (bvadd (_ bv8 64) c_ldv_is_in_set_~m~1.offset))) (not (= |c_ldv_is_in_set_#in~s.base| |c_~#mutexes~0.base|)) (not (= |c_ldv_is_in_set_#in~s.offset| |c_~#mutexes~0.offset|)))))
(check-sat)
(exit)
