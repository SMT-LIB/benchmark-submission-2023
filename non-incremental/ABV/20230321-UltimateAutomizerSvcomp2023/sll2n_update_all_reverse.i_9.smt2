...
(assert (forall ((v_ArrVal_246 (_ BitVec 64)) (v_ArrVal_245 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_244 (_ BitVec 64))) (= (bvmul (_ bv2 32) |ULTIMATE.start_main_~len~0#1|) (bvadd (let ((.cse0 (bvadd |ULTIMATE.start_main_~s~0#1.offset| (_ bv4 64)))) (select (select (store |#memory_int| |ULTIMATE.start_sll_update_at_~head#1.base| v_ArrVal_245) (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_sll_update_at_~head#1.base| (store (select |#memory_$Pointer$.base| |ULTIMATE.start_sll_update_at_~head#1.base|) |ULTIMATE.start_sll_update_at_~head#1.offset| v_ArrVal_246)) |ULTIMATE.start_main_~s~0#1.base|) .cse0)) (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_sll_update_at_~head#1.base| (store (select |#memory_$Pointer$.offset| |ULTIMATE.start_sll_update_at_~head#1.base|) |ULTIMATE.start_sll_update_at_~head#1.offset| v_ArrVal_244)) |ULTIMATE.start_main_~s~0#1.base|) .cse0))) (_ bv1 32)))))
(check-sat)
(exit)
