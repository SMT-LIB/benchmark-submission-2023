...
(assert (forall ((|v_ULTIMATE.start_main_~#array~1#1.base_15| (_ BitVec 64)) (v_ArrVal_269 (Array (_ BitVec 64) (_ BitVec 32)))) (or (not (let ((.cse0 (select (store |c_#memory_int| |v_ULTIMATE.start_main_~#array~1#1.base_15| v_ArrVal_269) |c_~#array~0.base|))) (bvslt (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv3 32)) (_ bv4 64)))) (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64))))))) (not (= (select |c_#valid| |v_ULTIMATE.start_main_~#array~1#1.base_15|) (_ bv0 1))))))
(assert (let ((.cse0 (select |c_#memory_int| |c_~#array~0.base|))) (bvslt (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv3 32)) (_ bv4 64)))) (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64)))))))
(check-sat)
(exit)
