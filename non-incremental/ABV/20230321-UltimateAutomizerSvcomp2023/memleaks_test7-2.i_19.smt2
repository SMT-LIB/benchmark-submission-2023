...
(declare-fun |ULTIMATE.start_disconnect_6_~a#1.base| () (_ BitVec 64))
...
(declare-fun |ULTIMATE.start_disconnect_6_~a#1.offset| () (_ BitVec 64))
(assert (= |ULTIMATE.start_disconnect_6_~a#1.base| |ULTIMATE.start_entry_point_~#a7~0#1.base|))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a7~0#1.base|)))
(assert (not (exists ((v_ArrVal_135 (_ BitVec 1)) (v_ArrVal_136 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a7~0#1.base| v_ArrVal_135)) (.cse1 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_entry_point_~#a7~0#1.base|) |ULTIMATE.start_disconnect_6_~a#1.offset|))) (and (= |#valid| (store .cse0 .cse1 v_ArrVal_136)) (= (select .cse0 .cse1) (_ bv0 1)))))))
(check-sat)
(exit)
