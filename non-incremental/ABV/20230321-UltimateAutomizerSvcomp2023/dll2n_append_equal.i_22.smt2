...
(assert (exists ((v_arrayElimCell_8 (_ BitVec 64))) (and (bvult v_arrayElimCell_8 |#StackHeapBarrier|) (not (= (_ bv0 64) v_arrayElimCell_8)))))
(assert (not (= (_ bv0 64) (bvadd |#StackHeapBarrier| (_ bv1 64)))))
(assert (not (exists ((v_ArrVal_515 (Array (_ BitVec 64) (_ BitVec 64)))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_515)))))
(check-sat)
(exit)
