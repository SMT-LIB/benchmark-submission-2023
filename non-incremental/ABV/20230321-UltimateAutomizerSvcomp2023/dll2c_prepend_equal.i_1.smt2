...
(assert (forall ((|v_node_create_~temp~0#1.base_7| (_ BitVec 64)) (v_ArrVal_244 (Array (_ BitVec 64) (_ BitVec 64)))) (or (not (= (_ bv0 64) (select (select (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_7| v_ArrVal_244) |c_ULTIMATE.start_dll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_dll_circular_prepend_~head#1.offset|))) (not (bvult |v_node_create_~temp~0#1.base_7| |c_#StackHeapBarrier|)))))
