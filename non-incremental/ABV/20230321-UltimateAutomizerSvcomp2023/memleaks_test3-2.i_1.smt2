...
(declare-fun |ULTIMATE.start_h_safe_#t~ret38#1.base| () (_ BitVec 64))
(declare-fun |ULTIMATE.start_main_old_#valid#1| () (Array (_ BitVec 64) (_ BitVec 1)))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_h_safe_#t~ret38#1.base|)))
(assert (not (exists ((v_ArrVal_13 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_h_safe_#t~ret38#1.base| v_ArrVal_13)))))
(check-sat)
(exit)
