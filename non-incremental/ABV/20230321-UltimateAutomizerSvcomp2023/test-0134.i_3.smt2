...
(assert (not (exists ((|v_ULTIMATE.start_gl_insert_~node~0#1.base_BEFORE_CALL_3| (_ BitVec 64))) (= (bvadd (_ bv1 1) (select |c_#valid| |v_ULTIMATE.start_gl_insert_~node~0#1.base_BEFORE_CALL_3|)) (_ bv0 1)))))
(check-sat)
(exit)
