...
(assert (let ((.cse0 (bvadd (_ bv8 64) |c_~#a6~0.offset|))) (and (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| |c_~#a6~0.base| (store (select |c_#memory_$Pointer$.base| |c_~#a6~0.base|) |c_~#a6~0.offset| (_ bv0 64)))) (bvule |c_~#a6~0.offset| .cse0) (= (store |c_#memory_int| |c_~#a6~0.base| (store (select |c_#memory_int| |c_~#a6~0.base|) |c_~#a6~0.offset| (select (select |c_#memory_int_primed| |c_~#a6~0.base|) |c_~#a6~0.offset|))) |c_#memory_int_primed|) (bvule .cse0 (select |c_#length| |c_~#a6~0.base|)) (= (bvadd (select |c_#valid| |c_~#a6~0.base|) (_ bv1 1)) (_ bv0 1)) (= (store |c_#memory_$Pointer$.offset| |c_~#a6~0.base| (store (select |c_#memory_$Pointer$.offset| |c_~#a6~0.base|) |c_~#a6~0.offset| (_ bv0 64))) |c_#memory_$Pointer$.offset_primed|) (bvule (_ bv0 64) |c_~#a6~0.offset|))))
