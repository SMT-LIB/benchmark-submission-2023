...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))) (and (not (= .cse0 |c_ULTIMATE.start_main_~head~0#1.base|)) (= (select (select |c_#memory_int_primed| .cse0) (_ bv8 64)) (_ bv0 32)) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))))))
(check-sat)
(exit)
