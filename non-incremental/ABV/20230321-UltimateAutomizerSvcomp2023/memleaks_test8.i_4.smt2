...
(assert (not (exists ((~a8~0.base (_ BitVec 64))) (and (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| ~a8~0.base (_ bv0 1))) (= (select |ULTIMATE.start_main_old_#valid#1| ~a8~0.base) (_ bv0 1))))))
(check-sat)
(exit)
