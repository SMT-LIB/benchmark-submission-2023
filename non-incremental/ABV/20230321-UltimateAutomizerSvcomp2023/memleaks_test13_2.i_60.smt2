...
(assert (and (= (_ bv16 64) (select |c_#length| (_ bv2 64))) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| (_ bv2 64)) (_ bv0 64))) (= (_ bv0 64) |c_~#global_list_13~0.offset|) (= |c_~#global_list_13~0.base| (_ bv2 64)) (= (_ bv2 64) (select (select |c_#memory_$Pointer$.base| (_ bv2 64)) (_ bv0 64)))))
