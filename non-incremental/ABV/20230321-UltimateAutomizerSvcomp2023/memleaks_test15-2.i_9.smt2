...
(assert (not (exists ((|ULTIMATE.start_entry_point_~hdev~0#1.base| (_ BitVec 64))) (and (= (_ bv0 1) (select |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~hdev~0#1.base|)) (= (store |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~hdev~0#1.base| (_ bv0 1)) |c_#valid|)))))
(check-sat)
(exit)
