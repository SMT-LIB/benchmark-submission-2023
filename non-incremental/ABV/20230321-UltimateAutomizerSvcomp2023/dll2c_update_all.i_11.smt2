...
(assert (not (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~s~0#1.base|) (bvadd |c_ULTIMATE.start_main_~s~0#1.offset| (_ bv16 64))) |c_ULTIMATE.start_main_~len~0#1|)))
(check-sat)
(exit)
