...
(assert (forall ((v_ArrVal_99 (_ BitVec 32)) (|v_ULTIMATE.start_main_~end~0#1.base_27| (_ BitVec 64)) (v_ArrVal_104 (Array (_ BitVec 64) (_ BitVec 32))) (v_arrayElimArr_2 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_105 (_ BitVec 64))) (or (not (= (select v_arrayElimArr_2 (_ bv8 64)) (_ bv1 32))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~end~0#1.base_27|))) (= (select (select (store (store (store |c_#memory_int| |c_ULTIMATE.start_main_~end~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~end~0#1.base|) |c_ULTIMATE.start_main_~end~0#1.offset| v_ArrVal_99)) |v_ULTIMATE.start_main_~end~0#1.base_27| v_ArrVal_104) v_ArrVal_105 v_arrayElimArr_2) |c_ULTIMATE.start_main_~list~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~list~0#1.offset|)) (_ bv1 32)))))
(check-sat)
(exit)
