...
(assert (let ((.cse0 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (_ bv0 64)))) (and (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (not (= .cse0 (_ bv0 64))) (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier|) (= (_ bv0 64) |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier|) (= |c_ULTIMATE.start_main_~#p1~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier|) (= .cse0 (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (_ bv0 64))) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|))))
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (let ((.cse1 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (_ bv0 64)))) (let ((.cse0 (not (= .cse1 (_ bv0 64))))) (or (and .cse0 (exists ((v_DerPreprocessor_9 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_8 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= .cse1 (select v_DerPreprocessor_9 (_ bv0 64))) (= (select (store (store (store (store |c_#memory_$Pointer$.base| .cse1 v_DerPreprocessor_8) |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| v_DerPreprocessor_9) .cse1 v_DerPreprocessor_8) |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| v_DerPreprocessor_9) .cse1) (select |c_#memory_$Pointer$.base| .cse1))))) (and .cse0 (= .cse1 |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|))))) (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier|) (= (_ bv0 64) |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier|) (= |c_ULTIMATE.start_main_~#p1~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier|) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|))))
(check-sat)
(exit)
