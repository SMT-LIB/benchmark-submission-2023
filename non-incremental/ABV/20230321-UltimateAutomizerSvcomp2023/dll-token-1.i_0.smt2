...
(assert (let ((.cse0 (bvadd |c_ULTIMATE.start_main_~head~0#1.offset| (_ bv16 64)))) (and (forall ((v_ArrVal_1040 (_ BitVec 64))) (or (forall ((v_ArrVal_1031 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_1035 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_1035) v_ArrVal_1040 v_ArrVal_1031) |c_ULTIMATE.start_main_~head~0#1.base|) .cse0) (_ bv0 32))) (not (= (_ bv0 1) (select |c_#valid| v_ArrVal_1040))))) (or (forall ((v_ArrVal_1031 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_1031) |c_ULTIMATE.start_main_~head~0#1.base|) .cse0) (_ bv0 32))) (not (= (select |c_#valid| |c_ULTIMATE.start_main_~x~0#1.base|) (_ bv0 1)))))))
