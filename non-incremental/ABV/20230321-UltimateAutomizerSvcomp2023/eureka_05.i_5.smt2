...
(assert (not (let ((.cse0 (select |c_#memory_int| (_ bv3 64)))) (and (= (_ bv0 64) |c_~#array~0.offset|) (= (select .cse0 (_ bv4 64)) (_ bv0 32)) (= (_ bv3 64) |c_~#array~0.base|) (not (= (_ bv3 64) |c_ULTIMATE.start_main_~#array~1#1.base|)) (= (select .cse0 (_ bv0 64)) (_ bv0 32)) (= |c_ULTIMATE.start_main_~i~1#1| (_ bv0 32))))))
(check-sat)
(exit)
