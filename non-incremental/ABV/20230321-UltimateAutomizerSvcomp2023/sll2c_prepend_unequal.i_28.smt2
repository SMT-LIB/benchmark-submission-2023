...
(assert (forall ((|v_node_create_~temp~0#1.base_13| (_ BitVec 64)) (v_ArrVal_335 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_334 (Array (_ BitVec 64) (_ BitVec 64)))) (or (not (bvult |v_node_create_~temp~0#1.base_13| |c_#StackHeapBarrier|)) (not (let ((.cse1 (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_13| v_ArrVal_335))) (let ((.cse0 (select (select .cse1 |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|))) (= .cse0 (select (select .cse1 .cse0) (select (select (store |c_#memory_$Pointer$.offset| |v_node_create_~temp~0#1.base_13| v_ArrVal_334) |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|)))))) (not (= (select |c_#valid| |v_node_create_~temp~0#1.base_13|) (_ bv0 1))))))
(assert (not (and (exists ((v_ArrVal_328 (Array (_ BitVec 64) (_ BitVec 64))) (|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_329 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.offset)| |node_create_~temp~0#1.base| v_ArrVal_328) |c_#memory_$Pointer$.offset|) (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_329) |c_#memory_$Pointer$.base|) (= (select |c_old(#valid)| |node_create_~temp~0#1.base|) (_ bv0 1)) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))))))
(check-sat)
(exit)
