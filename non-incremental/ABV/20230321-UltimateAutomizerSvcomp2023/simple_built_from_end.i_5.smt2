...
(assert (forall ((|ULTIMATE.start_main_~t~0#1.base| (_ BitVec 64)) (v_ArrVal_65 (Array (_ BitVec 64) (_ BitVec 32)))) (or (= (select (select (store |c_#memory_int| |ULTIMATE.start_main_~t~0#1.base| v_ArrVal_65) |c_ULTIMATE.start_main_~p~0#1.base|) |c_ULTIMATE.start_main_~p~0#1.offset|) (_ bv1 32)) (not (= (select v_ArrVal_65 (_ bv0 64)) (_ bv1 32))))))
(assert (not (and (= |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv0 64)) (= (_ bv1 32) (select (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (_ bv0 64))) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~p~0#1.base|) (_ bv4 64))) (= (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~p~0#1.base|) (_ bv4 64))) (_ bv0 64)) (_ bv1 32)))))
(check-sat)
(exit)
