...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~pp1#1.offset_Hier|) (= (_ bv0 64) |c_ULTIMATE.start_create_sll_~#list~0#1.offset_Hier|) (= (_ bv0 64) |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier|) (exists ((v_DerPreprocessor_3 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_2 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse0 (select v_DerPreprocessor_3 (_ bv0 64)))) (let ((.cse1 (select (store (store (store (store |c_#memory_$Pointer$.base| .cse0 v_DerPreprocessor_2) |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| v_DerPreprocessor_3) .cse0 v_DerPreprocessor_2) |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier| v_DerPreprocessor_3) .cse0))) (and (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_create_sll_~#list~0#1.base_Hier|) (_ bv0 64)) .cse0) (not (= .cse0 (_ bv0 64))) (= .cse1 (select |c_#memory_$Pointer$.base| .cse0)) (= v_DerPreprocessor_2 .cse1))))) (= |c_ULTIMATE.start_main_~#p1~0#1.base_Hier| |c_ULTIMATE.start_create_sll_~pp1#1.base_Hier|) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|))))
(check-sat)
(exit)
