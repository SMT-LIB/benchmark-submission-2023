...
(assert (not (exists ((v_ArrVal_2749 (_ BitVec 64)) (v_ArrVal_3042 (_ BitVec 64))) (= (store |c_old(#memory_$Pointer$.offset)| |c_LDV_INIT_LIST_HEAD_#in~list.base| (store (store (select |c_old(#memory_$Pointer$.offset)| |c_LDV_INIT_LIST_HEAD_#in~list.base|) |c_LDV_INIT_LIST_HEAD_#in~list.offset| v_ArrVal_2749) (bvadd (_ bv8 64) |c_LDV_INIT_LIST_HEAD_#in~list.offset|) v_ArrVal_3042)) |c_#memory_$Pointer$.offset|))))
(check-sat)
(exit)
