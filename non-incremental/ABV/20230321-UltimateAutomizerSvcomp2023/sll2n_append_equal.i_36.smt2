...
(assert (forall ((v_ArrVal_518 (_ BitVec 32)) (v_ArrVal_529 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_528 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_517 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_516 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_527 (Array (_ BitVec 64) (_ BitVec 32))) (|v_node_create_~temp~0#1.base_25| (_ BitVec 64))) (or (= |c_ULTIMATE.start_main_~data~0#1| (let ((.cse3 (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_25| v_ArrVal_528))) (let ((.cse2 (store |c_#memory_$Pointer$.offset| |v_node_create_~temp~0#1.base_25| v_ArrVal_529)) (.cse1 (select (select .cse3 |c_ULTIMATE.start_sll_append_~head#1.base|) |c_ULTIMATE.start_sll_append_~head#1.offset|))) (select (select (let ((.cse0 (store |c_#memory_int| |v_node_create_~temp~0#1.base_25| v_ArrVal_527))) (store .cse0 .cse1 (store (select .cse0 .cse1) (bvadd (select (select .cse2 |c_ULTIMATE.start_sll_append_~head#1.base|) |c_ULTIMATE.start_sll_append_~head#1.offset|) (_ bv4 64)) v_ArrVal_518))) (select (select (store .cse3 .cse1 v_ArrVal_516) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|)) (select (select (store .cse2 .cse1 v_ArrVal_517) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))))) (not (= (_ bv0 1) (select |c_#valid| |v_node_create_~temp~0#1.base_25|))) (not (bvult |v_node_create_~temp~0#1.base_25| |c_#StackHeapBarrier|)))))
(check-sat)
(exit)
