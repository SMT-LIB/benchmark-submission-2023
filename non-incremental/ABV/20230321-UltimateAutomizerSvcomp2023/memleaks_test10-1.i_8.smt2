...
(assert (not (exists ((|ULTIMATE.start_entry_point_~a10~0#1.base| (_ BitVec 64))) (and (= (store |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~a10~0#1.base| (_ bv0 1)) |c_#valid|) (= (select |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~a10~0#1.base|) (_ bv0 1))))))
(check-sat)
(exit)
