...
(assert (and (exists ((v_ArrVal_506 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |c_old(#memory_$Pointer$.offset)| |c_#Ultimate.C_memcpy_dest.base| v_ArrVal_506) |c_#memory_$Pointer$.offset|)) (= (_ bv3 64) |c_~#a~0.base|) (= (_ bv0 64) |c_~#a~0.offset|)))
