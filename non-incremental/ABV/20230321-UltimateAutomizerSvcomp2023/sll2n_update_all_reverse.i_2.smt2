...
(declare-fun |c_ULTIMATE.start_sll_get_data_at_#res#1| () (_ BitVec 32))
...
(assert (not (and (= |c_ULTIMATE.start_main_~expected~0#1| (_ bv3 32)) (= (_ bv3 32) |c_ULTIMATE.start_sll_get_data_at_#res#1|))))
(check-sat)
(exit)
