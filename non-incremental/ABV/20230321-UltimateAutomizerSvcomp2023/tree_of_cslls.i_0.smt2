...
(declare-fun |c_ULTIMATE.start_main_#t~mem11#1.base| () (_ BitVec 64))
...
(assert (forall ((v_ArrVal_437 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_#t~mem11#1.base| v_ArrVal_437) |c_ULTIMATE.start_main_~tree~0#1.base|) (bvadd |c_ULTIMATE.start_main_~tree~0#1.offset| (_ bv16 64)))) (_ bv1 1)))))
(check-sat)
(exit)
