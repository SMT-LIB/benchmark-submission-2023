...
(assert (not (or (forall ((v_arrayElimCell_49 (_ BitVec 64))) (not (= (_ bv0 1) (select (store |#valid| |ULTIMATE.start_main_~head~0#1.base| (_ bv1 1)) v_arrayElimCell_49)))) (= (_ bv0 64) |ULTIMATE.start_main_~head~0#1.base|) (not (= (_ bv0 1) (select |#valid| |ULTIMATE.start_main_~head~0#1.base|))))))
(check-sat)
(exit)
