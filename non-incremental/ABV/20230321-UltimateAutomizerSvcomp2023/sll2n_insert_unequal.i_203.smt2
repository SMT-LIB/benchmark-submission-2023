...
(assert (exists ((v_arrayElimCell_45 (_ BitVec 64))) (and (bvult v_arrayElimCell_45 |#StackHeapBarrier|) (not (= (_ bv0 64) v_arrayElimCell_45)))))
(assert (bvult |node_create_#res#1.base| |#StackHeapBarrier|))
(assert (not (= (_ bv0 64) (bvadd |#StackHeapBarrier| (_ bv1 64)))))
(assert (not (exists ((v_ArrVal_532 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_532) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
