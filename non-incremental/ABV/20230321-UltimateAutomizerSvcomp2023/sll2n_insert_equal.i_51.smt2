...
(declare-fun |c_aux_v_#memory_int_18| () (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 32))))
(assert (let ((.cse1 (select |c_aux_v_#memory_int_18| |c_node_create_~temp~0#1.base|)) (.cse0 (bvadd |c_node_create_~temp~0#1.offset| (_ bv4 64)))) (and (= (store |c_#memory_$Pointer$.offset| |c_node_create_~temp~0#1.base| (store (store (select |c_#memory_$Pointer$.offset| |c_node_create_~temp~0#1.base|) .cse0 (_ bv0 64)) |c_node_create_~temp~0#1.offset| (select (select |c_#memory_$Pointer$.offset_primed| |c_node_create_~temp~0#1.base|) |c_node_create_~temp~0#1.offset|))) |c_#memory_$Pointer$.offset_primed|) (= (store |c_#memory_int| |c_node_create_~temp~0#1.base| (store (select |c_#memory_int| |c_node_create_~temp~0#1.base|) .cse0 (select .cse1 .cse0))) |c_aux_v_#memory_int_18|) (= (store |c_aux_v_#memory_int_18| |c_node_create_~temp~0#1.base| (store .cse1 |c_node_create_~temp~0#1.offset| |c_node_create_~data#1|)) |c_#memory_int_primed|) (= |c_node_create_~temp~0#1.offset| |c_node_create_#res#1.offset_primed|) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| |c_node_create_~temp~0#1.base| (store (store (select |c_#memory_$Pointer$.base| |c_node_create_~temp~0#1.base|) .cse0 (_ bv0 64)) |c_node_create_~temp~0#1.offset| (select (select |c_#memory_$Pointer$.base_primed| |c_node_create_~temp~0#1.base|) |c_node_create_~temp~0#1.offset|)))) (= |c_node_create_~temp~0#1.base| |c_node_create_#res#1.base_primed|))))
(assert (and (not (= (_ bv0 64) |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (bvult |c_node_create_~temp~0#1.base| |c_#StackHeapBarrier|)))
(assert (not (and (exists ((v_arrayElimCell_1 (_ BitVec 64))) (and (not (= (_ bv0 64) v_arrayElimCell_1)) (bvult v_arrayElimCell_1 |c_#StackHeapBarrier|))) (exists ((v_ArrVal_222 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |c_old(#memory_$Pointer$.base)| |c_node_create_#res#1.base_primed| v_ArrVal_222) |c_#memory_$Pointer$.base_primed|)) (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))) (bvult |c_node_create_#res#1.base_primed| |c_#StackHeapBarrier|))))
(check-sat)
(exit)
