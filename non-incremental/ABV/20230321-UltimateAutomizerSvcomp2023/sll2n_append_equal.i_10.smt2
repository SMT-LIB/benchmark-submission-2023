...
(assert (and (not (= (_ bv0 64) |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) |c_node_create_#res#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_194 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_194) |c_#memory_$Pointer$.base|) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|)))))
...
(assert (not (and (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))) (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_194 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)_Hier| |node_create_~temp~0#1.base| v_ArrVal_194)) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))))))
(check-sat)
(exit)
