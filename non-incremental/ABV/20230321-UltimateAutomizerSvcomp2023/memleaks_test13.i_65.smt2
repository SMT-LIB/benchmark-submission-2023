...
(assert (not (and (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_6 (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_6)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))) (= (_ bv0 64) |c_~#global_list_13~0.offset|) (= |c_~#global_list_13~0.base| (_ bv2 64)))))
(check-sat)
(exit)
