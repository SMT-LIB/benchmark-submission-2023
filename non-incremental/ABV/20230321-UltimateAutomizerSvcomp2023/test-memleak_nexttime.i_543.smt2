...
(assert (and (= (bvadd (select |c_#valid| (_ bv3 64)) (_ bv1 1)) (_ bv0 1)) (exists ((|v_ULTIMATE.start_foo_~#p~0#1.base_10| (_ BitVec 64))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |v_ULTIMATE.start_foo_~#p~0#1.base_10|) (_ bv0 64)))) (and (not (= (_ bv3 64) |v_ULTIMATE.start_foo_~#p~0#1.base_10|)) (bvult .cse0 |c_#StackHeapBarrier|) (= (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) (_ bv0 64)) .cse0)))) (= (_ bv3 64) |c_~#a~0.base|) (= (_ bv0 64) |c_~#a~0.offset|)))
