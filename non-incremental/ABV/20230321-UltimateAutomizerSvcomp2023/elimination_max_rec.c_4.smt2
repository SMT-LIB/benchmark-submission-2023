...
(declare-fun c_check_~i~0 () (_ BitVec 32))
...
(assert (not (let ((.cse0 (select |c_#memory_int| c_check_~a.base))) (bvsle (select .cse0 (bvadd (bvmul (_ bv4 64) ((_ sign_extend 32) c_check_~i~0)) c_check_~a.offset)) (select .cse0 (bvadd (bvmul ((_ sign_extend 32) c_check_~x1~0) (_ bv4 64)) c_check_~a.offset))))))
(check-sat)
(exit)
