...
(assert (forall ((v_ArrVal_245 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_243 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_244 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 32) (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_245) (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_243) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)) (bvadd (_ bv8 64) (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_244) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))))))
(check-sat)
(exit)
