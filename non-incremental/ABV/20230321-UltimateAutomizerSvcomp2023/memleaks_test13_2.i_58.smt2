...
(assert (and (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| (_ bv2 64)) (_ bv0 64))) (= (_ bv0 64) |c_~#global_list_13~0.offset|) (= |c_old(#length)| |c_#length|) (= |c_~#global_list_13~0.base| (_ bv2 64)) (= (_ bv2 64) (select (select |c_#memory_$Pointer$.base| (_ bv2 64)) (_ bv0 64))) (= |c_old(#valid)| |c_#valid|)))
(assert (not (and (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| (_ bv2 64)) (_ bv0 64))) (= (_ bv0 64) |c_~#global_list_13~0.offset|) (= |c_~#global_list_13~0.base| (_ bv2 64)) (= (_ bv2 64) (select (select |c_#memory_$Pointer$.base| (_ bv2 64)) (_ bv0 64))) (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_11 (_ BitVec 64))) (and (= (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_11) |c_#length|) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))))))
(check-sat)
(exit)
