...
(assert (not (and (= |c_~#drvlist~0.base| (_ bv4 64)) (= (_ bv3 64) |c_~#mutexes~0.base|) (= (_ bv4 64) (select (select |c_#memory_$Pointer$.base| (_ bv4 64)) |c_~#drvlist~0.offset|)) (= (select (select |c_#memory_$Pointer$.offset| (_ bv3 64)) |c_~#mutexes~0.offset|) |c_~#mutexes~0.offset|) (= (_ bv3 64) (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) |c_~#mutexes~0.offset|)) (= (select |c_old(#valid)| |c_ldv_successful_malloc_#res#1.base|) (_ bv0 1)))))
(check-sat)
(exit)
