...
(assert (and (= |c_~#pstate~0.base| (_ bv5 64)) (= |c_~#pp~0.base| (_ bv4 64)) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (= |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|)))
(assert (and (= |c_~#pp~0.base| (_ bv4 64)) (= |c_~#pstate~0.base| (_ bv5 64))))
...
(assert (not (let ((.cse0 (select |c_old(#memory_$Pointer$.offset)_Hier| (_ bv4 64)))) (and (= |c_~#pp~0.base| (_ bv4 64)) (exists ((v_ArrVal_767 (Array (_ BitVec 64) (_ BitVec 64))) (f_~pointer.offset (_ BitVec 64))) (= |c_#memory_$Pointer$.offset| (store (store |c_old(#memory_$Pointer$.offset)_Hier| (_ bv4 64) (store .cse0 (bvadd |c_~#pp~0.offset| (bvmul (_ bv8 64) ((_ sign_extend 32) (_ bv1 32)))) f_~pointer.offset)) (_ bv5 64) v_ArrVal_767))) (let ((.cse1 (bvadd |c_~#pp~0.offset| (bvmul (_ bv8 64) ((_ sign_extend 32) (_ bv0 32)))))) (or (not (= (_ bv0 64) (select .cse0 .cse1))) (not (= (_ bv0 64) (select (select |c_old(#memory_$Pointer$.base)_Hier| (_ bv4 64)) .cse1))))) (= |c_~#pstate~0.base| (_ bv5 64))))))
(check-sat)
(exit)
