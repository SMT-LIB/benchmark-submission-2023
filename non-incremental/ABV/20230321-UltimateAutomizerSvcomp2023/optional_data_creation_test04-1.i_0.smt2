...
(assert (forall ((v_ArrVal_307 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_create_data_#t~mem8#1.base| v_ArrVal_307) |c_ULTIMATE.start_create_data_~data~0#1.base|) (bvadd |c_ULTIMATE.start_create_data_~data~0#1.offset| (_ bv4 64)))) (_ bv1 1)))))
(check-sat)
(exit)
