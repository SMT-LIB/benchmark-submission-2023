...
(assert (not (exists ((|v_ULTIMATE.start_main_~#iter~0#1.base_53| (_ BitVec 64))) (and (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |v_ULTIMATE.start_main_~#iter~0#1.base_53|)) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |v_ULTIMATE.start_main_~#iter~0#1.base_53| (_ bv0 1)))))))
(check-sat)
(exit)
