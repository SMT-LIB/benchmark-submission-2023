...
(assert (not (let ((.cse1 (bvadd |c_ULTIMATE.start_main_~tree~0#1.offset| (_ bv16 64)))) (let ((.cse2 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~tree~0#1.base|) .cse1))) (let ((.cse0 (bvadd (_ bv8 64) .cse2))) (and (bvule .cse0 (select |c_#length| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~tree~0#1.base|) .cse1))) (bvule .cse2 .cse0)))))))
(check-sat)
(exit)
