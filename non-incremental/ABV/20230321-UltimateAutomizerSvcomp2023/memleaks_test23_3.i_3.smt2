...
(assert (not (= (_ bv0 64) |ldv_zalloc_#t~malloc13#1.base|)))
...
(assert (not (exists ((v_ArrVal_389 (_ BitVec 1))) (= |#valid| (store |old(#valid)| |ldv_zalloc_#t~malloc13#1.base| v_ArrVal_389)))))
(check-sat)
(exit)
