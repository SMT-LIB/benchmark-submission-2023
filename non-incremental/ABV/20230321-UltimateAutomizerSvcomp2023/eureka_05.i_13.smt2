...
(assert (let ((.cse0 (select |c_#memory_int| |c_~#array~0.base|))) (bvslt (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv1 32)) (_ bv4 64)))) (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64)))))))
(check-sat)
(exit)
