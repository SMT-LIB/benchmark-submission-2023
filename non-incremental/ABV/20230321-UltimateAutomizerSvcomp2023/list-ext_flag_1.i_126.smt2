...
(assert (forall ((v_ArrVal_354 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_352 (Array (_ BitVec 64) (_ BitVec 32))) (|v_ULTIMATE.start_main_~t~0#1.base_18| (_ BitVec 64)) (v_ArrVal_346 (_ BitVec 32))) (or (not (= (select (select (store (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv8 64)) v_ArrVal_346)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_352) |v_ULTIMATE.start_main_~t~0#1.base_18| v_ArrVal_354) |c_ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|)) (_ bv0 32))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_18|))))))
