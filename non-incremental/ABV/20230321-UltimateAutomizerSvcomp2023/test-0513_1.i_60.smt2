...
(assert (or (not (= |c_ULTIMATE.start_main_~data~0#1.base| (_ bv0 64))) (not (= (_ bv0 64) |c_ULTIMATE.start_main_~data~0#1.offset|))))
...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~data~0#1.base|) (_ bv8 64)))) (and (= (_ bv6 32) (select (select |c_#memory_int| .cse0) (_ bv8 64))) (not (= .cse0 |c_ULTIMATE.start_main_~data~0#1.base|)) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~data~0#1.base|) (_ bv8 64))) (= (_ bv0 64) |c_ULTIMATE.start_main_~data~0#1.offset|)))))
(check-sat)
(exit)
