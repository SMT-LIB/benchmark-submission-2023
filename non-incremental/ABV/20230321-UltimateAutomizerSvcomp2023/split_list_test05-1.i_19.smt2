...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| c_append_~head.base) (bvadd (_ bv8 64) c_append_~head.offset)))) (and (= (_ bv0 1) (bvadd (select |c_#valid| .cse0) (_ bv1 1))) (not (= .cse0 c_append_~head.base)) (= (bvadd (select |c_#valid| c_append_~head.base) (_ bv1 1)) (_ bv0 1)) (exists ((append_~node~0.base (_ BitVec 64))) (and (not (= c_append_~head.base append_~node~0.base)) (= (bvadd (select |c_#valid| append_~node~0.base) (_ bv1 1)) (_ bv0 1)) (not (= .cse0 append_~node~0.base))))))))
(check-sat)
(exit)
