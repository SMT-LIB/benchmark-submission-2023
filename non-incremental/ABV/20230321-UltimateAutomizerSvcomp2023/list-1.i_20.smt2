...
(assert (forall ((v_ArrVal_236 (_ BitVec 64)) (v_ArrVal_234 (Array (_ BitVec 64) (_ BitVec 32)))) (let ((.cse0 (select (select (let ((.cse1 (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| v_ArrVal_234))) (store .cse1 v_ArrVal_236 (store (select .cse1 v_ArrVal_236) |c_ULTIMATE.start_main_~t~0#1.offset| (_ bv3 32)))) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|))) (or (= .cse0 (_ bv3 32)) (= .cse0 (_ bv1 32))))))
(check-sat)
(exit)
