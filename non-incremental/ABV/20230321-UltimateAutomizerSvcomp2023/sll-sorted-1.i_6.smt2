...
(assert (forall ((v_ArrVal_111 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~x~0#1.base| (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~x~0#1.base| v_ArrVal_111) |ULTIMATE.start_main_~head~0#1.base|) |ULTIMATE.start_main_~head~0#1.offset|))))
(assert (not (forall ((v_ArrVal_108 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~x~0#1.offset| (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~x~0#1.base| v_ArrVal_108) |ULTIMATE.start_main_~head~0#1.base|) |ULTIMATE.start_main_~head~0#1.offset|)))))
(check-sat)
(exit)
