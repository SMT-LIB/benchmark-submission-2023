...
(declare-fun |c_ULTIMATE.start_re_insert_#t~mem9#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_re_insert_#t~mem9#1.offset| () (_ BitVec 64))
...
(assert (let ((.cse2 (bvadd (_ bv8 64) |c_ULTIMATE.start_re_insert_~x#1.offset|))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_re_insert_~x#1.base|) .cse2)) (.cse1 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_re_insert_~x#1.base|) .cse2))) (and (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| .cse0 (store (select |c_#memory_$Pointer$.base| .cse0) .cse1 |c_ULTIMATE.start_re_insert_~x#1.base|))) (= |c_#memory_int_primed| (store |c_#memory_int| .cse0 (store (select |c_#memory_int| .cse0) .cse1 (select (select |c_#memory_int_primed| .cse0) .cse1)))) (= |c_#memory_$Pointer$.offset_primed| (store |c_#memory_$Pointer$.offset| .cse0 (store (select |c_#memory_$Pointer$.offset| .cse0) .cse1 |c_ULTIMATE.start_re_insert_~x#1.offset|))) (or (not (= (_ bv0 64) |c_ULTIMATE.start_re_insert_#t~mem9#1.offset|)) (not (= (_ bv0 64) |c_ULTIMATE.start_re_insert_#t~mem9#1.base|)))))))
