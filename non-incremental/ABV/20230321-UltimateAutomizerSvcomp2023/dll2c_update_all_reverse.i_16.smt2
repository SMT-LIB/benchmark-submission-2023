...
(assert (let ((.cse0 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|))) (and (forall ((v_ArrVal_414 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|) (select (select (store |#memory_$Pointer$.offset| .cse0 v_ArrVal_414) |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|))) (= |ULTIMATE.start_main_~len~0#1| (bvadd |ULTIMATE.start_main_~i~0#1| (_ bv1 32))) (forall ((v_ArrVal_412 (Array (_ BitVec 64) (_ BitVec 64)))) (not (= (select (select (store |#memory_$Pointer$.base| .cse0 v_ArrVal_412) |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|) |ULTIMATE.start_main_~s~0#1.base|))))))
(check-sat)
(exit)
