...
(assert (= (select |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |~#a6~0.base|) |~#a6~0.offset|)) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_130 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |~#a6~0.base|) |~#a6~0.offset|) v_ArrVal_130)))))
(check-sat)
(exit)
