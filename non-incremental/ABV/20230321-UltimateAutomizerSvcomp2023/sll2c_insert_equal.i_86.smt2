...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (exists ((|ULTIMATE.start_sll_circular_create_~last~0#1.base| (_ BitVec 64))) (and (not (= |ULTIMATE.start_sll_circular_create_~last~0#1.base| |c_ULTIMATE.start_sll_circular_create_#res#1.base|)) (= (_ bv0 1) (bvadd (select |c_#valid| |ULTIMATE.start_sll_circular_create_~last~0#1.base|) (_ bv1 1))))) (= (bvadd (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) (_ bv1 1)) (_ bv0 1)) (bvult |c_ULTIMATE.start_sll_circular_create_#res#1.base| |c_#StackHeapBarrier|) (= (_ bv0 64) |c_ULTIMATE.start_sll_circular_create_#res#1.offset|) (= (_ bv1 32) (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_create_#res#1.base|) (_ bv8 64))) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|))))
(check-sat)
(exit)
