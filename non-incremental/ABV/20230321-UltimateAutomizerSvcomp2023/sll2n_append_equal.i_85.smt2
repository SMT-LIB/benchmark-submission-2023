...
(assert (and (= |c_#memory_int| |c_old(#memory_int)|) (= (_ bv0 64) |c_node_create_~temp~0#1.offset|) (= |c_#valid| (store |c_old(#valid)| |c_node_create_~temp~0#1.base| (_ bv1 1))) (= (_ bv0 1) (select |c_old(#valid)| |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_node_create_~temp~0#1.base|) (_ bv1 1))) (= |c_node_create_#in~data#1| |c_node_create_~data#1|) (bvult |c_node_create_~temp~0#1.base| |c_#StackHeapBarrier|) (not (= (_ bv0 64) |c_#StackHeapBarrier|)) (= |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|)))
(assert (not (and (exists ((v_ArrVal_657 (Array (_ BitVec 64) (_ BitVec 64))) (|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_655 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_658 (Array (_ BitVec 64) (_ BitVec 32)))) (and (= (store |c_old(#memory_int)| |node_create_~temp~0#1.base| v_ArrVal_658) |c_#memory_int|) (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_657) |c_#memory_$Pointer$.base|) (= (store |c_old(#memory_$Pointer$.offset)| |node_create_~temp~0#1.base| v_ArrVal_655) |c_#memory_$Pointer$.offset|) (= (select |c_old(#valid)| |node_create_~temp~0#1.base|) (_ bv0 1)) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))))))
(check-sat)
(exit)
