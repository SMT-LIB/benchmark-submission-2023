...
(assert (not (exists ((|zalloc_or_die_calloc_model_~ptr~0#1.base| (_ BitVec 64))) (and (= (_ bv0 1) (select |c_old(#valid)| |zalloc_or_die_calloc_model_~ptr~0#1.base|)) (exists ((v_ArrVal_1239 (_ BitVec 1))) (= |c_#valid| (store |c_old(#valid)| |zalloc_or_die_calloc_model_~ptr~0#1.base| v_ArrVal_1239)))))))
(check-sat)
(exit)
