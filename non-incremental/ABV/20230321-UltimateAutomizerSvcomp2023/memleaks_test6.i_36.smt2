...
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_disconnect_6_~a#1.base|) |ULTIMATE.start_disconnect_6_~a#1.offset|))))
(assert (not (exists ((v_ArrVal_130 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_disconnect_6_~a#1.base|) |ULTIMATE.start_disconnect_6_~a#1.offset|) v_ArrVal_130)))))
(check-sat)
(exit)
