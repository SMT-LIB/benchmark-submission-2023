...
(declare-fun |~#a6~0.offset| () (_ BitVec 64))
(declare-fun |ULTIMATE.start_probe1_6_#t~ret40#1.base| () (_ BitVec 64))
(declare-fun |~#a6~0.base| () (_ BitVec 64))
...
(assert (= |ULTIMATE.start_probe1_6_~a#1.offset| |~#a6~0.offset|))
(assert (= |~#a6~0.base| |ULTIMATE.start_probe1_6_~a#1.base|))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe1_6_#t~ret40#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_130 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe1_6_#t~ret40#1.base| v_ArrVal_130)))))
(check-sat)
(exit)
