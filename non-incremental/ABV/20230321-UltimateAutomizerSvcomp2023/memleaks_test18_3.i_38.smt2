...
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (and (exists ((v_ArrVal_450 (_ BitVec 1))) (= |c_#valid| (store |c_old(#valid)| |ldv_malloc_#res.base| v_ArrVal_450))) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)) (exists ((v_ArrVal_451 (_ BitVec 64))) (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_451)))))))
(check-sat)
(exit)
