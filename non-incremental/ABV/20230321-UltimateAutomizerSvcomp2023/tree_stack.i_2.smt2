...
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) (_ bv8 64)))))
(assert (not (exists ((v_ArrVal_629 (_ BitVec 1)) (v_ArrVal_628 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) (_ bv8 64)) v_ArrVal_628))) (and (= (_ bv0 1) (select .cse0 |ULTIMATE.start_main_~s~0#1.base|)) (= (store .cse0 |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_629) |#valid|))))))
(check-sat)
(exit)
