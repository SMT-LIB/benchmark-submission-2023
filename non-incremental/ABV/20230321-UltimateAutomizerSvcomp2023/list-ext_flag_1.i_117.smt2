...
(assert (forall ((v_ArrVal_282 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_282) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv8 64) |ULTIMATE.start_main_~a~0#1.offset|)) |ULTIMATE.start_main_~p~0#1.base|)))
(assert (not (forall ((v_ArrVal_281 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.offset| (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_281) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv8 64) |ULTIMATE.start_main_~a~0#1.offset|))))))
(check-sat)
(exit)
