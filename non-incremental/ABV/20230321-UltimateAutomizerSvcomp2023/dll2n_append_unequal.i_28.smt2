...
(assert (and (bvult |c_node_create_#res#1.base| |c_#StackHeapBarrier|) (= (_ bv0 64) |c_node_create_#res#1.offset|) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= (_ bv0 1) (select |c_old(#valid)| |c_node_create_#res#1.base|)) (= |c_#valid| (store |c_old(#valid)| |c_node_create_#res#1.base| (_ bv1 1)))))
