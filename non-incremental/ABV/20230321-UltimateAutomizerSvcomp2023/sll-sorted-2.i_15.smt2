...
(assert (forall ((v_ArrVal_465 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_458 (Array (_ BitVec 64) (_ BitVec 64))) (|v_ULTIMATE.start_main_~x~0#1.base_66| (_ BitVec 64)) (v_ArrVal_467 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_466 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_461 (_ BitVec 32)) (v_ArrVal_464 (Array (_ BitVec 64) (_ BitVec 64)))) (or (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~x~0#1.base_66|))) (= (_ bv1 32) (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| v_ArrVal_461)) |v_ULTIMATE.start_main_~x~0#1.base_66| v_ArrVal_465) (select (select (store (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_464) |v_ULTIMATE.start_main_~x~0#1.base_66| v_ArrVal_466) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)) (bvadd (select (select (store (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_458) |v_ULTIMATE.start_main_~x~0#1.base_66| v_ArrVal_467) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|) (_ bv8 64)))))))
(check-sat)
(exit)
