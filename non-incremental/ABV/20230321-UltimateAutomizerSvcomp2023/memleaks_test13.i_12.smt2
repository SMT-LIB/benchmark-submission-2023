...
(assert (let ((.cse0 (bvadd (_ bv8 64) |c_~#global_list_13~0.offset|))) (or (not (bvule |c_~#global_list_13~0.offset| .cse0)) (not (bvule (_ bv0 64) |c_~#global_list_13~0.offset|)) (not (bvule .cse0 (select |c_#length| |c_~#global_list_13~0.base|))))))
