...
(assert (not (exists ((|ULTIMATE.start_entry_point_~q~0#1.base| (_ BitVec 64))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~p~0#1.base| (_ bv1 1)))) (and (= |#valid| (store .cse0 |ULTIMATE.start_entry_point_~q~0#1.base| (_ bv0 1))) (= (select .cse0 |ULTIMATE.start_entry_point_~q~0#1.base|) (_ bv0 1)))))))
(check-sat)
(exit)
