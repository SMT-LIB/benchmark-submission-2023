...
(assert (forall ((v_ArrVal_388 (Array (_ BitVec 64) (_ BitVec 32)))) (= (let ((.cse0 (bvadd (_ bv4 64) |ULTIMATE.start_dll_circular_create_#res#1.offset|))) (select (select (store |#memory_int| |ULTIMATE.start_dll_circular_create_#res#1.base| v_ArrVal_388) (select (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_circular_create_#res#1.base|) .cse0)) (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_dll_circular_create_#res#1.base|) .cse0))) |ULTIMATE.start_main_~data_init~0#1|)))
(check-sat)
(exit)
