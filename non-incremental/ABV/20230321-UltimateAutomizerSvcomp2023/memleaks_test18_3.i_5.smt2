...
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (and (exists ((v_ArrVal_80 (_ BitVec 64))) (= (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_80) |c_#length|)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1))))))
(check-sat)
(exit)
