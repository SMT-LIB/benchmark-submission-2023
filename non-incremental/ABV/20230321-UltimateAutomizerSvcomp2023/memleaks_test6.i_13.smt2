...
(declare-fun |c_ULTIMATE.start_disconnect_6_~a#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_disconnect_6_~a#1.offset| () (_ BitVec 64))
...
(assert (let ((.cse0 (bvadd (_ bv8 64) |c_ULTIMATE.start_disconnect_6_~a#1.offset|))) (or (not (bvule (_ bv0 64) |c_ULTIMATE.start_disconnect_6_~a#1.offset|)) (not (bvule .cse0 (select |c_#length| |c_ULTIMATE.start_disconnect_6_~a#1.base|))) (not (bvule |c_ULTIMATE.start_disconnect_6_~a#1.offset| .cse0)))))
