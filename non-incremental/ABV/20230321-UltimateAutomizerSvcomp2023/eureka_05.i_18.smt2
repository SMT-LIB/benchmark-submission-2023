...
(assert (not (let ((.cse0 (select |c_#memory_int| (_ bv3 64)))) (and (= (bvadd (select |c_#valid| (_ bv3 64)) (_ bv1 1)) (_ bv0 1)) (= (_ bv0 64) |c_~#array~0.offset|) (= (select .cse0 (_ bv4 64)) (_ bv0 32)) (forall ((v_ArrVal_203 (Array (_ BitVec 64) (_ BitVec 32)))) (not (let ((.cse1 (select (store |c_#memory_int| |c_ULTIMATE.start_main_~#array~1#1.base| v_ArrVal_203) |c_~#array~0.base|))) (bvslt (select .cse1 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv1 32)) (_ bv4 64)))) (select .cse1 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64)))))))) (= (_ bv3 64) |c_~#array~0.base|) (= (select .cse0 (_ bv0 64)) (_ bv0 32))))))
(check-sat)
(exit)
