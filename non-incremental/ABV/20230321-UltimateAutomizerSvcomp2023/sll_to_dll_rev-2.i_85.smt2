...
(assert (not (and (not (= (_ bv0 64) (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|) (_ bv0 64)))) (= (_ bv0 64) |c_ULTIMATE.start_main_~#p1~0#1.offset_Hier|) (exists ((|#StackHeapBarrier| (_ BitVec 64)) (|ULTIMATE.start_create_sll_~#list~0#1.base| (_ BitVec 64)) (v_DerPreprocessor_11 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_12 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse1 (select v_DerPreprocessor_12 (_ bv0 64)))) (let ((.cse0 (select (store (store (store (store |c_#memory_$Pointer$.base| .cse1 v_DerPreprocessor_11) |ULTIMATE.start_create_sll_~#list~0#1.base| v_DerPreprocessor_12) .cse1 v_DerPreprocessor_11) |ULTIMATE.start_create_sll_~#list~0#1.base| v_DerPreprocessor_12) .cse1))) (and (= .cse0 v_DerPreprocessor_11) (= (select |c_#memory_$Pointer$.base| .cse1) .cse0) (not (= (_ bv0 64) .cse1)) (= (select (select |c_#memory_$Pointer$.base| |ULTIMATE.start_create_sll_~#list~0#1.base|) (_ bv0 64)) .cse1) (bvult .cse1 |#StackHeapBarrier|) (bvult |#StackHeapBarrier| |c_ULTIMATE.start_main_~#p1~0#1.base_Hier|))))))))
(check-sat)
(exit)
