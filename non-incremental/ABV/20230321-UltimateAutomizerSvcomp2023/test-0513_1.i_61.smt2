...
(assert (not (bvsgt (let ((.cse0 (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~data~0#1.offset|))) (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~data~0#1.base|) .cse0)) (bvadd (_ bv8 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~data~0#1.base|) .cse0)))) (_ bv1 32))))
(check-sat)
(exit)
