...
(declare-fun |ULTIMATE.start_entry_point_~#list_14~0#1.base| () (_ BitVec 64))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#list_14~0#1.base|)))
(assert (not (exists ((v_ArrVal_114 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#list_14~0#1.base| v_ArrVal_114)))))
(check-sat)
(exit)
