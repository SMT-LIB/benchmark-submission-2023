...
(assert (= |~#a6~0.base| (_ bv2 64)))
(assert (= (_ bv0 64) |~#a6~0.offset|))
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_27 (_ BitVec 64))) (and (= (_ bv0 1) (select |old(#valid)| |ldv_malloc_#res.base|)) (= (store |old(#length)| |ldv_malloc_#res.base| v_ArrVal_27) |#length|)))))
(check-sat)
(exit)
