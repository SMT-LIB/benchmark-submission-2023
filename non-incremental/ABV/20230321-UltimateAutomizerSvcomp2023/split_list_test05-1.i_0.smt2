...
(assert (forall ((v_ArrVal_252 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| c_append_~node~0.base v_ArrVal_252) c_append_~head.base) (bvadd (_ bv8 64) c_append_~head.offset))) (_ bv1 1)))))
(check-sat)
(exit)
