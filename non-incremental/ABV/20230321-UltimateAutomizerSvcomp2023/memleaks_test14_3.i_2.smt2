...
(assert (not (and (exists ((|v_ULTIMATE.start_alloc_14_~list#1.base_BEFORE_CALL_5| (_ BitVec 64))) (and (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_alloc_14_~list#1.base_BEFORE_CALL_5|) (_ bv0 64))) (= |v_ULTIMATE.start_alloc_14_~list#1.base_BEFORE_CALL_5| (select (select |c_#memory_$Pointer$.base| |v_ULTIMATE.start_alloc_14_~list#1.base_BEFORE_CALL_5|) (_ bv0 64))))) (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_30 (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_30)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))))))
(check-sat)
(exit)
