...
(assert (not (and (exists ((v_ArrVal_29 (_ BitVec 64)) (|ldv_malloc_#res.base| (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_29)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))) (= (_ bv0 64) |c_~#a6~0.offset|) (= |c_~#a6~0.base| (_ bv2 64)))))
(check-sat)
(exit)
