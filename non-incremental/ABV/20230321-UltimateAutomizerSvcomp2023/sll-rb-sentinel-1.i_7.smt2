...
(assert (forall ((|v_ULTIMATE.start_main_~end~0#1.base_35| (_ BitVec 64)) (v_arrayElimArr_4 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_347 (Array (_ BitVec 64) (_ BitVec 32)))) (or (= (select (select (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_347) |v_ULTIMATE.start_main_~end~0#1.base_35| v_arrayElimArr_4) |ULTIMATE.start_main_~list~0#1.base|) (bvadd (_ bv8 64) |ULTIMATE.start_main_~list~0#1.offset|)) (_ bv1 32)) (not (= (_ bv1 32) (select v_arrayElimArr_4 (_ bv8 64)))))))
(check-sat)
(exit)
