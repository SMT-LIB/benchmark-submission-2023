...
(assert (not (exists ((|v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_9| (_ BitVec 64))) (and (= (_ bv0 1) (select |c_ULTIMATE.start_main_old_#valid#1| |v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_9|)) (= (store |c_ULTIMATE.start_main_old_#valid#1| |v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_9| (_ bv0 1)) |c_#valid|)))))
(check-sat)
(exit)
