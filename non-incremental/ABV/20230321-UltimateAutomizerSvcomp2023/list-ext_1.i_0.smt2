...
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~a~0#1.base|)))
(assert (not (exists ((v_ArrVal_172 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~a~0#1.base| v_ArrVal_172)))))
(check-sat)
(exit)
