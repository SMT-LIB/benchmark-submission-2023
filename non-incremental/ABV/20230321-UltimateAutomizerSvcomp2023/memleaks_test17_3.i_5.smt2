...
(declare-fun |ULTIMATE.start_entry_point_#t~ret42#1.base| () (_ BitVec 64))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_#t~ret42#1.base|)))
(assert (not (exists ((v_ArrVal_676 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_#t~ret42#1.base| v_ArrVal_676)))))
(check-sat)
(exit)
