...
(assert (exists ((v_ArrVal_190 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_188 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_185 (Array (_ BitVec 64) (_ BitVec 64)))) (= |#memory_$Pointer$.offset| (store (store (store |old(#memory_$Pointer$.offset)| |__ldv_list_add_#in~next.base| v_ArrVal_185) |__ldv_list_add_#in~new.base| v_ArrVal_188) |__ldv_list_add_#in~prev.base| v_ArrVal_190))))
(assert (not (exists ((v_ArrVal_191 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_187 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_186 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store (store (store |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base| v_ArrVal_191) |__ldv_list_add_#in~new.base| v_ArrVal_186) |__ldv_list_add_#in~prev.base| v_ArrVal_187) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
