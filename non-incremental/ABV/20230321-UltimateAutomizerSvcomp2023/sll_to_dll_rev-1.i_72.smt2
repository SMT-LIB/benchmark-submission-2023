...
(assert (not (= (_ bv0 64) (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~#p2~0#1.base|) (_ bv0 64)))))
...
(assert (exists ((|#StackHeapBarrier| (_ BitVec 64)) (|ULTIMATE.start_create_sll_~#list~0#1.base| (_ BitVec 64))) (let ((.cse0 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_create_sll_~#list~0#1.base|) (_ bv0 64)))) (and (not (= .cse0 (_ bv0 64))) (= .cse0 |ULTIMATE.start_create_sll_~#list~0#1.base|) (bvult .cse0 |#StackHeapBarrier|) (bvult |#StackHeapBarrier| |ULTIMATE.start_main_~#p2~0#1.base|)))))
(check-sat)
(exit)
