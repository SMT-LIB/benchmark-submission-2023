...
(assert (not (exists ((~a8~0.base (_ BitVec 64))) (and (= (select |c_ULTIMATE.start_main_old_#valid#1| ~a8~0.base) (_ bv0 1)) (= (store |c_ULTIMATE.start_main_old_#valid#1| ~a8~0.base (_ bv0 1)) |c_#valid|)))))
(check-sat)
(exit)
