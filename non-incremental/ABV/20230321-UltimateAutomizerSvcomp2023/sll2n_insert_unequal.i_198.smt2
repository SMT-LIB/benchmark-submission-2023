...
(declare-fun |c_ULTIMATE.start_sll_insert_#t~ret7#1.base_primed| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_insert_#t~ret7#1.offset_primed| () (_ BitVec 64))
...
(assert (and (= |c_node_create_#res#1.offset| |c_ULTIMATE.start_sll_insert_#t~ret7#1.offset_primed|) (= |c_ULTIMATE.start_sll_insert_#t~ret7#1.base_primed| |c_node_create_#res#1.base|)))
...
(declare-fun |c_ULTIMATE.start_sll_insert_~data#1_Hier| () (_ BitVec 32))
(assert (= |c_ULTIMATE.start_sll_insert_~data#1_Hier| |c_node_create_#in~data#1|))
(assert (and (not (= (_ bv0 64) |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) |c_node_create_#res#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_400 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_400) |c_#memory_$Pointer$.base|) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|)))))
...
(declare-fun |c_ULTIMATE.start_sll_insert_~head#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_insert_~head#1.offset_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| () (_ BitVec 64))
(assert (and (= (_ bv0 64) |c_ULTIMATE.start_sll_insert_~head#1.offset_Hier|) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base_Hier|) (not (= (_ bv0 64) |c_ULTIMATE.start_sll_create_~head~0#1.base_Hier|)) (not (= (_ bv0 64) |c_ULTIMATE.start_sll_create_#res#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| (_ bv0 64)) (not (= (_ bv0 64) (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_sll_insert_~head#1.base_Hier|) (_ bv0 64)))) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_sll_insert_~head#1.base_Hier|)))
(declare-fun |c_old(#memory_$Pointer$.base)_Hier| () (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64))))
(assert (not (and (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))) (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_400 (Array (_ BitVec 64) (_ BitVec 64)))) (and (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|) (= (store |c_old(#memory_$Pointer$.base)_Hier| |node_create_~temp~0#1.base| v_ArrVal_400) |c_#memory_$Pointer$.base|))))))
(check-sat)
(exit)
