...
(declare-fun |c_ULTIMATE.start_alloc_13_~p~0#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_alloc_13_~p~0#1.offset| () (_ BitVec 64))
...
(assert (or (not (= (_ bv0 64) |c_ULTIMATE.start_alloc_13_~p~0#1.offset|)) (not (= (_ bv0 64) |c_ULTIMATE.start_alloc_13_~p~0#1.base|))))
