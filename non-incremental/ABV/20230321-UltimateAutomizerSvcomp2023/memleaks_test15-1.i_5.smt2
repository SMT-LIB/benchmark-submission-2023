...
(assert (not (exists ((|ldv_zalloc_#t~malloc13#1.base| (_ BitVec 64))) (and (exists ((v_ArrVal_34 (_ BitVec 64))) (= (store |c_old(#length)| |ldv_zalloc_#t~malloc13#1.base| v_ArrVal_34) |c_#length|)) (= (_ bv0 1) (select |c_old(#valid)| |ldv_zalloc_#t~malloc13#1.base|))))))
(check-sat)
(exit)
