...
(assert (not (exists ((v_ArrVal_3425 (_ BitVec 8)) (v_ArrVal_3428 (_ BitVec 8))) (= |c_#memory_int| (store |c_old(#memory_int)| |c_LDV_INIT_LIST_HEAD_#in~list.base| (store (store (select |c_old(#memory_int)| |c_LDV_INIT_LIST_HEAD_#in~list.base|) |c_LDV_INIT_LIST_HEAD_#in~list.offset| v_ArrVal_3425) (bvadd (_ bv8 64) |c_LDV_INIT_LIST_HEAD_#in~list.offset|) v_ArrVal_3428))))))
(check-sat)
(exit)
