...
(assert (not (and (not (= |c_ULTIMATE.start_main_~x~0#1.base| |c_ULTIMATE.start_main_~head~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_main_~head~0#1.offset|) (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~head~0#1.base|) (_ bv8 64)) (_ bv0 32)))))
(check-sat)
(exit)
