...
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_6 (_ BitVec 64))) (and (= (_ bv0 1) (select |old(#valid)| |ldv_malloc_#res.base|)) (= |#length| (store |old(#length)| |ldv_malloc_#res.base| v_ArrVal_6))))))
(check-sat)
(exit)
