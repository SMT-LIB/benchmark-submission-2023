...
(assert (not (and (exists ((|##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| (_ BitVec 64)) (v_ArrVal_489 (Array (_ BitVec 64) (_ BitVec 64)))) (and (bvult |##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| |c_#StackHeapBarrier|) (= |c_##fun~$Pointer$~TO~VOID_dll_insert_slave_~next~0#1.base_primed| (select (select (store |c_old(#memory_$Pointer$.base)| |##fun~$Pointer$~TO~VOID_alloc_or_die_slave_~ptr~0#1.base| v_ArrVal_489) |c_##fun~$Pointer$~TO~VOID_#in~10#1.base|) |c_##fun~$Pointer$~TO~VOID_#in~10#1.offset|)))) (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))))))
(check-sat)
(exit)
