...
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (and (exists ((v_ArrVal_549 (_ BitVec 1))) (= |c_#valid| (store |c_old(#valid)| |ldv_malloc_#res.base| v_ArrVal_549))) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1))))))
(check-sat)
(exit)
