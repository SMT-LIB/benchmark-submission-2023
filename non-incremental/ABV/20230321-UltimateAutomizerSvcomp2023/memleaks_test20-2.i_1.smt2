...
(declare-fun |ULTIMATE.start_alloc_20_#t~ret38#1.base| () (_ BitVec 64))
(declare-fun |ULTIMATE.start_main_old_#valid#1| () (Array (_ BitVec 64) (_ BitVec 1)))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_alloc_20_#t~ret38#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_13 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_alloc_20_#t~ret38#1.base| v_ArrVal_13) |#valid|))))
(check-sat)
(exit)
