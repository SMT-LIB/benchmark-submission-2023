...
(declare-fun |c_ULTIMATE.start_alloc_13_~p~0#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_alloc_13_~p~0#1.offset_Hier| () (_ BitVec 64))
(assert (and (= |c_ldv_list_add_#in~head.base| |c_~#global_list_13~0.base|) (= (bvadd |c_ULTIMATE.start_alloc_13_~p~0#1.offset_Hier| (_ bv4 64)) |c_ldv_list_add_#in~new.offset|) (= |c_ldv_list_add_#in~new.base| |c_ULTIMATE.start_alloc_13_~p~0#1.base_Hier|) (= |c_~#global_list_13~0.offset| |c_ldv_list_add_#in~head.offset|)))
(assert (and (= |c_~#global_list_13~0.base| (_ bv2 64)) (= (_ bv2 64) c_ldv_list_add_~head.base) (= (_ bv2 64) |c_ldv_list_add_#in~head.base|) (= (bvadd (select |c_#valid| (_ bv2 64)) (_ bv1 1)) (_ bv0 1)) (= |c_old(#valid)| |c_#valid|)))
(assert (= |c_old(#valid)| |c_#valid|))
(assert (and (= (_ bv0 1) (bvadd (select |c_#valid| (_ bv2 64)) (_ bv1 1))) (= (_ bv2 64) |c_~#global_list_13~0.base|)))
