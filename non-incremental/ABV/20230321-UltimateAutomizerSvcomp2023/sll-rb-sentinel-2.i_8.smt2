...
(assert (not (or (= (_ bv0 64) |ULTIMATE.start_main_~list~0#1.offset|) (forall ((|v_ULTIMATE.start_main_~end~0#1.base_36| (_ BitVec 64)) (|v_ULTIMATE.start_main_~end~0#1.base_37| (_ BitVec 64)) (|v_ULTIMATE.start_main_~end~0#1.base_38| (_ BitVec 64)) (v_ArrVal_337 (_ BitVec 1))) (let ((.cse0 (store |#valid| |v_ULTIMATE.start_main_~end~0#1.base_38| v_ArrVal_337))) (or (not (= (_ bv0 1) (select .cse0 |v_ULTIMATE.start_main_~end~0#1.base_37|))) (not (= (select (store .cse0 |v_ULTIMATE.start_main_~end~0#1.base_37| (_ bv1 1)) |v_ULTIMATE.start_main_~end~0#1.base_36|) (_ bv0 1))) (not (= (select |#valid| |v_ULTIMATE.start_main_~end~0#1.base_38|) (_ bv0 1)))))))))
(check-sat)
(exit)
