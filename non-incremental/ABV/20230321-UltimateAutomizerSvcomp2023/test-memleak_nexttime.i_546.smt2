...
(assert (not (and (= (bvadd (select |c_#valid| (_ bv3 64)) (_ bv1 1)) (_ bv0 1)) (bvult (_ bv0 64) |c_#StackHeapBarrier|) (= (_ bv0 1) (bvadd (select |c_#valid| (_ bv1 64)) (_ bv1 1))) (= (_ bv3 64) |c_~#a~0.base|) (= (_ bv0 64) |c_~#a~0.offset|))))
(check-sat)
(exit)
