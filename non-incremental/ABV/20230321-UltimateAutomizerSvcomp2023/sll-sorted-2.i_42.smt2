...
(assert (forall ((v_ArrVal_536 (_ BitVec 64))) (or (forall ((v_ArrVal_539 (_ BitVec 32)) (v_ArrVal_540 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store (store |#memory_int| |ULTIMATE.start_main_~x~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~x~0#1.base|) |ULTIMATE.start_main_~x~0#1.offset| v_ArrVal_539)) v_ArrVal_536 v_ArrVal_540) |ULTIMATE.start_main_~head~0#1.base|) (_ bv8 64)) (_ bv0 32))) (not (= (_ bv0 1) (select |#valid| v_ArrVal_536))))))
(assert (not (or (= (_ bv0 64) |ULTIMATE.start_main_~head~0#1.offset|) (forall ((v_ArrVal_536 (_ BitVec 64))) (not (= (_ bv0 1) (select |#valid| v_ArrVal_536)))))))
(check-sat)
(exit)
