...
(assert (not (and (exists ((v_ArrVal_1070 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |c_old(#memory_$Pointer$.base)| |c_#Ultimate.C_memcpy_dest.base| v_ArrVal_1070) |c_#memory_$Pointer$.base|)) (= (_ bv3 64) |c_~#a~0.base|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_#Ultimate.C_memcpy_dest.base|) (_ bv1 1))) (= (_ bv0 64) |c_~#a~0.offset|) (not (= (_ bv0 64) |c_#StackHeapBarrier|)))))
(check-sat)
(exit)
