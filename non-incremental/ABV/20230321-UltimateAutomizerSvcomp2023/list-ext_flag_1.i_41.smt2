...
(assert (forall ((|v_ULTIMATE.start_main_~t~0#1.base_10| (_ BitVec 64))) (or (forall ((v_ArrVal_125 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_123 (_ BitVec 32))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv8 64)) v_ArrVal_123)) |v_ULTIMATE.start_main_~t~0#1.base_10| v_ArrVal_125) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|) (_ bv1 32))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~t~0#1.base_10|))))))
(assert (not (forall ((v_ArrVal_125 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_123 (_ BitVec 32))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv8 64)) v_ArrVal_123)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_125) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|) (_ bv1 32)))))
(check-sat)
(exit)
