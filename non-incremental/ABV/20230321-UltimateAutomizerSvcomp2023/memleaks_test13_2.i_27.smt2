...
(declare-fun |c_ldv_list_del_#in~entry#1.base| () (_ BitVec 64))
(declare-fun |c_ldv_list_del_#in~entry#1.offset| () (_ BitVec 64))
...
(declare-fun |c_ULTIMATE.start_free_unsafe_13_~p~1#1.offset_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_free_unsafe_13_~p~1#1.base_Hier| () (_ BitVec 64))
(assert (and (= |c_ULTIMATE.start_free_unsafe_13_~p~1#1.base_Hier| |c_ldv_list_del_#in~entry#1.base|) (= (bvadd (_ bv4 64) |c_ULTIMATE.start_free_unsafe_13_~p~1#1.offset_Hier|) |c_ldv_list_del_#in~entry#1.offset|)))
