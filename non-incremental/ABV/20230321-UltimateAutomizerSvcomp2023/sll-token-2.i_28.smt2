...
(assert (forall ((v_ArrVal_346 (_ BitVec 64)) (v_ArrVal_345 (Array (_ BitVec 64) (_ BitVec 32)))) (not (= (select (select (let ((.cse0 (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_345))) (store .cse0 v_ArrVal_346 (store (select .cse0 v_ArrVal_346) (_ bv8 64) (_ bv2 32)))) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|)) (_ bv1 32)))))
(check-sat)
(exit)
