...
(assert (not (and (exists ((v_ArrVal_351 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_351) |#memory_$Pointer$.base|)) (not (= (_ bv0 64) (bvadd |#StackHeapBarrier| (_ bv1 64)))) (bvult |node_create_#res#1.base| |#StackHeapBarrier|))))
(check-sat)
(exit)
