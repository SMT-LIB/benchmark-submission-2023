...
(assert (let ((.cse1 (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~x~0#1.offset_primed|))) (and (= (_ bv0 64) |c_ULTIMATE.start_main_~x~0#1.offset_primed|) (= (_ bv0 1) (select |c_#valid| |c_ULTIMATE.start_main_~x~0#1.base_primed|)) (= |c_#valid_primed| (store |c_#valid| |c_ULTIMATE.start_main_~x~0#1.base_primed| (_ bv1 1))) (not (= (_ bv0 32) |c_ULTIMATE.start_main_#t~nondet2#1|)) (bvult |c_ULTIMATE.start_main_~x~0#1.base_primed| |c_#StackHeapBarrier|) (= |c_#length_primed| (store |c_#length| |c_ULTIMATE.start_main_~x~0#1.base_primed| (_ bv12 64))) (= |c_aux_v_#memory_int_11| (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| (select (select |c_aux_v_#memory_int_11| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset|)))) (not (= (_ bv0 64) |c_ULTIMATE.start_main_~x~0#1.base_primed|)) (= (let ((.cse0 (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| |c_ULTIMATE.start_main_~x~0#1.offset_primed|)))) (store .cse0 |c_ULTIMATE.start_main_~x~0#1.base_primed| (store (select .cse0 |c_ULTIMATE.start_main_~x~0#1.base_primed|) .cse1 (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~x~0#1.base_primed|) .cse1)))) |c_#memory_$Pointer$.offset_primed|) (= |c_#memory_$Pointer$.base_primed| (let ((.cse2 (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| |c_ULTIMATE.start_main_~x~0#1.base_primed|)))) (store .cse2 |c_ULTIMATE.start_main_~x~0#1.base_primed| (store (select .cse2 |c_ULTIMATE.start_main_~x~0#1.base_primed|) .cse1 (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~x~0#1.base_primed|) .cse1))))) (= |c_#memory_int_primed| (store |c_aux_v_#memory_int_11| |c_ULTIMATE.start_main_~x~0#1.base_primed| (store (select |c_aux_v_#memory_int_11| |c_ULTIMATE.start_main_~x~0#1.base_primed|) .cse1 (_ bv0 32)))))))
(assert (and (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~x~0#1.offset|)) (_ bv0 32)) (forall ((v_ArrVal_284 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_283 (Array (_ BitVec 64) (_ BitVec 32))) (|v_ULTIMATE.start_main_#t~malloc5#1.base_13| (_ BitVec 64))) (or (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_#t~malloc5#1.base_13|))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_283) |v_ULTIMATE.start_main_#t~malloc5#1.base_13| v_ArrVal_284) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|)) (_ bv0 32))))))
(assert (not (= (_ bv0 32) |c_ULTIMATE.start_main_#t~mem8#1|)))
(check-sat)
(exit)
