...
(assert (let ((.cse0 (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|))) (and (forall ((v_ArrVal_124 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_124) |ULTIMATE.start_main_~a~0#1.base|) .cse0) |ULTIMATE.start_main_~p~0#1.base|)) (forall ((v_ArrVal_126 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.offset| (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_126) |ULTIMATE.start_main_~a~0#1.base|) .cse0))))))
(check-sat)
(exit)
