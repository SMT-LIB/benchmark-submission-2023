...
(declare-fun |ULTIMATE.start_entry_point_~#a19~0#1.base| () (_ BitVec 64))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a19~0#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_70 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a19~0#1.base| v_ArrVal_70) |#valid|))))
(check-sat)
(exit)
