...
(assert (forall ((v_ArrVal_469 (Array (_ BitVec 64) (_ BitVec 64))) (|v_node_create_~temp~0#1.base_22| (_ BitVec 64))) (or (not (= (_ bv0 64) (select (select (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_22| v_ArrVal_469) |c_ULTIMATE.start_sll_insert_~head#1.base|) |c_ULTIMATE.start_sll_insert_~head#1.offset|))) (not (bvult |v_node_create_~temp~0#1.base_22| |c_#StackHeapBarrier|)))))
