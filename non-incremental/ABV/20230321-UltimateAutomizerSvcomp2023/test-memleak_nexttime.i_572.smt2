...
(assert (and (= (bvadd (select |c_#valid| (_ bv3 64)) (_ bv1 1)) (_ bv0 1)) (bvult (_ bv0 64) |c_#StackHeapBarrier|) (exists ((v_arrayElimCell_43 (_ BitVec 64))) (and (bvult v_arrayElimCell_43 |c_#StackHeapBarrier|) (not (= v_arrayElimCell_43 (_ bv1 64))) (not (= (_ bv3 64) v_arrayElimCell_43)) (not (= (_ bv0 64) v_arrayElimCell_43)))) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (= (_ bv0 1) (bvadd (select |c_#valid| (_ bv1 64)) (_ bv1 1))) (= (_ bv3 64) |c_~#a~0.base|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_#Ultimate.C_memcpy_dest.base|) (_ bv1 1))) (= (_ bv0 64) |c_~#a~0.offset|) (not (= (_ bv0 64) |c_#StackHeapBarrier|))))
