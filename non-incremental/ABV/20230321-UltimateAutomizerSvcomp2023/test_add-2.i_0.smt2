...
(declare-fun |c_ULTIMATE.start_ldv_set_add_~new#1| () (_ BitVec 32))
(declare-fun |c_ULTIMATE.start_ldv_set_add_~s#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_ldv_set_add_~s#1.offset| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_ldv_successful_malloc_~ptr~0#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_ldv_successful_malloc_~ptr~0#1.offset| () (_ BitVec 64))
...
(assert (and (= (_ bv3 64) (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) |c_~#s1~0.offset|)) (= |c_~#s1~0.offset| |c_ULTIMATE.start_ldv_set_add_~s#1.offset|) (not (= (_ bv3 64) |c_ULTIMATE.start_ldv_successful_malloc_~ptr~0#1.base|)) (= (_ bv3 64) |c_ULTIMATE.start_ldv_set_add_~s#1.base|) (= (_ bv3 64) |c_~#s1~0.base|) (= |c_ULTIMATE.start_ldv_set_add_~new#1| |c_ULTIMATE.start_foo_~j~0#1|) (= (_ bv0 64) |c_ULTIMATE.start_ldv_successful_malloc_~ptr~0#1.offset|)))
