...
(declare-fun |c_ULTIMATE.start_entry_point_~ret~1#1_primed| () (_ BitVec 32))
(declare-fun |c_ULTIMATE.start_probe1_6_#res#1| () (_ BitVec 32))
...
(assert (= |c_ULTIMATE.start_entry_point_~ret~1#1_primed| |c_ULTIMATE.start_probe1_6_#res#1|))
