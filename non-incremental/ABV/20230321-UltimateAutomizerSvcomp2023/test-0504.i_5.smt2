...
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~x~0#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_719 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~x~0#1.base| v_ArrVal_719)))))
(check-sat)
(exit)
