...
(assert (not (exists ((|create_sub_list_insert_sub_~sub~0#1.base| (_ BitVec 64))) (and (= (_ bv0 1) (select |c_old(#valid)| |create_sub_list_insert_sub_~sub~0#1.base|)) (exists ((v_ArrVal_448 (_ BitVec 64))) (= |c_#length| (store |c_old(#length)| |create_sub_list_insert_sub_~sub~0#1.base| v_ArrVal_448)))))))
(check-sat)
(exit)
