...
(assert (forall ((v_ArrVal_346 (_ BitVec 64)) (v_ArrVal_345 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_343 (_ BitVec 64)) (v_ArrVal_341 (_ BitVec 32))) (or (not (= (_ bv0 1) (select |c_#valid| v_ArrVal_343))) (not (= (select (select (let ((.cse0 (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| v_ArrVal_341)) v_ArrVal_343 v_ArrVal_345))) (store .cse0 v_ArrVal_346 (store (select .cse0 v_ArrVal_346) (_ bv8 64) (_ bv2 32)))) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|)) (_ bv1 32))))))
(check-sat)
(exit)
