...
(assert (not (exists ((v_ArrVal_1284 (Array (_ BitVec 64) (_ BitVec 64)))) (= |#memory_$Pointer$.base| (store |old(#memory_$Pointer$.base)| |dll_insert_master_alloc_or_die_master_#res#1.base| v_ArrVal_1284)))))
(check-sat)
(exit)
