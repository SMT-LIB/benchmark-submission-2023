...
(assert (forall ((v_ArrVal_93 (_ BitVec 32)) (v_ArrVal_96 (Array (_ BitVec 64) (_ BitVec 32)))) (= (_ bv2 32) (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64)) v_ArrVal_93)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_96) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|))))
