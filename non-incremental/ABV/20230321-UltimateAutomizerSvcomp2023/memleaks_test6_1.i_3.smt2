...
(assert (not (exists ((v_ArrVal_29 (_ BitVec 64)) (|ldv_malloc_#res.base| (_ BitVec 64))) (and (= (store |old(#length)| |ldv_malloc_#res.base| v_ArrVal_29) |#length|) (= (_ bv0 1) (select |old(#valid)| |ldv_malloc_#res.base|))))))
(check-sat)
(exit)
