...
(declare-fun |ULTIMATE.start_probe3_6_~p~0#1.base| () (_ BitVec 64))
(declare-fun |#valid| () (Array (_ BitVec 64) (_ BitVec 1)))
(assert (= (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe3_6_~p~0#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_40 (_ BitVec 1))) (= |#valid| (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_probe3_6_~p~0#1.base| v_ArrVal_40)))))
(check-sat)
(exit)
