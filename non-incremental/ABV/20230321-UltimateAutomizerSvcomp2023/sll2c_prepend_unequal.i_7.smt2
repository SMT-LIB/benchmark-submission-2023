...
(assert (not (and (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_235 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_235) |c_#memory_$Pointer$.base|) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))))))
(check-sat)
(exit)
