...
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_disconnect_6_#t~mem43#1.base|)))
(assert (not (exists ((v_ArrVal_130 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_disconnect_6_#t~mem43#1.base| v_ArrVal_130) |#valid|))))
(check-sat)
(exit)
