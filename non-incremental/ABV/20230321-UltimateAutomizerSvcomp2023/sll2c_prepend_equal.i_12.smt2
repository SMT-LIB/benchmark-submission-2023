...
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_primed| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.offset_primed| () (_ BitVec 64))
...
(assert (and (= |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_primed| |c_node_create_#res#1.base|) (= |c_node_create_#res#1.offset| |c_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.offset_primed|)))
...
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_~data#1_Hier| () (_ BitVec 32))
(assert (= |c_ULTIMATE.start_sll_circular_prepend_~data#1_Hier| |c_node_create_#in~data#1|))
(assert (and (not (= (_ bv0 64) |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) |c_node_create_#res#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_163 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_163) |c_#memory_$Pointer$.base|) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|)))))
(declare-fun |c_ULTIMATE.start_main_~#s~0#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_create_#res#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_~head#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_create_~head~0#1.base_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| () (_ BitVec 64))
(assert (and (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base_Hier|) (not (= (_ bv0 64) |c_ULTIMATE.start_sll_circular_create_#res#1.base_Hier|)) (not (= (_ bv0 64) (select (select |c_#memory_$Pointer$.base_Hier| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base_Hier|) (_ bv0 64)))) (= |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| (_ bv0 64)) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_sll_circular_prepend_~head#1.base_Hier|) (not (= (_ bv0 64) |c_ULTIMATE.start_sll_circular_create_~head~0#1.base_Hier|)) (= (_ bv0 64) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset_Hier|)))
(declare-fun |c_old(#memory_$Pointer$.base)_Hier| () (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64))))
(assert (not (and (exists ((|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_163 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= |c_#memory_$Pointer$.base| (store |c_old(#memory_$Pointer$.base)_Hier| |node_create_~temp~0#1.base| v_ArrVal_163)) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))) (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))))))
(check-sat)
(exit)
