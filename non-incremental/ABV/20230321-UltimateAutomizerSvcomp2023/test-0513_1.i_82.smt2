...
(assert (not (and (= (_ bv0 1) (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~item~0#1.base|))) (= |c_ULTIMATE.start_main_~c1~0#1| (_ bv1 32)) (= (_ bv0 64) |c_ULTIMATE.start_main_~item~0#1.offset|))))
(check-sat)
(exit)
