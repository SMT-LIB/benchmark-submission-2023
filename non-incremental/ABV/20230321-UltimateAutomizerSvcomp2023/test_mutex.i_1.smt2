...
(assert (and (= (_ bv3 64) (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) (_ bv0 64))) (= |c_~#mutexes~0.offset| (_ bv0 64)) (= (_ bv3 64) |c_~#mutexes~0.base|) (= (select |c_old(#valid)| |c_ldv_successful_malloc_#res#1.base|) (_ bv0 1))))
