...
(assert (forall ((v_ArrVal_388 (Array (_ BitVec 64) (_ BitVec 32)))) (= (let ((.cse0 (bvadd |c_ULTIMATE.start_main_~ptr~0#1.offset| (_ bv4 64)))) (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~ptr~0#1.base| v_ArrVal_388) (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~ptr~0#1.base|) .cse0)) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~ptr~0#1.base|) .cse0))) |c_ULTIMATE.start_main_~data_init~0#1|)))
(check-sat)
(exit)
