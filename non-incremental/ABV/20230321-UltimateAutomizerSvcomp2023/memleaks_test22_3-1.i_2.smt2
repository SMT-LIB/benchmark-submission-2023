...
(assert (not (exists ((v_ArrVal_3899 (_ BitVec 8))) (= |#memory_int| (store |old(#memory_int)| LDV_INIT_LIST_HEAD_~list.base (store (select |old(#memory_int)| LDV_INIT_LIST_HEAD_~list.base) LDV_INIT_LIST_HEAD_~list.offset v_ArrVal_3899))))))
(check-sat)
(exit)
