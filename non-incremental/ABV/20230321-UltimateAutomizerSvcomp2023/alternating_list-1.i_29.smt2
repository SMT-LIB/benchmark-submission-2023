...
(assert (let ((.cse0 (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|))) (and (forall ((v_ArrVal_100 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~p~0#1.base| v_ArrVal_100) |c_ULTIMATE.start_main_~a~0#1.base|) .cse0) |c_ULTIMATE.start_main_~p~0#1.base|)) (forall ((v_ArrVal_98 (Array (_ BitVec 64) (_ BitVec 64)))) (= |c_ULTIMATE.start_main_~p~0#1.offset| (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~p~0#1.base| v_ArrVal_98) |c_ULTIMATE.start_main_~a~0#1.base|) .cse0))))))
(check-sat)
(exit)
