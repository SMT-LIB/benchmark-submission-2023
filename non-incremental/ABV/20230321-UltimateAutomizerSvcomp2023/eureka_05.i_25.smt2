...
(assert (forall ((v_ArrVal_236 (Array (_ BitVec 64) (_ BitVec 32))) (|v_ULTIMATE.start_main_~#array~1#1.base_14| (_ BitVec 64))) (or (not (let ((.cse0 (select (store |c_#memory_int| |v_ULTIMATE.start_main_~#array~1#1.base_14| v_ArrVal_236) |c_~#array~0.base|))) (bvslt (select .cse0 (bvadd |c_~#array~0.offset| (bvmul (_ bv4 64) ((_ sign_extend 32) (_ bv2 32))))) (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64))))))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~#array~1#1.base_14|))))))
(assert (let ((.cse0 (select |c_#memory_int| |c_~#array~0.base|))) (bvslt (select .cse0 (bvadd |c_~#array~0.offset| (bvmul (_ bv4 64) ((_ sign_extend 32) (_ bv2 32))))) (select .cse0 (bvadd |c_~#array~0.offset| (bvmul ((_ sign_extend 32) (_ bv0 32)) (_ bv4 64)))))))
(check-sat)
(exit)
