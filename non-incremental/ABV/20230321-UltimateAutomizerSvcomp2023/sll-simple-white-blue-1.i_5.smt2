...
(assert (forall ((|v_ULTIMATE.start_main_~head~0#1.base_11| (_ BitVec 64)) (v_ArrVal_141 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_139 (_ BitVec 32)) (v_ArrVal_143 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_140 (_ BitVec 1)) (v_ArrVal_138 (_ BitVec 64))) (or (not (= (_ bv0 1) (select |c_#valid| v_ArrVal_138))) (not (= (select (store |c_#valid| v_ArrVal_138 v_ArrVal_140) |v_ULTIMATE.start_main_~head~0#1.base_11|) (_ bv0 1))) (not (= (_ bv1 32) (select (select (store (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset| v_ArrVal_139)) v_ArrVal_138 v_ArrVal_141) |v_ULTIMATE.start_main_~head~0#1.base_11| v_ArrVal_143) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|)))))))
(assert (= (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)) (bvadd (_ bv8 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))) (_ bv1 32)))
(check-sat)
(exit)
