...
(assert (not (and (exists ((v_ArrVal_515 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_513 (Array (_ BitVec 64) (_ BitVec 64))) (|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_514 (Array (_ BitVec 64) (_ BitVec 32)))) (and (= (store |c_old(#memory_int)| |node_create_~temp~0#1.base| v_ArrVal_514) |c_#memory_int_primed|) (= |c_#memory_$Pointer$.offset_primed| (store |c_old(#memory_$Pointer$.offset)| |node_create_~temp~0#1.base| v_ArrVal_513)) (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_515) |c_#memory_$Pointer$.base_primed|) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|) (= (_ bv0 1) (select |c_old(#valid)| |node_create_~temp~0#1.base|)))) (not (= (_ bv0 64) (bvadd |c_#StackHeapBarrier| (_ bv1 64)))))))
(check-sat)
(exit)
