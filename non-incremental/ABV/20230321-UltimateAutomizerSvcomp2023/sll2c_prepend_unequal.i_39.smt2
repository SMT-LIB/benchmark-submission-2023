...
(assert (forall ((|v_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_14| (_ BitVec 64)) (v_ArrVal_433 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_432 (Array (_ BitVec 64) (_ BitVec 64)))) (or (not (bvult |v_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_14| |c_#StackHeapBarrier|)) (not (let ((.cse1 (store |c_#memory_$Pointer$.base| |v_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_14| v_ArrVal_432))) (let ((.cse0 (select (select .cse1 |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|))) (= .cse0 (select (select .cse1 .cse0) (select (select (store |c_#memory_$Pointer$.offset| |v_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_14| v_ArrVal_433) |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|)))))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_sll_circular_prepend_#t~ret9#1.base_14|))))))
