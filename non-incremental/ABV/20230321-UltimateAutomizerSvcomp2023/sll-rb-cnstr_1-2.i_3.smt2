...
(assert (forall ((v_ArrVal_104 (Array (_ BitVec 64) (_ BitVec 32))) (v_arrayElimArr_2 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_105 (_ BitVec 64))) (or (not (= (select v_arrayElimArr_2 (_ bv8 64)) (_ bv1 32))) (= (_ bv1 32) (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~end~0#1.base| v_ArrVal_104) v_ArrVal_105 v_arrayElimArr_2) |c_ULTIMATE.start_main_~list~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~list~0#1.offset|))))))
