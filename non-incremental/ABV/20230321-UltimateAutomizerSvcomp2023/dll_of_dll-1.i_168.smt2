...
(assert (not (exists ((v_ArrVal_975 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |old(#memory_$Pointer$.base)| |dll_insert_master_alloc_or_die_master_#res#1.base| v_ArrVal_975) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
