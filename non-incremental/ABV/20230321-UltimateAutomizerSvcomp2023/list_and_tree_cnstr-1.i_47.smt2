...
(assert (not (let ((.cse0 (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv3 32))))) (or (not (= (_ bv2 32) (select (select .cse0 |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|))) (forall ((v_ArrVal_407 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_410 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv2 32) (let ((.cse1 (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|))) (select (select .cse0 (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~p~0#1.base| v_ArrVal_407) |c_ULTIMATE.start_main_~a~0#1.base|) .cse1)) (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~p~0#1.base| v_ArrVal_410) |c_ULTIMATE.start_main_~a~0#1.base|) .cse1)))))))))
(check-sat)
(exit)
