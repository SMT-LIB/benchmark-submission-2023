...
(assert (forall ((v_ArrVal_234 (Array (_ BitVec 64) (_ BitVec 32))) (|v_ULTIMATE.start_main_~x~0#1.base_51| (_ BitVec 64)) (v_ArrVal_232 (Array (_ BitVec 64) (_ BitVec 32)))) (or (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_main_~x~0#1.base_51|))) (= (_ bv0 32) (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_232) |v_ULTIMATE.start_main_~x~0#1.base_51| v_ArrVal_234) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|))))))
(check-sat)
(exit)
