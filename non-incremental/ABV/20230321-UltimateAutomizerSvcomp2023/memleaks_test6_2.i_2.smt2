...
(assert (and (= |c_old(#length)| |c_#length|) (= (_ bv0 64) |c_~#a6~0.offset|) (= |c_~#a6~0.base| (_ bv2 64)) (= |c_old(#valid)| |c_#valid|)))
(assert (not (and (= (_ bv0 64) |c_~#a6~0.offset|) (= |c_~#a6~0.base| (_ bv2 64)) (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_30 (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_30)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))))))
(check-sat)
(exit)
