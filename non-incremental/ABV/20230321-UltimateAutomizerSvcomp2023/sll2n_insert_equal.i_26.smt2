...
(assert (not (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|))) (and (exists ((|#StackHeapBarrier| (_ BitVec 64)) (v_arrayElimCell_1 (_ BitVec 64))) (and (bvult |c_ULTIMATE.start_sll_insert_~new_node~0#1.base| |#StackHeapBarrier|) (not (= (_ bv0 64) v_arrayElimCell_1)) (bvult v_arrayElimCell_1 |#StackHeapBarrier|) (bvult |#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (bvult .cse0 |#StackHeapBarrier|))) (not (= (_ bv0 64) .cse0))))))
(check-sat)
(exit)
