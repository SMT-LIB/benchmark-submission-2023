...
(assert (not (= |c_ULTIMATE.start_main_~expected~0#1| (select (select |c_#memory_int| |c_ULTIMATE.start_sll_get_data_at_~head#1.base|) |c_ULTIMATE.start_sll_get_data_at_~head#1.offset|))))
(check-sat)
(exit)
