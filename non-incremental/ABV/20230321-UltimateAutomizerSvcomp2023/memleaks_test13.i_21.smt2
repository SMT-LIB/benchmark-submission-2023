...
(declare-fun |c_LDV_INIT_LIST_HEAD_#in~list.base| () (_ BitVec 64))
(declare-fun |c_LDV_INIT_LIST_HEAD_#in~list.offset| () (_ BitVec 64))
...
(assert (and (= |c_~#global_list_13~0.offset| |c_LDV_INIT_LIST_HEAD_#in~list.offset|) (= |c_~#global_list_13~0.base| |c_LDV_INIT_LIST_HEAD_#in~list.base|)))
