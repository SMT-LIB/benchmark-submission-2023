...
(assert (forall ((v_ArrVal_241 (Array (_ BitVec 64) (_ BitVec 32)))) (= |c_ULTIMATE.start_main_~len~0#1| (select (select (store |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_update_at_~head#1.base|) (bvadd |c_ULTIMATE.start_dll_update_at_~head#1.offset| (_ bv4 64))) v_ArrVal_241) |c_ULTIMATE.start_main_~s~0#1.base|) |c_ULTIMATE.start_main_~s~0#1.offset|))))
(assert (not (and (= |c_ULTIMATE.start_dll_create_~head~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_create_~new_head~0#1.base|) (_ bv4 64))) (not (= |c_ULTIMATE.start_dll_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_create_~head~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_dll_create_~new_head~0#1.offset|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_ULTIMATE.start_dll_create_~head~0#1.base|) (_ bv1 1))) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_dll_create_~new_head~0#1.base|)) (_ bv0 1)))))
(check-sat)
(exit)
