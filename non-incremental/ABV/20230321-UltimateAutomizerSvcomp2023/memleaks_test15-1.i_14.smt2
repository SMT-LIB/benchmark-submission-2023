...
(assert (not (exists ((|ldv_zalloc_#Ultimate.meminit_#ptr#1.base| (_ BitVec 64)) (v_ArrVal_163 (_ BitVec 1)) (v_ArrVal_162 (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_zalloc_#Ultimate.meminit_#ptr#1.base| v_ArrVal_162)) (= (select |c_old(#valid)| |ldv_zalloc_#Ultimate.meminit_#ptr#1.base|) (_ bv0 1)) (= (store |c_old(#valid)| |ldv_zalloc_#Ultimate.meminit_#ptr#1.base| v_ArrVal_163) |c_#valid|)))))
(check-sat)
(exit)
