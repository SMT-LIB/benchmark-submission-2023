...
(assert (not (forall ((v_ArrVal_170 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_170) |ULTIMATE.start_main_~a~0#1.base|) |ULTIMATE.start_main_~a~0#1.offset|) (_ bv0 32)))))
