...
(assert (not (exists ((|zalloc_or_die_#Ultimate.C_memset_#ptr#1.base| (_ BitVec 64))) (= |c_#valid| (store |c_old(#valid)| |zalloc_or_die_#Ultimate.C_memset_#ptr#1.base| (_ bv1 1))))))
(check-sat)
(exit)
