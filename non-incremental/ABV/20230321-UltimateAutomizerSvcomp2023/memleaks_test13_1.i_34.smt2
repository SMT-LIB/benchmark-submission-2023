...
(assert (not (and (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| (_ bv2 64)) (_ bv0 64))) (= (_ bv0 64) |c_~#global_list_13~0.offset|) (= |c_~#global_list_13~0.base| (_ bv2 64)) (exists ((v_ArrVal_13 (_ BitVec 64)) (|ldv_malloc_#res.base| (_ BitVec 64))) (and (= |c_#length| (store |c_old(#length)| |ldv_malloc_#res.base| v_ArrVal_13)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1)))) (= (_ bv2 64) (select (select |c_#memory_$Pointer$.base| (_ bv2 64)) (_ bv0 64))))))
(check-sat)
(exit)
