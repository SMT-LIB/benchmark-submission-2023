...
(assert (not (and (not (= |c_ULTIMATE.start_dll_create_~head~0#1.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_create_~head~0#1.base|) (_ bv4 64)))) (= (_ bv0 64) |c_ULTIMATE.start_dll_create_~head~0#1.offset|))))
(check-sat)
(exit)
