...
(assert (= |#valid| (store |old(#valid)| |ldv_zalloc_#res#1.base| (_ bv1 1))))
(assert (= |#valid| (store |old(#valid)| |ldv_zalloc_#t~malloc13#1.base| (_ bv1 1))))
(assert (not (exists ((|ldv_zalloc_#t~malloc13#1.base| (_ BitVec 64))) (and (exists ((v_ArrVal_130 (_ BitVec 1))) (= (store |old(#valid)| |ldv_zalloc_#t~malloc13#1.base| v_ArrVal_130) |#valid|)) (= (_ bv0 1) (select |old(#valid)| |ldv_zalloc_#t~malloc13#1.base|))))))
(check-sat)
(exit)
