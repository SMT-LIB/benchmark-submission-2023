...
(declare-fun |c_ULTIMATE.start_main_#t~malloc4#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_main_#t~malloc4#1.offset| () (_ BitVec 64))
...
(assert (not (and (= (select |c_#length| |c_ULTIMATE.start_main_#t~malloc4#1.base|) (_ bv8 64)) (= (bvadd (select |c_#valid| |c_ULTIMATE.start_main_#t~malloc4#1.base|) (_ bv1 1)) (_ bv0 1)) (= (_ bv0 64) |c_ULTIMATE.start_main_~tree~0#1.offset|) (= (_ bv0 64) |c_ULTIMATE.start_main_#t~malloc4#1.offset|) (not (= |c_ULTIMATE.start_main_#t~malloc4#1.base| |c_ULTIMATE.start_main_~tree~0#1.base|)) (= (_ bv0 1) (bvadd (select |c_#valid| |c_ULTIMATE.start_main_~tree~0#1.base|) (_ bv1 1))))))
(check-sat)
(exit)
