...
(declare-fun ~a9~0.base () (_ BitVec 64))
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| ~a9~0.base)))
(assert (not (exists ((v_ArrVal_13 (_ BitVec 1))) (= (store |ULTIMATE.start_main_old_#valid#1| ~a9~0.base v_ArrVal_13) |#valid|))))
(check-sat)
(exit)
