...
(assert (not (and (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (bvult |c_node_create_~temp~0#1.base| |c_#StackHeapBarrier|) (= |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|))))
(check-sat)
(exit)
