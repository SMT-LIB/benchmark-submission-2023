...
(assert (and (exists ((|v_ULTIMATE.start_entry_point_~#list_14~0#1.offset_BEFORE_CALL_3| (_ BitVec 64)) (|v_ULTIMATE.start_entry_point_~#list_14~0#1.base_BEFORE_CALL_4| (_ BitVec 64))) (= |v_ULTIMATE.start_entry_point_~#list_14~0#1.base_BEFORE_CALL_4| (select (select |c_#memory_$Pointer$.base_Hier| |v_ULTIMATE.start_entry_point_~#list_14~0#1.base_BEFORE_CALL_4|) |v_ULTIMATE.start_entry_point_~#list_14~0#1.offset_BEFORE_CALL_3|))) (= |c_#valid| |c_#valid|)))
