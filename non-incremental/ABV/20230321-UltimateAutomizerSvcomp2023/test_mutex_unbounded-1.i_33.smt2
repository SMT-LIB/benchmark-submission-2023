...
(assert (exists ((v_ArrVal_184 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_188 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_189 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store (store (store |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base| v_ArrVal_189) |__ldv_list_add_#in~new.base| v_ArrVal_184) |__ldv_list_add_#in~prev.base| v_ArrVal_188) |#memory_$Pointer$.base|)))
(assert (= (_ bv0 64) |~#drvlist~0.offset|))
(assert (= |~#drvlist~0.base| (_ bv4 64)))
(assert (= |~#mutexes~0.offset| (_ bv0 64)))
(assert (not (exists ((v_ArrVal_187 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_186 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_185 (Array (_ BitVec 64) (_ BitVec 64)))) (= |#memory_$Pointer$.offset| (store (store (store |old(#memory_$Pointer$.offset)| |__ldv_list_add_#in~next.base| v_ArrVal_185) |__ldv_list_add_#in~new.base| v_ArrVal_186) |__ldv_list_add_#in~prev.base| v_ArrVal_187)))))
(check-sat)
(exit)
