...
(assert (or (not (= |c_ldv_is_in_set_#in~e| (let ((.cse0 (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_~#s1~0.base|) |c_~#s1~0.offset|))) (.cse1 (select (select |c_#memory_$Pointer$.offset| |c_~#s1~0.base|) |c_~#s1~0.offset|))) (concat (concat (concat (select .cse0 (bvadd (_ bv18446744073709551615 64) .cse1)) (select .cse0 (bvadd (_ bv18446744073709551614 64) .cse1))) (select .cse0 (bvadd (_ bv18446744073709551613 64) .cse1))) (select .cse0 (bvadd (_ bv18446744073709551612 64) .cse1)))))) (= c_ldv_is_in_set_~e (let ((.cse2 (select |c_#memory_int| c_ldv_is_in_set_~m~1.base))) (concat (concat (concat (select .cse2 (bvadd (_ bv3 64) c_ldv_is_in_set_~m~1.offset)) (select .cse2 (bvadd (_ bv2 64) c_ldv_is_in_set_~m~1.offset))) (select .cse2 (bvadd (_ bv1 64) c_ldv_is_in_set_~m~1.offset))) (select .cse2 c_ldv_is_in_set_~m~1.offset)))) (not (= |c_ldv_is_in_set_#in~s.offset| |c_~#s1~0.offset|)) (not (= |c_ldv_is_in_set_#in~s.base| |c_~#s1~0.base|))))
