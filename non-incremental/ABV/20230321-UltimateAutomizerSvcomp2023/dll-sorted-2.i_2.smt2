...
(assert (forall ((v_ArrVal_501 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_500 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_499 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_501) (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_499) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)) (bvadd (_ bv16 64) (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_500) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))) (_ bv0 32))))
(check-sat)
(exit)
