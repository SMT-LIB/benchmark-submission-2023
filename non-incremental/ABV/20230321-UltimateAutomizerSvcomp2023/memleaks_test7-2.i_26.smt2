...
(assert (not (and (= (_ bv0 1) (select |c_ULTIMATE.start_main_old_#valid#1_primed| |c_ULTIMATE.start_entry_point_~#a7~0#1.base_primed|)) (exists ((v_ArrVal_135 (_ BitVec 1)) (|v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_8| (_ BitVec 64))) (let ((.cse0 (store |c_ULTIMATE.start_main_old_#valid#1_primed| |c_ULTIMATE.start_entry_point_~#a7~0#1.base_primed| v_ArrVal_135))) (and (= (_ bv0 1) (select .cse0 |v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_8|)) (= |c_#valid_primed| (store .cse0 |v_ULTIMATE.start_disconnect_6_#t~mem43#1.base_8| (_ bv0 1)))))))))
(check-sat)
(exit)
