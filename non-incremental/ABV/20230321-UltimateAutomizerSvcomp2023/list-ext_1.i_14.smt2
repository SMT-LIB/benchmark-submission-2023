...
(assert (forall ((v_ArrVal_207 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64))) v_ArrVal_207) |c_ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|))) (_ bv1 1)))))
(assert (not (= (_ bv0 1) (bvadd (select |c_#valid| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|))) (_ bv1 1)))))
(check-sat)
(exit)
