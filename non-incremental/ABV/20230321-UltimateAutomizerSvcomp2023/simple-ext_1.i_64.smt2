...
(assert (not (forall ((v_ArrVal_170 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_165 (_ BitVec 32))) (= (select (select (store (store |#memory_int| |ULTIMATE.start_main_~p~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~p~0#1.base|) (bvadd |ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64)) v_ArrVal_165)) |ULTIMATE.start_main_~t~0#1.base| v_ArrVal_170) |ULTIMATE.start_main_~a~0#1.base|) |ULTIMATE.start_main_~a~0#1.offset|) (_ bv0 32)))))
(assert (forall ((|v_ULTIMATE.start_main_~t~0#1.base_15| (_ BitVec 64))) (not (= (_ bv0 1) (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_15|)))))
(check-sat)
(exit)
