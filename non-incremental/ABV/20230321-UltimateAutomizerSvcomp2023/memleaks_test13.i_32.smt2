...
(assert (and (= (store |c_#valid| |c_ULTIMATE.start_free_13_~p~1#1.base| (_ bv0 1)) |c_#valid_primed|) (or (= (_ bv0 64) |c_ULTIMATE.start_free_13_~p~1#1.base|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_ULTIMATE.start_free_13_~p~1#1.base|) (_ bv1 1))))))
(assert (and (= |c_~#global_list_13~0.base| (_ bv2 64)) (= (bvadd (select |c_#valid| (_ bv2 64)) (_ bv1 1)) (_ bv0 1))))
(assert (not (and (= (_ bv2 64) |c_~#global_list_13~0.base|) (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (= (store |c_old(#valid)| |ldv_malloc_#res.base| (_ bv1 1)) |c_#valid_primed|)))))
(check-sat)
(exit)
