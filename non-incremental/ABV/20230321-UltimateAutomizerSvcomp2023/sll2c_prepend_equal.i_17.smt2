...
(assert (not (and (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (exists ((v_ArrVal_328 (Array (_ BitVec 64) (_ BitVec 64))) (|node_create_~temp~0#1.base| (_ BitVec 64)) (v_ArrVal_329 (Array (_ BitVec 64) (_ BitVec 64)))) (and (= (store |c_old(#memory_$Pointer$.base)| |node_create_~temp~0#1.base| v_ArrVal_328) |c_#memory_$Pointer$.base|) (= |c_#memory_$Pointer$.offset| (store |c_old(#memory_$Pointer$.offset)| |node_create_~temp~0#1.base| v_ArrVal_329)) (= (select |c_old(#valid)| |node_create_~temp~0#1.base|) (_ bv0 1)) (bvult |node_create_~temp~0#1.base| |c_#StackHeapBarrier|))))))
(check-sat)
(exit)
