...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~#s~0#1.base|) (_ bv0 64))) (exists ((v_arrayElimIndex_6 (_ BitVec 64)) (|#StackHeapBarrier| (_ BitVec 64)) (v_DerPreprocessor_1 (_ BitVec 64))) (let ((.cse2 (select (select |c_#memory_$Pointer$.base| v_arrayElimIndex_6) (_ bv0 64))) (.cse5 (select (select |c_#memory_$Pointer$.offset| v_DerPreprocessor_1) (_ bv0 64)))) (let ((.cse3 (bvadd (_ bv8 64) .cse5)) (.cse4 (select |c_#memory_$Pointer$.base| .cse2))) (let ((.cse1 (select .cse4 .cse5)) (.cse0 (select .cse4 .cse3))) (and (= v_DerPreprocessor_1 .cse0) (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~#s~0#1.base|) (_ bv0 64)) .cse0) (not (= .cse1 |c_ULTIMATE.start_main_~#s~0#1.base|)) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| .cse2) .cse3)) (= v_arrayElimIndex_6 .cse0) (bvult .cse2 |#StackHeapBarrier|) (bvult |#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (not (= .cse1 .cse0)) (not (= .cse1 .cse2)) (not (= .cse2 .cse0)) (= (select (select |c_#memory_int| .cse0) (_ bv16 64)) (_ bv1 32))))))))))
(check-sat)
(exit)
