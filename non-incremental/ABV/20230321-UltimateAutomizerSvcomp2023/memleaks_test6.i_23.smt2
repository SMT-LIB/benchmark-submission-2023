...
(assert (and (or (= (_ bv0 1) (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_disconnect_6_#t~mem43#1.base|))) (= (_ bv0 64) |c_ULTIMATE.start_disconnect_6_#t~mem43#1.base|)) (= (store |c_#valid| |c_ULTIMATE.start_disconnect_6_#t~mem43#1.base| (_ bv0 1)) |c_#valid_primed|)))
