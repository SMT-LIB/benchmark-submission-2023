...
(assert (not (exists ((v_DerPreprocessor_3 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_4 (Array (_ BitVec 64) (_ BitVec 64)))) (and (let ((.cse0 (select (select |#memory_$Pointer$.base| |append_to_queue_#in~q.base|) |append_to_queue_#in~q.offset|))) (= (select |#memory_$Pointer$.offset| .cse0) (select (store (store (store (store |#memory_$Pointer$.offset| .cse0 v_DerPreprocessor_3) |append_to_queue_#in~q.base| v_DerPreprocessor_4) .cse0 v_DerPreprocessor_3) |append_to_queue_#in~q.base| v_DerPreprocessor_4) .cse0))) (= (_ bv0 64) (select v_DerPreprocessor_4 |append_to_queue_#in~q.offset|))))))
(check-sat)
(exit)
