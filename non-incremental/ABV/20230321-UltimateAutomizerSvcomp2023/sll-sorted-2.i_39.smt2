...
(assert (and (= (_ bv0 64) |ULTIMATE.start_main_~head~0#1.offset|) (forall ((v_ArrVal_540 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| |ULTIMATE.start_main_~x~0#1.base| v_ArrVal_540) |ULTIMATE.start_main_~head~0#1.base|) (_ bv8 64)) (_ bv0 32)))))
(check-sat)
(exit)
