...
(assert (not (forall ((v_ArrVal_224 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_223 (Array (_ BitVec 64) (_ BitVec 64)))) (not (= (select (select (store (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_sll_insert_~snd_to_last~0#1.base| v_ArrVal_223) |c_ULTIMATE.start_sll_insert_~new_node~0#1.base| v_ArrVal_224) |c_ULTIMATE.start_main_~#s~0#1.base|) |c_ULTIMATE.start_main_~#s~0#1.offset|) (_ bv0 64))))))
(check-sat)
(exit)
