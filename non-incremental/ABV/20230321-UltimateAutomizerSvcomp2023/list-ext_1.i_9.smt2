...
(declare-fun |c_ULTIMATE.start_main_#t~mem13#1.base| () (_ BitVec 64))
...
(assert (forall ((v_ArrVal_207 (Array (_ BitVec 64) (_ BitVec 64)))) (= (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_#t~mem13#1.base| v_ArrVal_207) |c_ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |c_ULTIMATE.start_main_~a~0#1.offset|))) (_ bv1 1)) (_ bv0 1))))
(check-sat)
(exit)
