...
(assert (let ((.cse3 (= |__ldv_list_add_#in~new.offset| (select (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~prev.base|) |__ldv_list_add_#in~prev.offset|)))) (or (and (or (exists ((v_DerPreprocessor_9 (Array (_ BitVec 64) (_ BitVec 64)))) (and (exists ((v_DerPreprocessor_7 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_8 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse2 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9) |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9))) (and (exists ((v_DerPreprocessor_6 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_5 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_4 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse0 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6) |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6))) (let ((.cse1 (select .cse0 |__ldv_list_add_#in~next.base|))) (and (= v_DerPreprocessor_5 (select .cse0 |__ldv_list_add_#in~new.base|)) (= |__ldv_list_add_#in~new.offset| (select v_DerPreprocessor_6 |__ldv_list_add_#in~prev.offset|)) (= .cse1 (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base|)) (= .cse1 (select .cse2 |__ldv_list_add_#in~next.base|)))))) (= v_DerPreprocessor_8 (select .cse2 |__ldv_list_add_#in~new.base|))))) (= |__ldv_list_add_#in~new.offset| (select v_DerPreprocessor_9 |__ldv_list_add_#in~prev.offset|)))) (= |__ldv_list_add_#in~prev.base| |__ldv_list_add_#in~next.base|)) .cse3) (and (not (= |__ldv_list_add_#in~prev.base| |__ldv_list_add_#in~new.base|)) .cse3))))
