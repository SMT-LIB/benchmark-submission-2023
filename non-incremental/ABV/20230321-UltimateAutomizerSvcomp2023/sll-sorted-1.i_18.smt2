...
(assert (forall ((v_ArrVal_395 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_393 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_394 (Array (_ BitVec 64) (_ BitVec 64)))) (= (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_393) (select (select (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_395) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)) (bvadd (_ bv8 64) (select (select (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_394) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|))) (_ bv1 32))))
(check-sat)
(exit)
