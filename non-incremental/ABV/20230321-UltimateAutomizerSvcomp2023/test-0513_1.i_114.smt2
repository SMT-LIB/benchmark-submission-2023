...
(assert (not (bvslt (let ((.cse0 (bvadd |c_ULTIMATE.start_main_~data~0#1.offset| (_ bv8 64)))) (select (select |c_#memory_int| (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~data~0#1.base|) .cse0)) (bvadd (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~data~0#1.base|) .cse0) (_ bv8 64)))) (_ bv15 32))))
(check-sat)
(exit)
