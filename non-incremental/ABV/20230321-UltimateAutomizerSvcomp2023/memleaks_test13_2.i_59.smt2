...
(declare-fun |~#global_list_13~0.base| () (_ BitVec 64))
(declare-fun |~#global_list_13~0.offset| () (_ BitVec 64))
(assert (= (_ bv0 64) (select (select |#memory_$Pointer$.offset| (_ bv2 64)) (_ bv0 64))))
(assert (= (_ bv2 64) |~#global_list_13~0.base|))
(assert (= (_ bv2 64) (select (select |#memory_$Pointer$.base| (_ bv2 64)) (_ bv0 64))))
(assert (= (_ bv0 64) |~#global_list_13~0.offset|))
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64)) (v_ArrVal_11 (_ BitVec 64))) (and (= |#length| (store |old(#length)| |ldv_malloc_#res.base| v_ArrVal_11)) (= (_ bv0 1) (select |old(#valid)| |ldv_malloc_#res.base|))))))
(check-sat)
(exit)
