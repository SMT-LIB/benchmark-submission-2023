...
(assert (or (= |ULTIMATE.start_main_~a~0#1.base| |ULTIMATE.start_main_~p~0#1.base|) (forall ((v_arrayElimCell_17 (_ BitVec 64)) (|v_ULTIMATE.start_main_~t~0#1.base_13| (_ BitVec 64))) (or (= (_ bv0 1) (bvadd (select (store |#valid| |v_ULTIMATE.start_main_~t~0#1.base_13| (_ bv1 1)) v_arrayElimCell_17) (_ bv1 1))) (not (= (_ bv0 1) (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_13|)))))))
(assert (or (= |ULTIMATE.start_main_~p~0#1.offset| |ULTIMATE.start_main_~a~0#1.offset|) (forall ((v_arrayElimCell_17 (_ BitVec 64)) (|v_ULTIMATE.start_main_~t~0#1.base_13| (_ BitVec 64))) (or (= (_ bv0 1) (bvadd (select (store |#valid| |v_ULTIMATE.start_main_~t~0#1.base_13| (_ bv1 1)) v_arrayElimCell_17) (_ bv1 1))) (not (= (_ bv0 1) (select |#valid| |v_ULTIMATE.start_main_~t~0#1.base_13|)))))))
(assert (= (select |#valid| |ULTIMATE.start_main_~a~0#1.base|) (_ bv0 1)))
(assert (forall ((v_arrayElimCell_17 (_ BitVec 64))) (= (_ bv0 1) (bvadd (select (store |#valid| |ULTIMATE.start_main_~a~0#1.base| (_ bv1 1)) v_arrayElimCell_17) (_ bv1 1)))))
(check-sat)
(exit)
