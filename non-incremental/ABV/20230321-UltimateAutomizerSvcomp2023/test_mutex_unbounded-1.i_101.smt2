...
(assert (not (and (exists ((v_ArrVal_94 (Array (_ BitVec 64) (_ BitVec 64))) (__ldv_list_add_~new.offset (_ BitVec 64)) (v_ArrVal_86 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_87 (Array (_ BitVec 64) (_ BitVec 64))) (__ldv_list_add_~next.offset (_ BitVec 64)) (__ldv_list_add_~prev.offset (_ BitVec 64))) (let ((.cse0 (bvadd (_ bv8 64) __ldv_list_add_~next.offset))) (and (= (store (store (store |c_old(#memory_$Pointer$.base)| |c___ldv_list_add_#in~next.base| (store (select |c_old(#memory_$Pointer$.base)| |c___ldv_list_add_#in~next.base|) .cse0 |c___ldv_list_add_#in~new.base|)) |c___ldv_list_add_#in~new.base| v_ArrVal_87) |c___ldv_list_add_#in~prev.base| v_ArrVal_86) |c_#memory_$Pointer$.base|) (= |c_#memory_$Pointer$.offset| (store (let ((.cse1 (store |c_old(#memory_$Pointer$.offset)| |c___ldv_list_add_#in~next.base| (store (select |c_old(#memory_$Pointer$.offset)| |c___ldv_list_add_#in~next.base|) .cse0 __ldv_list_add_~new.offset)))) (store .cse1 |c___ldv_list_add_#in~new.base| (store (store (select .cse1 |c___ldv_list_add_#in~new.base|) __ldv_list_add_~new.offset __ldv_list_add_~next.offset) (bvadd (_ bv8 64) __ldv_list_add_~new.offset) __ldv_list_add_~prev.offset))) |c___ldv_list_add_#in~prev.base| v_ArrVal_94))))) (= |c_~#drvlist~0.base| (_ bv4 64)) (= (_ bv3 64) |c_~#mutexes~0.base|))))
(check-sat)
(exit)
