...
(assert (= (select (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~p~0#1.base| (_ bv1 1)) |ULTIMATE.start_entry_point_~q~0#1.base|) (_ bv0 1)))
(assert (not (exists ((v_ArrVal_53 (_ BitVec 1))) (= (store (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~p~0#1.base| (_ bv1 1)) |ULTIMATE.start_entry_point_~q~0#1.base| v_ArrVal_53) |#valid|))))
(check-sat)
(exit)
