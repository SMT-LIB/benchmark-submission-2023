...
(assert (and (= (_ bv0 64) |c_node_create_~temp~0#1.offset|) (= |c_#valid| (store |c_old(#valid)| |c_node_create_~temp~0#1.base| (_ bv1 1))) (= (_ bv0 1) (select |c_old(#valid)| |c_node_create_~temp~0#1.base|)) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (= |c_node_create_#in~data#1| |c_node_create_~data#1|) (not (= (_ bv0 64) |c_#StackHeapBarrier|))))
