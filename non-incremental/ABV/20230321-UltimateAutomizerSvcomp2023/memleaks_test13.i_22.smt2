...
(assert (and (= |c_ldv_list_add_#in~head.base| |c_~#global_list_13~0.base|) (= (bvadd |c_ULTIMATE.start_alloc_13_~p~0#1.offset_Hier| (_ bv4 64)) |c_ldv_list_add_#in~new.offset|) (= |c_~#global_list_13~0.offset| |c_ldv_list_add_#in~head.offset|) (= |c_ldv_list_add_#in~new.base| |c_ULTIMATE.start_alloc_13_~p~0#1.base_Hier|)))
