...
(assert (not (and (= (_ bv0 1) (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~item~0#1.base|))) (= (_ bv6 32) (select (select |c_#memory_int| |c_ULTIMATE.start_main_~item~0#1.base|) (_ bv8 64))) (= (_ bv0 64) |c_ULTIMATE.start_main_~item~0#1.offset|))))
(check-sat)
(exit)
