...
(assert (not (and (= |c_~#drvlist~0.base| (_ bv4 64)) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (= c_ldv_list_add_~new.base |c_ldv_list_add_#in~new.base|) (= (_ bv3 64) |c_~#mutexes~0.base|) (= |c_ldv_list_add_#t~mem6.base| (select (select |c_#memory_$Pointer$.base| c_ldv_list_add_~head.base) |c_ldv_list_add_#in~head.offset|)) (= |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|) (= c_ldv_list_add_~head.base |c_ldv_list_add_#in~head.base|))))
(check-sat)
(exit)
