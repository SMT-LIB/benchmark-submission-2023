...
(assert (not (exists ((|ULTIMATE.start_main_~data~0#1.base| (_ BitVec 64)) (v_ArrVal_507 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~item~0#1.base| v_ArrVal_507))) (and (= (_ bv0 1) (select .cse0 |ULTIMATE.start_main_~data~0#1.base|)) (= (store .cse0 |ULTIMATE.start_main_~data~0#1.base| (_ bv0 1)) |#valid|))))))
(check-sat)
(exit)
