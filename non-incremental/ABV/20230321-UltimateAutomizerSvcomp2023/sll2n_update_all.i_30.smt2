...
(assert (forall ((v_ArrVal_200 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) (bvadd |ULTIMATE.start_main_~s~0#1.offset| (_ bv4 64))) v_ArrVal_200) |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|) |ULTIMATE.start_main_~len~0#1|)))
...
(assert (= |ULTIMATE.start_sll_update_at_~data#1| |ULTIMATE.start_main_~len~0#1|))
(assert (not (= (select (select |#memory_int| |ULTIMATE.start_main_~s~0#1.base|) (_ bv0 64)) |ULTIMATE.start_main_~len~0#1|)))
(check-sat)
(exit)
