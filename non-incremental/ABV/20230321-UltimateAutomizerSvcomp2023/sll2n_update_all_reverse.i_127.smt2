...
(declare-fun |ULTIMATE.start_node_create_#res#1.offset| () (_ BitVec 64))
...
(assert (= |ULTIMATE.start_sll_update_at_~data#1| (_ bv3 32)))
(assert (= (_ bv0 64) |ULTIMATE.start_node_create_#res#1.offset|))
...
(assert (= (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) (_ bv4 64)) |ULTIMATE.start_sll_update_at_~head#1.base|))
(assert (= (_ bv2 32) |ULTIMATE.start_main_~len~0#1|))
(assert (= (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_sll_create_#res#1.base|) (_ bv4 64)) (_ bv0 64)))
(assert (= (_ bv0 1) (bvadd (select |#valid| |ULTIMATE.start_node_create_#res#1.base|) (_ bv1 1))))
(assert (not (= (select (select |#memory_$Pointer$.base| |ULTIMATE.start_sll_create_#res#1.base|) (_ bv4 64)) |ULTIMATE.start_sll_create_#res#1.base|)))
(assert (forall ((v_ArrVal_245 (Array (_ BitVec 64) (_ BitVec 32)))) (= (bvadd (let ((.cse0 (bvadd |ULTIMATE.start_main_~s~0#1.offset| (_ bv4 64)))) (select (select (store |#memory_int| |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_245) (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) .cse0)) (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_main_~s~0#1.base|) .cse0))) (_ bv1 32)) (bvmul (_ bv2 32) |ULTIMATE.start_main_~len~0#1|))))
(assert (= (_ bv0 1) (bvadd (select |#valid| |ULTIMATE.start_node_create_~temp~0#1.base|) (_ bv1 1))))
(assert (= (_ bv0 64) (select (select |#memory_$Pointer$.offset| |ULTIMATE.start_sll_create_~head~0#1.base|) (_ bv4 64))))
(assert (= (_ bv0 64) |ULTIMATE.start_node_create_~temp~0#1.offset|))
(assert (= (_ bv0 64) |ULTIMATE.start_sll_update_at_~head#1.offset|))
(assert (= (select (select |#memory_$Pointer$.base| |ULTIMATE.start_sll_create_~head~0#1.base|) (_ bv4 64)) |ULTIMATE.start_sll_create_~head~0#1.base|))
(check-sat)
(exit)
