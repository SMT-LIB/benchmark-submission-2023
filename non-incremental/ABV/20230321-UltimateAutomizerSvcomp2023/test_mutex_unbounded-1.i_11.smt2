...
(assert (not (and (= |c_~#drvlist~0.base| (_ bv4 64)) (= |c_old(#memory_$Pointer$.base)| |c_#memory_$Pointer$.base|) (= (_ bv3 64) |c_~#mutexes~0.base|) (= |c_old(#memory_$Pointer$.offset)| |c_#memory_$Pointer$.offset|))))
(check-sat)
(exit)
