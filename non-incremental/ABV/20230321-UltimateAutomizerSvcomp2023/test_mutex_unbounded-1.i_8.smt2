...
(assert (not (and (= |c_~#drvlist~0.base| (_ bv4 64)) (= (bvadd (select |c_#valid| (_ bv3 64)) (_ bv1 1)) (_ bv0 1)) (= (_ bv3 64) |c_~#mutexes~0.base|) (= (_ bv4 64) (select (select |c_#memory_$Pointer$.base| (_ bv4 64)) |c_~#drvlist~0.offset|)) (= (select (select |c_#memory_$Pointer$.offset| (_ bv3 64)) |c_~#mutexes~0.offset|) |c_~#mutexes~0.offset|) (= (_ bv3 64) (select (select |c_#memory_$Pointer$.base| (_ bv3 64)) |c_~#mutexes~0.offset|)))))
(check-sat)
(exit)
