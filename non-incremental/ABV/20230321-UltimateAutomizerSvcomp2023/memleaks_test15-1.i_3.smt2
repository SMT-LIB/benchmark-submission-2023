...
(assert (= (_ bv0 1) (bvadd (select |#valid| |ldv_zalloc_#t~malloc13#1.base|) (_ bv1 1))))
(assert (= (_ bv0 1) (bvadd (select |#valid| |ldv_zalloc_#res#1.base|) (_ bv1 1))))
(assert (not (exists ((|ldv_zalloc_#t~malloc13#1.base| (_ BitVec 64))) (= |#valid| (store |old(#valid)| |ldv_zalloc_#t~malloc13#1.base| (_ bv1 1))))))
(check-sat)
(exit)
