...
(assert (not (exists ((~a9~0.base (_ BitVec 64))) (and (= (_ bv0 1) (select |c_ULTIMATE.start_main_old_#valid#1| ~a9~0.base)) (= |c_#valid| (store |c_ULTIMATE.start_main_old_#valid#1| ~a9~0.base (_ bv0 1)))))))
(check-sat)
(exit)
