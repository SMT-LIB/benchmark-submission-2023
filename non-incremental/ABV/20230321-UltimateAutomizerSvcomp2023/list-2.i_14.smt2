...
(assert (let ((.cse0 (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|))) (and (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|)) (_ bv0 1)) (not (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|)) (forall ((v_ArrVal_95 (_ BitVec 32)) (v_ArrVal_98 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store .cse0 (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64)) v_ArrVal_95)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_98) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|) (_ bv1 32))) (= (select .cse0 |c_ULTIMATE.start_main_~p~0#1.offset|) (_ bv1 32)))))
(assert (not (and (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|) (_ bv1 32)) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~a~0#1.base|)) (_ bv0 1)) (not (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|)) (forall ((v_ArrVal_95 (_ BitVec 32)) (v_ArrVal_98 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store (store |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_main_~p~0#1.base|) (bvadd |c_ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64)) v_ArrVal_95)) |c_ULTIMATE.start_main_~t~0#1.base| v_ArrVal_98) |c_ULTIMATE.start_main_~a~0#1.base|) |c_ULTIMATE.start_main_~a~0#1.offset|) (_ bv1 32))))))
(check-sat)
(exit)
