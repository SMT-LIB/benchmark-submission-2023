...
(declare-fun |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.base_primed| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.offset_primed| () (_ BitVec 64))
...
(assert (and (= |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.base_primed| |c_node_create_#res#1.base|) (= |c_ULTIMATE.start_dll_circular_create_#t~ret5#1.offset_primed| |c_node_create_#res#1.offset|)))
...
(declare-fun |c_ULTIMATE.start_dll_circular_create_~data#1_Hier| () (_ BitVec 32))
(assert (= |c_node_create_#in~data#1| |c_ULTIMATE.start_dll_circular_create_~data#1_Hier|))
...
(assert (and (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base_Hier|) (not (= (_ bv0 64) |c_ULTIMATE.start_dll_circular_create_~new_head~0#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| (_ bv0 64)) (not (= (_ bv0 64) |c_ULTIMATE.start_dll_circular_create_~head~0#1.base_Hier|))))
