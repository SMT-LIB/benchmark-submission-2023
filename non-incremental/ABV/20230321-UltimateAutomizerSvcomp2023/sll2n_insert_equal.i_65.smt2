...
(assert (not (= (_ bv0 64) |node_create_~temp~0#1.base|)))
(assert (not (= (_ bv0 64) |node_create_#res#1.base|)))
(assert (not (exists ((v_ArrVal_222 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |old(#memory_$Pointer$.base)| |node_create_#res#1.base| v_ArrVal_222) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
