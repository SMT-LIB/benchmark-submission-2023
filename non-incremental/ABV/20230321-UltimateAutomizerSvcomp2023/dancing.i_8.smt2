...
(declare-fun |c_ULTIMATE.start_re_insert_#t~mem11#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_re_insert_#t~mem11#1.offset| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_re_insert_~x#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_re_insert_~x#1.offset| () (_ BitVec 64))
(assert (= ~unnamed0~0~P_ALL (_ bv0 32)))
(assert (= ~unnamed0~0~P_PID (_ bv1 32)))
(assert (= (_ bv2 32) ~unnamed0~0~P_PGID))
(assert (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_re_insert_~x#1.base|) |c_ULTIMATE.start_re_insert_~x#1.offset|)) (.cse1 (bvadd (_ bv8 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_re_insert_~x#1.base|) |c_ULTIMATE.start_re_insert_~x#1.offset|)))) (and (= (store |c_#memory_int| .cse0 (store (select |c_#memory_int| .cse0) .cse1 (select (select |c_#memory_int_primed| .cse0) .cse1))) |c_#memory_int_primed|) (= (store |c_#memory_$Pointer$.offset| .cse0 (store (select |c_#memory_$Pointer$.offset| .cse0) .cse1 |c_ULTIMATE.start_re_insert_~x#1.offset|)) |c_#memory_$Pointer$.offset_primed|) (or (not (= (_ bv0 64) |c_ULTIMATE.start_re_insert_#t~mem11#1.offset|)) (not (= (_ bv0 64) |c_ULTIMATE.start_re_insert_#t~mem11#1.base|))) (= |c_#memory_$Pointer$.base_primed| (store |c_#memory_$Pointer$.base| .cse0 (store (select |c_#memory_$Pointer$.base| .cse0) .cse1 |c_ULTIMATE.start_re_insert_~x#1.base|))))))
