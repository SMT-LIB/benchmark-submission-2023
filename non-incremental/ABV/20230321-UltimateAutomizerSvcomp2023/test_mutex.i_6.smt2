...
(assert (let ((.cse0 (= |__ldv_list_add_#in~new.offset| (select (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~prev.base|) |__ldv_list_add_#in~prev.offset|)))) (or (and (not (= |__ldv_list_add_#in~prev.base| |__ldv_list_add_#in~new.base|)) .cse0) (and (or (exists ((v_DerPreprocessor_9 (Array (_ BitVec 64) (_ BitVec 64)))) (and (exists ((v_DerPreprocessor_7 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_8 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse2 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9) |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9))) (let ((.cse1 (select .cse2 |__ldv_list_add_#in~next.base|))) (and (= .cse1 v_DerPreprocessor_7) (= v_DerPreprocessor_8 (select .cse2 |__ldv_list_add_#in~new.base|)) (exists ((v_DerPreprocessor_6 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_5 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_4 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse3 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6) |__ldv_list_add_#in~next.base| v_DerPreprocessor_4) |__ldv_list_add_#in~new.base| v_DerPreprocessor_5) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_6))) (let ((.cse4 (select .cse3 |__ldv_list_add_#in~next.base|))) (and (= v_DerPreprocessor_5 (select .cse3 |__ldv_list_add_#in~new.base|)) (= |__ldv_list_add_#in~new.offset| (select v_DerPreprocessor_6 |__ldv_list_add_#in~prev.offset|)) (= .cse4 v_DerPreprocessor_4) (= .cse4 (select |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base|)) (= .cse4 .cse1))))))))) (= |__ldv_list_add_#in~new.offset| (select v_DerPreprocessor_9 |__ldv_list_add_#in~prev.offset|)))) (and (exists ((v_prenex_9 (Array (_ BitVec 64) (_ BitVec 64))) (v_prenex_10 (Array (_ BitVec 64) (_ BitVec 64))) (v_prenex_11 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse5 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_prenex_11) |__ldv_list_add_#in~new.base| v_prenex_10) |__ldv_list_add_#in~prev.base| v_prenex_9) |__ldv_list_add_#in~next.base| v_prenex_11) |__ldv_list_add_#in~new.base| v_prenex_10) |__ldv_list_add_#in~prev.base| v_prenex_9))) (and (= v_prenex_10 (select .cse5 |__ldv_list_add_#in~new.base|)) (= |__ldv_list_add_#in~new.offset| (select v_prenex_9 |__ldv_list_add_#in~prev.offset|)) (= v_prenex_11 (select .cse5 |__ldv_list_add_#in~next.base|))))) (exists ((v_DerPreprocessor_7 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_9 (Array (_ BitVec 64) (_ BitVec 64))) (v_DerPreprocessor_8 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse6 (store (store (store (store (store (store |#memory_$Pointer$.offset| |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9) |__ldv_list_add_#in~next.base| v_DerPreprocessor_7) |__ldv_list_add_#in~new.base| v_DerPreprocessor_8) |__ldv_list_add_#in~prev.base| v_DerPreprocessor_9))) (and (= (select .cse6 |__ldv_list_add_#in~next.base|) v_DerPreprocessor_7) (= v_DerPreprocessor_8 (select .cse6 |__ldv_list_add_#in~new.base|)) (= |__ldv_list_add_#in~new.offset| (select v_DerPreprocessor_9 |__ldv_list_add_#in~prev.offset|))))) (= |__ldv_list_add_#in~prev.base| |__ldv_list_add_#in~next.base|))) .cse0))))
(assert (= (_ bv3 64) |~#mutexes~0.base|))
(assert (= |~#mutexes~0.offset| (_ bv0 64)))
(assert (not (exists ((v_ArrVal_84 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_87 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_77 (Array (_ BitVec 64) (_ BitVec 64))) (__ldv_list_add_~next.offset (_ BitVec 64))) (= |#memory_$Pointer$.base| (store (store (store |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base| v_ArrVal_84) |__ldv_list_add_#in~new.base| (store (store (select (store |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base| (store (select |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base|) (bvadd (_ bv8 64) __ldv_list_add_~next.offset) |__ldv_list_add_#in~new.base|)) |__ldv_list_add_#in~new.base|) |__ldv_list_add_#in~new.offset| |__ldv_list_add_#in~next.base|) (bvadd |__ldv_list_add_#in~new.offset| (_ bv8 64)) |__ldv_list_add_#in~prev.base|)) |__ldv_list_add_#in~prev.base| (store (select (store (store |old(#memory_$Pointer$.base)| |__ldv_list_add_#in~next.base| v_ArrVal_77) |__ldv_list_add_#in~new.base| v_ArrVal_87) |__ldv_list_add_#in~prev.base|) |__ldv_list_add_#in~prev.offset| |__ldv_list_add_#in~new.base|))))))
(check-sat)
(exit)
