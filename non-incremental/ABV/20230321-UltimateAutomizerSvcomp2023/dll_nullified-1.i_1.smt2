...
(assert (and (= (_ bv0 1) (bvadd (select |#valid| |ULTIMATE.start_dll_create_~new_head~0#1.base|) (_ bv1 1))) (= (_ bv0 1) (bvadd (select |#valid| |ULTIMATE.start_dll_create_~head~0#1.base|) (_ bv1 1))) (forall ((v_ArrVal_354 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| |ULTIMATE.start_dll_create_~head~0#1.base| v_ArrVal_354) |ULTIMATE.start_dll_create_~new_head~0#1.base|) |ULTIMATE.start_dll_create_~new_head~0#1.offset|) (_ bv0 32))) (= (select (select |#memory_int| |ULTIMATE.start_dll_create_~head~0#1.base|) |ULTIMATE.start_dll_create_~head~0#1.offset|) (_ bv0 32))))
(check-sat)
(exit)
