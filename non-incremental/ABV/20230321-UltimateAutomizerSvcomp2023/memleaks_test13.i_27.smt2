...
(declare-fun |c_ULTIMATE.start_free_13_~p~1#1.offset_Hier| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_free_13_~p~1#1.base_Hier| () (_ BitVec 64))
(assert (and (= (bvadd |c_ULTIMATE.start_free_13_~p~1#1.offset_Hier| (_ bv4 64)) |c_ldv_list_del_#in~entry#1.offset|) (= |c_ldv_list_del_#in~entry#1.base| |c_ULTIMATE.start_free_13_~p~1#1.base_Hier|)))
