...
(assert (not (exists ((v_ArrVal_393 (Array (_ BitVec 64) (_ BitVec 64)))) (= (store |old(#memory_$Pointer$.base)| |chain_node_alloc_node_#res#1.base| v_ArrVal_393) |#memory_$Pointer$.base|))))
(check-sat)
(exit)
