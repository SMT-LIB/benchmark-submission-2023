...
(assert (forall ((v_ArrVal_241 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |#memory_int| |ULTIMATE.start_dll_update_at_~head#1.base| v_ArrVal_241) |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|) |ULTIMATE.start_main_~len~0#1|)))
(check-sat)
(exit)
