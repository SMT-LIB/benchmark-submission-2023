...
(assert (forall ((v_ArrVal_403 (Array (_ BitVec 64) (_ BitVec 64))) (|v_node_create_~temp~0#1.base_19| (_ BitVec 64))) (or (not (bvult |v_node_create_~temp~0#1.base_19| |c_#StackHeapBarrier|)) (not (= (_ bv0 64) (select (select (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_19| v_ArrVal_403) |c_ULTIMATE.start_sll_insert_~head#1.base|) |c_ULTIMATE.start_sll_insert_~head#1.offset|))))))
