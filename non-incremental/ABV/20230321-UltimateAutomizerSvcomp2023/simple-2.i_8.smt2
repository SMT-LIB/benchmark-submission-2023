...
(assert (forall ((v_ArrVal_116 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.base| (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_116) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|)))))
(assert (not (forall ((v_ArrVal_114 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.offset| (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_114) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|))))))
(check-sat)
(exit)
