...
(assert (forall ((v_ArrVal_184 (Array (_ BitVec 64) (_ BitVec 64)))) (= |ULTIMATE.start_main_~p~0#1.offset| (select (select (store |#memory_$Pointer$.offset| |ULTIMATE.start_main_~p~0#1.base| v_ArrVal_184) |ULTIMATE.start_main_~a~0#1.base|) (bvadd (_ bv4 64) |ULTIMATE.start_main_~a~0#1.offset|)))))
(check-sat)
(exit)
