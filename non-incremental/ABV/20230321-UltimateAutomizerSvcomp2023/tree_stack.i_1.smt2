...
(declare-fun |ULTIMATE.start_main_~root~0#1.base| () (_ BitVec 64))
...
(assert (= (_ bv0 1) (select |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~root~0#1.base|)))
(assert (not (exists ((v_ArrVal_629 (_ BitVec 1)) (v_ArrVal_628 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_main_~root~0#1.base| v_ArrVal_628))) (and (= (select .cse0 |ULTIMATE.start_main_~s~0#1.base|) (_ bv0 1)) (= |#valid| (store .cse0 |ULTIMATE.start_main_~s~0#1.base| v_ArrVal_629)))))))
(check-sat)
(exit)
