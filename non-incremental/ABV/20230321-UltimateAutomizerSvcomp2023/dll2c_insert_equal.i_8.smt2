...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base|) (_ bv0 64)) |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|) (not (= |c_ULTIMATE.start_dll_circular_create_~head~0#1.base| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|)) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_main_~#s~0#1.base|)) (_ bv0 1)) (= (bvadd (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base|) (_ bv1 1)) (_ bv0 1)) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (not (= |c_ULTIMATE.start_dll_circular_create_~head~0#1.base| |c_ULTIMATE.start_main_~#s~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_dll_circular_create_~head~0#1.offset|) (not (= |c_ULTIMATE.start_main_~#s~0#1.base| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|)) (= (_ bv1 32) (select (select |c_#memory_int| |c_ULTIMATE.start_dll_circular_create_~head~0#1.base|) (_ bv16 64))) (= (_ bv0 1) (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_dll_circular_create_~last~0#1.base|))) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|))))
(check-sat)
(exit)
