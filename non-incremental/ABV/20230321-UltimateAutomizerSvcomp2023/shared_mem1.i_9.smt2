...
(assert (forall ((v_ArrVal_444 (Array (_ BitVec 64) (_ BitVec 64))) (v_ArrVal_442 (Array (_ BitVec 64) (_ BitVec 64)))) (not (bvsle (let ((.cse3 (bvadd |c_ULTIMATE.start_main_~list~0#1.offset| (_ bv4 64)))) (let ((.cse0 (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~list~0#1.base|) .cse3))) (let ((.cse7 (store |c_#memory_$Pointer$.offset| .cse0 v_ArrVal_442)) (.cse4 (store |c_#memory_$Pointer$.base| .cse0 v_ArrVal_444)) (.cse8 (bvadd |c_ULTIMATE.start_main_~list~0#1.offset| (_ bv12 64)))) (let ((.cse5 (select (select .cse4 |c_ULTIMATE.start_main_~list~0#1.base|) .cse8)) (.cse6 (bvadd (_ bv4 64) (select (select .cse7 |c_ULTIMATE.start_main_~list~0#1.base|) .cse8)))) (select (select (store |c_#memory_int| .cse0 (let ((.cse1 (select |c_#memory_int| .cse0)) (.cse2 (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~list~0#1.base|) .cse3))) (store .cse1 .cse2 (bvadd (select (select |c_#memory_int| |c_ULTIMATE.start_main_~list~0#1.base|) |c_ULTIMATE.start_main_~list~0#1.offset|) (select .cse1 .cse2))))) (select (select .cse4 .cse5) .cse6)) (select (select .cse7 .cse5) .cse6)))))) (_ bv100 32)))))
(check-sat)
(exit)
