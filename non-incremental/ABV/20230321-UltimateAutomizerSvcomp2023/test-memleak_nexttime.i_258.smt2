...
(declare-fun |c_ULTIMATE.start_main_~#p~1#1.base_primed| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_main_~#p~1#1.offset_primed| () (_ BitVec 64))
(assert (= ~unnamed0~0~P_ALL (_ bv0 32)))
(assert (= ~unnamed0~0~P_PID (_ bv1 32)))
(assert (= (_ bv2 32) ~unnamed0~0~P_PGID))
(assert (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#p~1#1.offset_primed|) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#p~1#1.base_primed|) (= |c_#length_primed| (store |c_#length| |c_ULTIMATE.start_main_~#p~1#1.base_primed| (_ bv8 64))) (= (select |c_#valid| |c_ULTIMATE.start_main_~#p~1#1.base_primed|) (_ bv0 1)) (= (store |c_#valid| |c_ULTIMATE.start_main_~#p~1#1.base_primed| (_ bv1 1)) |c_#valid_primed|) (not (= (_ bv0 64) |c_ULTIMATE.start_main_~#p~1#1.base_primed|))))
