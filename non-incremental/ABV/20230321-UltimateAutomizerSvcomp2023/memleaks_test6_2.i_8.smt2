...
(declare-fun |c_ULTIMATE.start_probe3_6_~a#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_probe3_6_~a#1.offset| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_probe3_6_~p~0#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_probe3_6_~p~0#1.offset| () (_ BitVec 64))
...
(assert (let ((.cse0 (bvadd (_ bv8 64) |c_ULTIMATE.start_probe3_6_~a#1.offset|))) (and (= (store |c_#memory_int| |c_ULTIMATE.start_probe3_6_~a#1.base| (store (select |c_#memory_int| |c_ULTIMATE.start_probe3_6_~a#1.base|) |c_ULTIMATE.start_probe3_6_~a#1.offset| (select (select |c_#memory_int_primed| |c_ULTIMATE.start_probe3_6_~a#1.base|) |c_ULTIMATE.start_probe3_6_~a#1.offset|))) |c_#memory_int_primed|) (bvule .cse0 (select |c_#length| |c_ULTIMATE.start_probe3_6_~a#1.base|)) (= (store |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_probe3_6_~a#1.base| (store (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_probe3_6_~a#1.base|) |c_ULTIMATE.start_probe3_6_~a#1.offset| |c_ULTIMATE.start_probe3_6_~p~0#1.offset|)) |c_#memory_$Pointer$.offset_primed|) (= (store |c_#memory_$Pointer$.base| |c_ULTIMATE.start_probe3_6_~a#1.base| (store (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_probe3_6_~a#1.base|) |c_ULTIMATE.start_probe3_6_~a#1.offset| |c_ULTIMATE.start_probe3_6_~p~0#1.base|)) |c_#memory_$Pointer$.base_primed|) (bvule |c_ULTIMATE.start_probe3_6_~a#1.offset| .cse0) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_probe3_6_~a#1.base|)) (_ bv0 1)) (bvule (_ bv0 64) |c_ULTIMATE.start_probe3_6_~a#1.offset|))))
