...
(assert (and (= (_ bv0 64) |ULTIMATE.start_main_~a~0#1.offset|) (= (_ bv1 32) (select (select |#memory_int| |ULTIMATE.start_main_~a~0#1.base|) (_ bv0 64))) (= (bvadd (select |#valid| |ULTIMATE.start_main_~a~0#1.base|) (_ bv1 1)) (_ bv0 1)) (forall ((v_ArrVal_236 (_ BitVec 64)) (v_ArrVal_234 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_230 (_ BitVec 32))) (let ((.cse0 (select (select (let ((.cse1 (store (store |#memory_int| |ULTIMATE.start_main_~p~0#1.base| (store (select |#memory_int| |ULTIMATE.start_main_~p~0#1.base|) (bvadd |ULTIMATE.start_main_~p~0#1.offset| (_ bv4 64)) v_ArrVal_230)) |ULTIMATE.start_main_~t~0#1.base| v_ArrVal_234))) (store .cse1 v_ArrVal_236 (store (select .cse1 v_ArrVal_236) (_ bv0 64) (_ bv3 32)))) |ULTIMATE.start_main_~a~0#1.base|) |ULTIMATE.start_main_~a~0#1.offset|))) (or (= (_ bv3 32) .cse0) (= (_ bv1 32) .cse0)))) (not (= |ULTIMATE.start_main_~a~0#1.base| |ULTIMATE.start_main_~p~0#1.base|))))
(check-sat)
(exit)
