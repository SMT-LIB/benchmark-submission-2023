...
(assert (forall ((v_ArrVal_401 (Array (_ BitVec 64) (_ BitVec 64)))) (let ((.cse1 (bvadd |ULTIMATE.start_main_~s~0#1.offset| (_ bv4 64)))) (let ((.cse0 (select (select |#memory_$Pointer$.base| |ULTIMATE.start_main_~s~0#1.base|) .cse1))) (= .cse0 (select (select (store |#memory_$Pointer$.base| .cse0 v_ArrVal_401) |ULTIMATE.start_main_~s~0#1.base|) .cse1))))))
