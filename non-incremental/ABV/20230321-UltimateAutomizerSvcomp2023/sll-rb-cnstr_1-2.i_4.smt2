...
(assert (forall ((v_ArrVal_104 (Array (_ BitVec 64) (_ BitVec 32))) (v_arrayElimArr_2 (Array (_ BitVec 64) (_ BitVec 32))) (v_ArrVal_105 (_ BitVec 64))) (or (not (= (select v_arrayElimArr_2 (_ bv8 64)) (_ bv1 32))) (= (select (select (store (store |#memory_int| |ULTIMATE.start_main_~end~0#1.base| v_ArrVal_104) v_ArrVal_105 v_arrayElimArr_2) |ULTIMATE.start_main_~list~0#1.base|) (bvadd (_ bv8 64) |ULTIMATE.start_main_~list~0#1.offset|)) (_ bv1 32)))))
(check-sat)
(exit)
