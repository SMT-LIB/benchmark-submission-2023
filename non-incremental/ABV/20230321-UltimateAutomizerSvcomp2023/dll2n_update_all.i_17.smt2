...
(assert (not (and (not (= |c_ULTIMATE.start_dll_create_~new_head~0#1.base| |c_ULTIMATE.start_dll_create_~head~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_dll_create_~new_head~0#1.offset|))))
(check-sat)
(exit)
