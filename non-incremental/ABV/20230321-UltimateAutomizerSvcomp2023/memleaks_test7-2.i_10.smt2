...
(assert (not (exists ((|ULTIMATE.start_probe1_6_~p~0#1.base| (_ BitVec 64)) (v_ArrVal_71 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a7~0#1.base| v_ArrVal_71))) (and (= (store .cse0 |ULTIMATE.start_probe1_6_~p~0#1.base| (_ bv0 1)) |#valid|) (= (_ bv0 1) (select .cse0 |ULTIMATE.start_probe1_6_~p~0#1.base|)))))))
(check-sat)
(exit)
