...
(declare-fun |ULTIMATE.start_dll_update_at_~head#1.offset| () (_ BitVec 64))
...
(declare-fun |ULTIMATE.start_dll_update_at_~head#1.base| () (_ BitVec 64))
(declare-fun |ULTIMATE.start_main_~len~0#1| () (_ BitVec 32))
(assert (forall ((v_ArrVal_241 (Array (_ BitVec 64) (_ BitVec 32)))) (= |ULTIMATE.start_main_~len~0#1| (select (select (store |#memory_int| (select (select |#memory_$Pointer$.base| |ULTIMATE.start_dll_update_at_~head#1.base|) (bvadd |ULTIMATE.start_dll_update_at_~head#1.offset| (_ bv4 64))) v_ArrVal_241) |ULTIMATE.start_main_~s~0#1.base|) |ULTIMATE.start_main_~s~0#1.offset|))))
(check-sat)
(exit)
