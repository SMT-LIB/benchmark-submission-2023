...
(declare-fun |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.base| () (_ BitVec 64))
(declare-fun |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.offset| () (_ BitVec 64))
...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= (bvadd (_ bv1 1) (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_~head~0#1.base|)) (_ bv0 1)) (not (= |c_ULTIMATE.start_sll_circular_create_~head~0#1.base| |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.base|)) (= |c_ULTIMATE.start_sll_circular_create_~last~0#1.base| |c_ULTIMATE.start_sll_circular_create_~head~0#1.base|) (= (_ bv0 1) (bvadd (select |c_#valid| |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.base|) (_ bv1 1))) (= (select (select |c_#memory_int| |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.base|) (_ bv8 64)) (_ bv1 32)) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|) (= (_ bv0 64) |c_ULTIMATE.start_sll_circular_create_#t~ret5#1.offset|))))
(check-sat)
(exit)
