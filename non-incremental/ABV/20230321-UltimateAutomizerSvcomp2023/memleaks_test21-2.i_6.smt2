...
(assert (not (exists ((|ULTIMATE.start_free_21_~p~1#1.base| (_ BitVec 64))) (and (= (store |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_free_21_~p~1#1.base| (_ bv0 1)) |c_#valid|) (= (_ bv0 1) (select |c_ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_free_21_~p~1#1.base|))))))
(check-sat)
(exit)
