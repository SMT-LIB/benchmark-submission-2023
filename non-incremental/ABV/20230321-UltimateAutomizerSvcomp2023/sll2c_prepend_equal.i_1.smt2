...
(assert (forall ((v_ArrVal_166 (Array (_ BitVec 64) (_ BitVec 64))) (|v_node_create_~temp~0#1.base_7| (_ BitVec 64))) (or (not (= (select (select (store |c_#memory_$Pointer$.base| |v_node_create_~temp~0#1.base_7| v_ArrVal_166) |c_ULTIMATE.start_sll_circular_prepend_~head#1.base|) |c_ULTIMATE.start_sll_circular_prepend_~head#1.offset|) (_ bv0 64))) (not (bvult |v_node_create_~temp~0#1.base_7| |c_#StackHeapBarrier|)))))
