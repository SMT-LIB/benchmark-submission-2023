...
(assert (forall ((v_ArrVal_415 (Array (_ BitVec 64) (_ BitVec 32)))) (= (bvmul (_ bv2 32) |c_ULTIMATE.start_main_~len~0#1|) (bvadd (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~s~0#1.base| v_ArrVal_415) (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~s~0#1.base|) |c_ULTIMATE.start_main_~s~0#1.offset|)) (bvadd (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~s~0#1.base|) |c_ULTIMATE.start_main_~s~0#1.offset|) (_ bv16 64))) (_ bv1 32)))))
(check-sat)
(exit)
