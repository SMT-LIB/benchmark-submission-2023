...
(declare-fun |ULTIMATE.start_gl_insert_~node~0#1.base| () (_ BitVec 64))
...
(assert (forall ((v_ArrVal_410 (Array (_ BitVec 64) (_ BitVec 64)))) (= (bvadd (select |#valid| (select (select (store |#memory_$Pointer$.base| |ULTIMATE.start_gl_insert_~node~0#1.base| v_ArrVal_410) |~#gl_list~0.base|) |~#gl_list~0.offset|)) (_ bv1 1)) (_ bv0 1))))
(check-sat)
(exit)
