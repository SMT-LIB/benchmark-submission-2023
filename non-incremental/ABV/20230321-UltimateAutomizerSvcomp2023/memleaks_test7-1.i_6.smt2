...
(assert (not (exists ((v_ArrVal_40 (_ BitVec 1)) (v_ArrVal_41 (_ BitVec 1))) (let ((.cse0 (store |ULTIMATE.start_main_old_#valid#1| |ULTIMATE.start_entry_point_~#a7~0#1.base| v_ArrVal_40))) (and (= (select .cse0 |ULTIMATE.start_probe1_6_#t~ret40#1.base|) (_ bv0 1)) (= |#valid| (store .cse0 |ULTIMATE.start_probe1_6_#t~ret40#1.base| v_ArrVal_41)))))))
(check-sat)
(exit)
