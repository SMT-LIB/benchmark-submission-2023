...
(assert (and (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base_Hier|) (not (= (_ bv0 64) |c_ULTIMATE.start_dll_create_~head~0#1.base_Hier|)) (= |c_ULTIMATE.start_main_~#s~0#1.offset_Hier| (_ bv0 64)) (not (= (_ bv0 64) |c_ULTIMATE.start_dll_create_~new_head~0#1.base_Hier|))))
