...
(assert (forall ((v_ArrVal_234 (Array (_ BitVec 64) (_ BitVec 32)))) (= (select (select (store |c_#memory_int| |c_ULTIMATE.start_main_~x~0#1.base| v_ArrVal_234) |c_ULTIMATE.start_main_~head~0#1.base|) (bvadd (_ bv8 64) |c_ULTIMATE.start_main_~head~0#1.offset|)) (_ bv0 32))))
