...
(assert (forall ((v_ArrVal_179 (Array (_ BitVec 64) (_ BitVec 64)))) (= (_ bv0 1) (bvadd (select |c_#valid| (select (select (store |c_#memory_$Pointer$.base| |c_create_data_#t~mem9.base| v_ArrVal_179) c_create_data_~data~0.base) (bvadd (_ bv4 64) c_create_data_~data~0.offset))) (_ bv1 1)))))
(check-sat)
(exit)
