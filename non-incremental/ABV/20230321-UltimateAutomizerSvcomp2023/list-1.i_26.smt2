...
(assert (not (and (= (select (select |c_#memory_int| |c_ULTIMATE.start_main_~a~0#1.base|) (_ bv0 64)) (_ bv1 32)) (not (= |c_ULTIMATE.start_main_~a~0#1.base| |c_ULTIMATE.start_main_~p~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_main_~t~0#1.offset|) (= (_ bv0 64) |c_ULTIMATE.start_main_~a~0#1.offset|))))
(check-sat)
(exit)
