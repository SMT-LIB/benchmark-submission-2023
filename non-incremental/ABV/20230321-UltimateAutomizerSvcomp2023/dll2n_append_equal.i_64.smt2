...
(assert (and (bvult |c_node_create_#res#1.base| |c_#StackHeapBarrier|) (not (= (_ bv0 64) (bvadd (_ bv1 64) |c_#StackHeapBarrier|))) (bvult |c_node_create_~temp~0#1.base| |c_#StackHeapBarrier|)))
