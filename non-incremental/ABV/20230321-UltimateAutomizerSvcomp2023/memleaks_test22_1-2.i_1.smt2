...
(assert (not (exists ((v_ArrVal_2472 (_ BitVec 8)) (v_ArrVal_2471 (_ BitVec 8))) (= |c_#memory_int| (store |c_old(#memory_int)| |c_LDV_INIT_LIST_HEAD_#in~list.base| (store (store (select |c_old(#memory_int)| |c_LDV_INIT_LIST_HEAD_#in~list.base|) |c_LDV_INIT_LIST_HEAD_#in~list.offset| v_ArrVal_2471) (bvadd (_ bv8 64) |c_LDV_INIT_LIST_HEAD_#in~list.offset|) v_ArrVal_2472))))))
(check-sat)
(exit)
