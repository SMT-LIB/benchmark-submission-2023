...
(assert (not (and (= |c_ULTIMATE.start_sll_get_data_at_~head#1.offset| (_ bv0 64)) (= (_ bv3 32) (select (select |c_#memory_int| |c_ULTIMATE.start_sll_get_data_at_~head#1.base|) (_ bv0 64))) (= |c_ULTIMATE.start_main_~expected~0#1| (_ bv3 32)))))
(check-sat)
(exit)
