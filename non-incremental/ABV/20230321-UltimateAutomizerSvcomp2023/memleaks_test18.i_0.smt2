...
(assert (not (exists ((|ldv_malloc_#res.base| (_ BitVec 64))) (and (exists ((v_ArrVal_10 (_ BitVec 1))) (= (store |c_old(#valid)| |ldv_malloc_#res.base| v_ArrVal_10) |c_#valid|)) (= (select |c_old(#valid)| |ldv_malloc_#res.base|) (_ bv0 1))))))
(check-sat)
(exit)
