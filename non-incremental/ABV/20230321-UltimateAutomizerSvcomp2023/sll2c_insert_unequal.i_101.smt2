...
(assert (not (and (= (_ bv0 64) |c_ULTIMATE.start_main_~#s~0#1.offset|) (= |c_ULTIMATE.start_main_~data~0#1| (_ bv1 32)) (= |c_ULTIMATE.start_sll_circular_create_~data#1| (_ bv1 32)) (bvult |c_#StackHeapBarrier| |c_ULTIMATE.start_main_~#s~0#1.base|))))
(check-sat)
(exit)
