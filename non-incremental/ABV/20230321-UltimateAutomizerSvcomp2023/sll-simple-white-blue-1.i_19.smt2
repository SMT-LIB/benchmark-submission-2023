...
(assert (and (= (_ bv0 64) |c_ULTIMATE.start_main_~head~0#1.offset|) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset|)) (forall ((|v_ULTIMATE.start_main_~head~0#1.base_14| (_ BitVec 64))) (or (= |v_ULTIMATE.start_main_~head~0#1.base_14| |c_ULTIMATE.start_main_~head~0#1.base|) (forall ((v_arrayElimArr_3 (Array (_ BitVec 64) (_ BitVec 64)))) (or (not (= (select v_arrayElimArr_3 (_ bv0 64)) |c_ULTIMATE.start_main_~head~0#1.base|)) (= (_ bv0 64) (select (select (store |c_#memory_$Pointer$.base| |v_ULTIMATE.start_main_~head~0#1.base_14| v_arrayElimArr_3) |c_ULTIMATE.start_main_~head~0#1.base|) |c_ULTIMATE.start_main_~head~0#1.offset|)))))) (= (select (select |c_#memory_$Pointer$.base| |c_ULTIMATE.start_main_~x~0#1.base|) |c_ULTIMATE.start_main_~x~0#1.offset|) (_ bv0 64)) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset| |c_ULTIMATE.start_main_~head~0#1.base|) (_ bv0 64)))))
(assert (not (and (= (_ bv0 64) (select (select |c_#memory_$Pointer$.base_primed| |c_ULTIMATE.start_main_~head~0#1.base|) (_ bv0 64))) (= (_ bv0 64) |c_ULTIMATE.start_main_~head~0#1.offset|) (= (_ bv0 64) (select (select |c_#memory_$Pointer$.offset_primed| |c_ULTIMATE.start_main_~head~0#1.base|) (_ bv0 64))))))
(check-sat)
(exit)
