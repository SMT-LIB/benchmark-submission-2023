...
(assert (forall ((|v_ULTIMATE.start_entry_point_#t~ret39#1.base_21| (_ BitVec 64))) (or (= |c_ULTIMATE.start_main_old_#valid#1| (store (store |c_#valid| |v_ULTIMATE.start_entry_point_#t~ret39#1.base_21| (_ bv0 1)) |c_ULTIMATE.start_entry_point_~p~0#1.base| (_ bv0 1))) (not (= (_ bv0 1) (select |c_#valid| |v_ULTIMATE.start_entry_point_#t~ret39#1.base_21|))))))
(check-sat)
(exit)
