...
(assert (= (+ (div |ULTIMATE.start_main_~d~0#1| 2) (mod |ULTIMATE.start_main_~A~0#1| 4294967296) 1) (let ((.cse0 (mod |ULTIMATE.start_main_~B~0#1| 4294967296))) (+ (* (div |ULTIMATE.start_main_~p~0#1| 2) .cse0) (* |ULTIMATE.start_main_~q~0#1| .cse0) |ULTIMATE.start_main_~r~0#1|))))
(check-sat)
(exit)
