...
(assert (or (<= (* oldres oldres) (+ x oldres))
            (<= (* oldres oldres) (div (* 1000000000000000000000118 x) 1000000000000000000000000))))
(assert (= newres (div (+ oldres (div x oldres)) 2)))
(assert (not (and (< x (* (+ newres 1) (+ newres 1)))
             (or (<= (* newres newres) (+ x newres))
                 (<= (* newres newres) (div (* 10000000000000000000000000000000000000000000035 x) 10000000000000000000000000000000000000000000000))))))
(check-sat)
(exit)
