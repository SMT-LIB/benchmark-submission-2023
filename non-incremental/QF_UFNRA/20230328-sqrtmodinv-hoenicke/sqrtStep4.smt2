...
(assert (axiom_frac_zero (* 100000931 x) 100000000 100611 x (uninterp_frac (* 100000931 x) 100000000)))
...
(assert (axiom_frac_bound (* 100611 x) 100000))
(assert (axiom_frac_zero (* 100611 x) 100000 (+ newres 1) (+ newres 1) (uninterp_frac (* 100611 x) 100000)))
(assert (axiom_frac_zero (* 100611 x) 100000 (+ oldres 1) (+ oldres 1) (uninterp_frac (* 100611 x) 100000)))
(assert (axiom_frac_zero (* 100611 x) 100000 100000931 x (uninterp_frac (* 100611 x) 100000)))
(assert (axiom_frac_zero (* 100611 x) 100000 100611 x (uninterp_frac (* 100611 x) 100000)))
(assert (axiom_frac_zero (* 100611 x) 100000 newres newres (uninterp_frac (* 100611 x) 100000)))
(assert (axiom_frac_zero (* 100611 x) 100000 oldres oldres (uninterp_frac (* 100611 x) 100000)))
...
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 100611 x (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
...
(assert (axiom_frac_zero x oldres 100611 x (uninterp_frac x oldres)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (- (/ (* 100611 x) 100000) (uninterp_frac (* 100611 x) 100000)))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (- (/ (* 100000931 x) 100000000) (uninterp_frac (* 100000931 x) 100000000)))))))
(check-sat)
(exit)
