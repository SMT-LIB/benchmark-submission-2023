...
(assert (axiom_frac_zero (* 10000000000000000000000000000000000000000000035 x) 10000000000000000000000000000000000000000000000 1000000000000000000000118 x (uninterp_frac (* 10000000000000000000000000000000000000000000035 x) 10000000000000000000000000000000000000000000000)))
...
(assert (axiom_frac_zero (* 1000000000000000000000118 x) 1000000000000000000000000 10000000000000000000000000000000000000000000035 x (uninterp_frac (* 1000000000000000000000118 x) 1000000000000000000000000)))
...
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 10000000000000000000000000000000000000000000035 x (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (- (/ (* 1000000000000000000000118 x) 1000000000000000000000000) (uninterp_frac (* 1000000000000000000000118 x) 1000000000000000000000000)))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (- (/ (* 10000000000000000000000000000000000000000000035 x) 10000000000000000000000000000000000000000000000) (uninterp_frac (* 10000000000000000000000000000000000000000000035 x) 10000000000000000000000000000000000000000000000)))))))
(check-sat)
(exit)
