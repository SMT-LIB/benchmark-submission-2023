...
(assert (axiom_frac_zero (* 1050625 x) 1000000 15625 x (uninterp_frac (* 1050625 x) 1000000)))
...
(assert (axiom_frac_bound (* 15625 x) 10000))
(assert (axiom_frac_zero (* 15625 x) 10000 (+ newres 1) (+ newres 1) (uninterp_frac (* 15625 x) 10000)))
(assert (axiom_frac_zero (* 15625 x) 10000 (+ oldres 1) (+ oldres 1) (uninterp_frac (* 15625 x) 10000)))
(assert (axiom_frac_zero (* 15625 x) 10000 1050625 x (uninterp_frac (* 15625 x) 10000)))
(assert (axiom_frac_zero (* 15625 x) 10000 15625 x (uninterp_frac (* 15625 x) 10000)))
(assert (axiom_frac_zero (* 15625 x) 10000 newres newres (uninterp_frac (* 15625 x) 10000)))
(assert (axiom_frac_zero (* 15625 x) 10000 oldres oldres (uninterp_frac (* 15625 x) 10000)))
...
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 15625 x (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
...
(assert (axiom_frac_zero x oldres 15625 x (uninterp_frac x oldres)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (- (/ (* 15625 x) 10000) (uninterp_frac (* 15625 x) 10000)))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (- (/ (* 1050625 x) 1000000) (uninterp_frac (* 1050625 x) 1000000)))))))
(check-sat)
(exit)
