...
(assert (axiom_frac_bound x 10751840))
(assert (axiom_frac_zero x 10751840 (+ newres 1) (+ newres 1) (uninterp_frac x 10751840)))
(assert (axiom_frac_zero x 10751840 (+ oldres 1) (+ oldres 1) (uninterp_frac x 10751840)))
(assert (axiom_frac_zero x 10751840 newres newres (uninterp_frac x 10751840)))
(assert (axiom_frac_zero x 10751840 oldres oldres (uninterp_frac x 10751840)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (+ x (- (/ x 1639) (uninterp_frac x 1639))))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (+ x (- (/ x 10751840) (uninterp_frac x 10751840))))))))
(check-sat)
(exit)
