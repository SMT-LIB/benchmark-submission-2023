...
(assert (axiom_frac_bound (* 1681 x) 1600))
(assert (axiom_frac_zero (* 1681 x) 1600 (+ newres 1) (+ newres 1) (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_zero (* 1681 x) 1600 (+ oldres 1) (+ oldres 1) (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_zero (* 1681 x) 1600 1681 x (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_zero (* 1681 x) 1600 25 x (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_zero (* 1681 x) 1600 newres newres (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_zero (* 1681 x) 1600 oldres oldres (uninterp_frac (* 1681 x) 1600)))
(assert (axiom_frac_bound (* 25 x) 16))
(assert (axiom_frac_zero (* 25 x) 16 (+ newres 1) (+ newres 1) (uninterp_frac (* 25 x) 16)))
(assert (axiom_frac_zero (* 25 x) 16 (+ oldres 1) (+ oldres 1) (uninterp_frac (* 25 x) 16)))
(assert (axiom_frac_zero (* 25 x) 16 1681 x (uninterp_frac (* 25 x) 16)))
(assert (axiom_frac_zero (* 25 x) 16 25 x (uninterp_frac (* 25 x) 16)))
(assert (axiom_frac_zero (* 25 x) 16 newres newres (uninterp_frac (* 25 x) 16)))
(assert (axiom_frac_zero (* 25 x) 16 oldres oldres (uninterp_frac (* 25 x) 16)))
...
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 1681 x (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 25 x (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
...
(assert (axiom_frac_zero x oldres 1681 x (uninterp_frac x oldres)))
(assert (axiom_frac_zero x oldres 25 x (uninterp_frac x oldres)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (- (/ (* 25 x) 16) (uninterp_frac (* 25 x) 16)))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (- (/ (* 1681 x) 1600) (uninterp_frac (* 1681 x) 1600)))))))
(check-sat)
(exit)
