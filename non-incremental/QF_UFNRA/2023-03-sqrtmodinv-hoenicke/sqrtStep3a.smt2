...
(assert (axiom_frac_bound x 1639))
(assert (axiom_frac_zero x 1639 (+ newres 1) (+ newres 1) (uninterp_frac x 1639)))
(assert (axiom_frac_zero x 1639 (+ oldres 1) (+ oldres 1) (uninterp_frac x 1639)))
(assert (axiom_frac_zero x 1639 1681 x (uninterp_frac x 1639)))
(assert (axiom_frac_zero x 1639 newres newres (uninterp_frac x 1639)))
(assert (axiom_frac_zero x 1639 oldres oldres (uninterp_frac x 1639)))
...
(assert (or (<= (* oldres oldres) (+ x oldres)) (<= (* oldres oldres) (- (/ (* 1681 x) 1600) (uninterp_frac (* 1681 x) 1600)))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (+ x (- (/ x 1639) (uninterp_frac x 1639))))))))
(check-sat)
(exit)
