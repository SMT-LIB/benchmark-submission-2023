...
(assert (axiom_frac_zero (* 15625 x) 10000 4 (* oldres oldres) (uninterp_frac (* 15625 x) 10000)))
...
(assert (axiom_frac_zero (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2 4 (* oldres oldres) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2)))
...
(assert (axiom_frac_zero x oldres 4 (* oldres oldres) (uninterp_frac x oldres)))
...
(assert (<= (* oldres oldres) x))
(assert (<= x (* 4 (* oldres oldres))))
(assert (= newres (- (/ (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2) (uninterp_frac (+ oldres (- (/ x oldres) (uninterp_frac x oldres))) 2))))
(assert (not (and (< x (* (+ newres 1) (+ newres 1))) (or (< (- (* newres newres) 1) (+ x newres)) (< (- (* newres newres) 1) (- (/ (* 15625 x) 10000) (uninterp_frac (* 15625 x) 10000)))))))
(check-sat)
(exit)
