...
(define-fun x184 ((x65 Int) (x276 Int)) Bool (=> (and (> x276 0) (> x65 0)) (and (< (- x65 x276) (* x276 (x97 x65 x276))) (>= x65 (* x276 (x97 x65 x276))))))
(define-fun x181 ((x65 Int) (x276 Int)) Bool (= (* x276 (x97 x65 x276)) (- x65 (x16 (- x276 1) x65))))
(define-fun x289 ((x65 Int) (x276 Int)) Bool (and (x91 x65 x276) (x181 x65 x276) (x184 x65 x276) (x206 x65 x276) (x70 x65 x276) (x161 x65 x276)))
...
(define-fun x231 ((x65 Int) (x276 Int)) Bool (=> (> x276 0) (= x65 (+ (* x276 (x97 x65 x276)) (x61 x65 x276)))))
(define-fun x287 ((x65 Int) (x276 Int)) Bool (and (x115 x65 x276) (x231 x65 x276) (x74 x65 x276) (x203 x65 x276)))
...
(assert (x24 x174))
(assert (x289 x80 18446744073709551616))
...
(assert (x113 x202))
(assert (x287 x271 4294967296))
(assert (x113 x84))
(assert (x113 x249))
(assert (x113 x220))
(assert (x113 x151))
(assert (= (x150 1061922874) (x2 1061922874)))
(assert (x287 x174 256))
...
(assert (x57 x188))
(assert (x113 x211))
(assert (x287 x151 4294967296))
(assert (x287 x148 4294967296))
(assert (x113 x106))
(assert (x113 x245))
(assert (x113 x15))
(assert (x113 x5))
...
(assert (x287 x268 340282366920938463463374607431768211456))
...
(assert (x113 x254))
(assert (x113 x214))
(assert (x287 x275 1461501637330902918203684832716283019655932542976))
...
(assert (x287 x11 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (x113 x144))
(assert (x113 x44))
(assert (x113 x274))
(assert (x232 x271))
(assert (x289 x93 79228162514264337593543950336))
(assert (x113 x196))
(assert (x57 x50))
...
(assert (x289 x225 79228162514264337593543950336))
(assert (x113 x59))
...
(assert (x289 x86 18446744073709551616))
...
(assert (x287 x200 4294967296))
(assert (x113 x139))
(assert (x113 x37))
(assert (x113 x125))
(assert (x287 x208 340282366920938463463374607431768211456))
(assert (x113 x262))
(assert (x113 x259))
(check-sat)
(exit)