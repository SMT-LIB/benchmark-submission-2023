...
(define-fun x312 ((x280 Int) (x341 Int)) Bool (=> (< 0 x341) (= (+ (x333 x280 x341) (* x341 (x100 x280 x341))) x280)))
(define-fun x254 ((x280 Int) (x341 Int)) Bool (and (x50 x280 x341) (x632 x280 x341) (x312 x280 x341) (x541 x280 x341)))
...
(assert (x387 x390))
(assert (x424 x199))
(assert (x254 x390 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (x507 x131))
...
(assert (x654 x131))
(assert (x254 x628 1461501637330902918203684832716283019655932542976))
(assert (x654 x57))
(assert (x654 x671))
(assert (x654 x311))
...
(assert (x254 x225 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (x654 x212))
(assert (x424 (- x9 x364)))
(assert (x654 x539))
(assert (x654 x73))
