...
(define-fun x563 ((x607 Int) (x230 Int)) Bool (=> (> x230 0) (= (+ (* (x444 x607 x230) x230) (x696 x607 x230)) x607)))
(define-fun x227 ((x607 Int) (x230 Int)) Bool (and (x661 x607 x230) (x95 x607 x230) (x563 x607 x230) (x767 x607 x230)))
...
(assert (x227 x685 115792089237316195423570985008687907853269984665640564039457584007913129639936))
...
(assert (x227 x505 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (x773 x113))
...
(assert (x227 x709 1461501637330902918203684832716283019655932542976))
...
(assert (x525 x140))
(assert (x227 x741 1461501637330902918203684832716283019655932542976))
(assert (x525 x694))
