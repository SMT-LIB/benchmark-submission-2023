...
(define-fun x97 ((x61 Int) (x178 Int)) Bool (=> (and (< 0 x61) (> x178 0)) (and (<= (* x178 (x43 x61 x178)) x61) (< (- x61 x178) (* x178 (x43 x61 x178))))))
(define-fun x195 ((x61 Int) (x178 Int)) Bool (= (- x61 (x153 (- x178 1) x61)) (* x178 (x43 x61 x178))))
(define-fun x99 ((x61 Int) (x178 Int)) Bool (and (x189 x61 x178) (x195 x61 x178) (x143 x61 x178) (x19 x61 x178) (x47 x61 x178) (x97 x61 x178)))
...
(define-fun x73 ((x61 Int) (x178 Int)) Bool (=> (> x178 0) (= x61 (+ (x200 x61 x178) (* x178 (x43 x61 x178))))))
(define-fun x111 ((x61 Int) (x178 Int)) Bool (and (x73 x61 x178) (x37 x61 x178) (x9 x61 x178) (x201 x61 x178)))
...
(define-fun x190 ((x61 Int) (x178 Int)) Bool (= (* x178 x61) (x196 x61 x178)))
(define-fun x2 ((x61 Int) (x178 Int)) Bool (and (= (* (- x178 115792089237316195423570985008687907853269984665640564039457584007913129639936) x61) (x196 x61 (- x178 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (= (- (* x61 x178) (* x178 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (x196 (- x61 115792089237316195423570985008687907853269984665640564039457584007913129639936) x178)) (= (- (* (- x178 115792089237316195423570985008687907853269984665640564039457584007913129639936) x61) (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 (- x178 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (x196 (- x61 115792089237316195423570985008687907853269984665640564039457584007913129639936) (- x178 115792089237316195423570985008687907853269984665640564039457584007913129639936)))))
...
(define-fun x68 ((x61 Int) (x178 Int)) Bool (and (x18 x61 x178) (x190 x61 x178) (x71 x61 x178) (x124 x61 x178) (x113 x61 x178) (x2 x61 x178) (x78 x61 x178)))
