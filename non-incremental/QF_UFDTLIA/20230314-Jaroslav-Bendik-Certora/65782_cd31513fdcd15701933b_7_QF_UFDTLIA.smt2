...
(define-fun x178 ((x53 Int) (x25 Int)) Bool (=> (> x25 0) (= (+ (x2 x53 x25) (* (x348 x53 x25) x25)) x53)))
(define-fun x38 ((x53 Int) (x25 Int)) Bool (and (x178 x53 x25) (x202 x53 x25) (x353 x53 x25) (x237 x53 x25)))
...
(assert (x191 x79))
(assert (x38 x17 1461501637330902918203684832716283019655932542976))
(assert (x191 x284))
(assert (x191 x210))
(assert (x191 x215))
(assert (x191 x135))
...
(assert (x176 x120))
(assert (x359 x113))
(assert (x38 x26 1461501637330902918203684832716283019655932542976))
(assert (x18 x246))
(check-sat)
(exit)