...
(define-fun x64 ((x109 Int) (x1 Int)) Bool (=> (and (> x109 0) (> x1 0)) (and (> (* (x239 x109 x1) x1) (- x109 x1)) (>= x109 (* x1 (x239 x109 x1))))))
(define-fun x108 ((x109 Int) (x1 Int)) Bool (= (- x109 (x244 (- x1 1) x109)) (* x1 (x239 x109 x1))))
(define-fun x90 ((x109 Int) (x1 Int)) Bool (and (x113 x109 x1) (x82 x109 x1) (x64 x109 x1) (x39 x109 x1) (x194 x109 x1) (x108 x109 x1)))
...
(define-fun x240 ((x109 Int) (x1 Int)) Bool (=> (< 0 x1) (= x109 (+ (* x1 (x239 x109 x1)) (x53 x109 x1)))))
(define-fun x191 ((x109 Int) (x1 Int)) Bool (and (x226 x109 x1) (x126 x109 x1) (x45 x109 x1) (x240 x109 x1)))
...
(define-fun x189 ((x109 Int) (x1 Int)) Bool (= (* x109 x1) (x224 x109 x1)))
(define-fun x247 ((x109 Int) (x1 Int)) Bool (and (= (* (- x1 115792089237316195423570985008687907853269984665640564039457584007913129639936) x109) (x224 x109 (- x1 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (= (- (* x109 (- x1 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 (- x1 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (x224 (- x109 115792089237316195423570985008687907853269984665640564039457584007913129639936) (- x1 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (= (x224 (- x109 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1) (- (* x1 x109) (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1)))))
...
(define-fun x164 ((x109 Int) (x1 Int)) Bool (and (x97 x109 x1) (x247 x109 x1) (x189 x109 x1) (x147 x109 x1) (x219 x109 x1) (x83 x109 x1) (x50 x109 x1)))
...
(assert (x191 x220 18446744073709551616))
...
(assert (x191 x234 115792089237316195423570985008687907853269984665640564039457584007913129639936))
...
(assert (x191 x133 1461501637330902918203684832716283019655932542976))
...
(assert (x138 x198))
(assert (x90 x213 6277101735386680763835789423207666416102355444464034512896))
...
(assert (x222 x220))
(assert (x90 x213 1461501637330902918203684832716283019655932542976))
...
(assert (x90 x124 452312848583266388373324160190187140051835877600158453279131187530910662656))
(assert (x138 x77))
