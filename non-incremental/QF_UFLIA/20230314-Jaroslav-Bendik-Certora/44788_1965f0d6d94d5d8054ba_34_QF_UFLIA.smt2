...
(define-fun x286 ((x4 Int) (x187 Int)) Bool (=> (> x187 0) (= x4 (+ (x259 x4 x187) (* x187 (x301 x4 x187))))))
(define-fun x314 ((x4 Int) (x187 Int)) Bool (and (x33 x4 x187) (x320 x4 x187) (x286 x4 x187) (x176 x4 x187)))
...
(assert (x314 x93 1461501637330902918203684832716283019655932542976))
...
(assert (x314 x295 1461501637330902918203684832716283019655932542976))
...
(assert (x314 x85 1461501637330902918203684832716283019655932542976))
(assert (x51 x171))
(assert (x310 x93))
