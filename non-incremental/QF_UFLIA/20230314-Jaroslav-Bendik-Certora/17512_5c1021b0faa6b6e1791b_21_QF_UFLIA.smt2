...
(define-fun x475 ((x129 Int) (x66 Int)) Bool (=> (and (< 0 x66) (> x129 0)) (and (>= x129 (* (x509 x129 x66) x66)) (> (* x66 (x509 x129 x66)) (- x129 x66)))))
(define-fun x126 ((x129 Int) (x66 Int)) Bool (and (x296 x129 x66) (x706 x129 x66) (x463 x129 x66) (x475 x129 x66) (x69 x129 x66)))
...
(define-fun x731 ((x129 Int) (x66 Int)) Bool (=> (< 0 x66) (= (+ (* (x509 x129 x66) x66) (x102 x129 x66)) x129)))
(define-fun x689 ((x129 Int) (x66 Int)) Bool (and (x309 x129 x66) (x277 x129 x66) (x731 x129 x66) (x698 x129 x66)))
...
(define-fun x72 ((x129 Int) (x66 Int)) Bool (and (x116 x129 x66) (x550 x129 x66) (x584 x129 x66) (x329 x129 x66) (x487 x129 x66) (x790 x129 x66) (x726 x129 x66)))
...
(assert (x689 x242 1461501637330902918203684832716283019655932542976))
...
(assert (x72 1000000000000000000000000000 x374))
...
(assert (x454 x217))
(assert (x454 x669))
(assert (x72 1000000000000000000000000000 x40))
...
(assert (x126 x37 1000000000000000000000000000))
(assert (x454 x100))
...
(assert (x126 x503 1000000000000000000000000000))
...
(assert (x126 x516 1000000000000000000000000000))
(assert (x454 x78))
(assert (x218 (- x341 x79)))
(assert (x247 x244 x631 x506 x214))
(assert (x454 x694))
(assert (x689 x412 1461501637330902918203684832716283019655932542976))
...
(assert (x126 x75 1000000000000000000000000000))
...
(assert (x72 1000000000000000000000000000 x366))
...
(assert (x72 1000000000000000000000000000 x79))
...
(assert (x126 x570 1000000000000000000000000000))
...
(assert (x454 x541))
(assert (x689 x398 340282366920938463463374607431768211456))
...
(assert (x126 x409 1000000000000000000000000000))
...
(assert (x218 (- x99 x79)))
(assert (x126 x51 1000000000000000000000000000))
...
(assert (x689 x481 340282366920938463463374607431768211456))
(assert (x72 3 x267))
...
(assert (x689 x526 340282366920938463463374607431768211456))
(assert (x218 x631))
(assert (x454 x201))
(assert (x689 x527 1461501637330902918203684832716283019655932542976))
...
(assert (x689 x442 1461501637330902918203684832716283019655932542976))
(assert (x454 x723))
...
(assert (x454 x780))
(assert (x72 1000000000000000000000000000 x450))
(assert (x454 x37))
...
(assert (x72 1000000000000000000000000000 x619))
...
(assert (x454 x208))
(assert (x454 x678))
(assert (x126 x208 1000000000000000000000000000))
...
(assert (x59 x558))
(assert (x126 x29 1000000000000000000000000000))
(assert (x454 x259))
...
(assert (x126 x260 1000000000000000000000000000))
...
(assert (x126 x660 1000000000000000000000000000))
...
(assert (x454 x642))
(assert (x126 x612 1000000000000000000000000000))
(assert (x454 x437))
