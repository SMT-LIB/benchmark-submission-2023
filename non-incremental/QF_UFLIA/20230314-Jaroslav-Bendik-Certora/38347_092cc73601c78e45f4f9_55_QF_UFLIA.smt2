...
(define-fun x77 ((x58 Int) (x47 Int)) Bool (=> (and (> x47 0) (> x58 0)) (and (<= (* x47 (x2 x58 x47)) x58) (< (- x58 x47) (* (x2 x58 x47) x47)))))
(define-fun x244 ((x58 Int) (x47 Int)) Bool (= (- x58 (x192 (- x47 1) x58)) (* (x2 x58 x47) x47)))
(define-fun x220 ((x58 Int) (x47 Int)) Bool (and (x158 x58 x47) (x244 x58 x47) (x77 x58 x47) (x270 x58 x47) (x90 x58 x47) (x165 x58 x47)))
...
(define-fun x259 ((x58 Int) (x47 Int)) Bool (=> (< 0 x47) (= x58 (+ (x8 x58 x47) (* (x2 x58 x47) x47)))))
(define-fun x1 ((x58 Int) (x47 Int)) Bool (and (x22 x58 x47) (x147 x58 x47) (x117 x58 x47) (x259 x58 x47)))
...
(assert (x56 x131))
(assert (x1 x242 4294967296))
(assert (=> (= (+ x205 2) (+ 2 x27)) (and (= x86 x261) (= x222 x271))))
(assert (x1 x217 4294967296))
...
(assert (x1 x64 1461501637330902918203684832716283019655932542976))
(assert (=> (<= x261 10000) (not (= (x108 x153 x124) x261))))
(assert (x1 x83 4294967296))
...
(assert (x276 x205))
(assert (x207 256))
(assert (x1 x30 340282366920938463463374607431768211456))
(assert (x56 x151))
(assert (x56 x110))
(assert (x56 x72))
...
(assert (x1 x84 340282366920938463463374607431768211456))
...
(assert (x56 x241))
(assert (x56 x99))
(assert (x220 x45 18446744073709551616))
(assert (x56 x107))
...
(assert (x220 x7 79228162514264337593543950336))
...
(assert (x56 x239))
(assert (x56 x136))
(assert (x220 x36 79228162514264337593543950336))
(assert (x220 x126 18446744073709551616))
...
(assert (x1 x227 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (x56 x164))
