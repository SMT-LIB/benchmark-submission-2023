...
(define-fun x9 ((x32 Int) (x105 Int)) Bool (=> (> x105 0) (= x32 (+ (x198 x32 x105) (* x105 (x200 x32 x105))))))
(define-fun x111 ((x32 Int) (x105 Int)) Bool (and (x9 x32 x105) (x183 x32 x105) (x49 x32 x105) (x39 x32 x105)))
...
(assert (x66 x98))
(assert (x111 x317 1461501637330902918203684832716283019655932542976))
...
(assert (x111 x297 1461501637330902918203684832716283019655932542976))
